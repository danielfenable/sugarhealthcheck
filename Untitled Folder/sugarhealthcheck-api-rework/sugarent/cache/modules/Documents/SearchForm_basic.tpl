...
<tr>
		...
		{if $fields.document_name_basic.acl > 0}
	...
	<td scope="row" nowrap="nowrap" width='1%' >
			<label for='document_name_basic'> {sugar_translate label='LBL_DOCUMENT_NAME' module='Documents'}
		</td>
