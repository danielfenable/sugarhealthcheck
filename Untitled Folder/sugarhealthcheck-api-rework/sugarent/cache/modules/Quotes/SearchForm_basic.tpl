...
<tr>
	...
	<td scope="row" nowrap="nowrap" width='1%' >
			<label for='name_basic'> {sugar_translate label='LBL_QUOTE_NAME' module='Quotes'}
		</td>
...
<input type='text' name='{$fields.name_basic.name}' 
	...
	<td scope="row" nowrap="nowrap" width='1%' >
		...
		<label for='current_user_only_basic' >{sugar_translate label='LBL_CURRENT_USER_FILTER' module='Quotes'}</label>
    	</td>
...
value="1" title='' tabindex="" {$checked} >
	...
	<td scope="row" nowrap="nowrap" width='1%' >
		...
		<label for='favorites_only_basic' >{sugar_translate label='LBL_FAVORITES_FILTER' module='Quotes'}</label>
    	</td>
...
value="1" title='' tabindex="" {$checked} >
		...
		{if $fields.open_only_basic.acl > 0}
		{counter assign=index}
	{math equation="left % right"
   		  left=$index
          right=$basicMaxColumns
	...
	<td scope="row" nowrap="nowrap" width='1%' >
		...
		<label for='open_only_basic' >{sugar_translate label='LBL_OPEN_ITEMS' module='Quotes'}</label>
    	</td>
