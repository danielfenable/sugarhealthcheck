<?php 
 $GLOBALS["dictionary"]["KBArticle"]=array (
  'table' => 'kbarticles',
  'reassignable' => false,
  'favorites' => true,
  'unified_search' => true,
  ...
  array (
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'kbarticles_created_by',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'kbarticles_modified_user',
    ...
    array (
      'name' => 'activities',
      'type' => 'link',
      'relationship' => 'kbarticle_activities',
    ...
    array (
      'name' => 'following_link',
      'type' => 'link',
      'relationship' => 'kbarticles_following',
      'source' => 'non-db',
      'vname' => 'LBL_FOLLOWING',
      'reportable' => false,
    ),
    ...
    array (
      'name' => 'favorite_link',
      'type' => 'link',
      'relationship' => 'kbarticles_favorite',
      'source' => 'non-db',
      'vname' => 'LBL_FAVORITE',
      'reportable' => false,
      'workflow' => false,
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'kbarticles_team_count_relationship',
      'link_type' => 'one',
      'module' => 'Teams',
      'bean_name' => 'TeamSet',
      'source' => 'non-db',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'kbarticles_assigned_user',
  ...
  array (
    ...
    'date_modified' => 
    array (
      'name' => 'idx_kbarticles_date_modfied',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'date_modified',
    ...
    'date_entered' => 
    array (
      'name' => 'idx_kbarticles_date_entered',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'date_entered',
    ...
    'assigned_user_id' => 
    array (
      'name' => 'idx_kbarticles_assigned_del',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'deleted',
