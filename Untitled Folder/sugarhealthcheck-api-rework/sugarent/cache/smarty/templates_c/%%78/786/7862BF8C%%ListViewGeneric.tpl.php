...
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_getjspath', 'include/ListView/ListViewGeneric.tpl', 14, false),array('function', 'counter', 'include/ListView/ListViewGeneric.tpl', 110, false),array('function', 'sugar_translate', 'include/ListView/ListViewGeneric.tpl', 124, false),array('function', 'sugar_getimage', 'include/ListView/ListViewGeneric.tpl', 130, false),array('function', 'sugar_ajax_url', 'include/ListView/ListViewGeneric.tpl', 210, false),array('function', 'sugar_evalcolumn_old', 'include/ListView/ListViewGeneric.tpl', 213, false),array('function', 'sugar_field', 'include/ListView/ListViewGeneric.tpl', 215, false),array('modifier', 'replace', 'include/ListView/ListViewGeneric.tpl', 54, false),array('modifier', 'default', 'include/ListView/ListViewGeneric.tpl', 113, false),array('modifier', 'lower', 'include/ListView/ListViewGeneric.tpl', 116, false),array('modifier', 'upper', 'include/ListView/ListViewGeneric.tpl', 119, false),)), $this); ?>
...
<?php if (count ( $this->_tpl_vars['data'] ) == 0): ?>
    ...
    <?php if ($this->_tpl_vars['displayEmptyDataMesssages']): ?>
        <?php if (strlen ( $this->_tpl_vars['query'] ) == 0): ?>
                <?php if ($this->_tpl_vars['pageData']['bean']['parentModuleDir']): ?>
                    <?php $this->assign('currentModule', $this->_tpl_vars['pageData']['bean']['parentModuleDir']); ?>
                <?php endif; ?>
                <?php ob_start(); ?><a href="?module=<?php echo $this->_tpl_vars['currentModule']; ?>
&action=<?php echo $this->_tpl_vars['pageData']['bean']['createAction']; ?>
&return_module=<?php echo $this->_tpl_vars['currentModule']; ?>
&return_action=DetailView"><?php echo $this->_tpl_vars['APP']['LBL_CREATE_BUTTON_LABEL']; ?>
                ...
                <?php ob_start(); ?><a href="?module=Import&action=Step1&import_module=<?php echo $this->_tpl_vars['currentModule']; ?>
&return_module=<?php echo $this->_tpl_vars['currentModule']; ?>
&return_action=index"><?php echo $this->_tpl_vars['APP']['LBL_IMPORT']; ?>
                ...
                <?php ob_start(); ?><a href="?module=<?php echo $this->_tpl_vars['currentModule']; ?>
&action=index"><?php echo $this->_tpl_vars['APP']['LBL_VIEW_BUTTON_LABEL']; ?>
</a><?php $this->_smarty_vars['capture']['default'] = ob_get_contents();  $this->assign('viewLink', ob_get_contents());ob_end_clean(); ?>
...
&help_action=&key='><?php echo $this->_tpl_vars['APP']['LBL_CLICK_HERE']; ?>
                ...
                <p class="msg">
                    <?php if ($this->_tpl_vars['pageData']['bean']['showLink'] == true): ?>
                        <?php echo ((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['APP']['MSG_EMPTY_LIST_VIEW_GO_TO_PARENT'])) ? $this->_run_mod_handler('replace', true, $_tmp, "<item1>", $this->_tpl_vars['pageData']['bean']['moduleTitle']) : smarty_modifier_replace($_tmp, "<item1>", $this->_tpl_vars['pageData']['bean']['moduleTitle'])))) ? $this->_run_mod_handler('replace', true, $_tmp, "<item2>", $this->_tpl_vars['pageData']['bean']['parentTitle']) : smarty_modifier_replace($_tmp, "<item2>", $this->_tpl_vars['pageData']['bean']['parentTitle'])))) ? $this->_run_mod_handler('replace', true, $_tmp, "<item3>", $this->_tpl_vars['viewLink']) : smarty_modifier_replace($_tmp, "<item3>", $this->_tpl_vars['viewLink'])); ?>

                    <?php elseif ($this->_tpl_vars['pageData']['bean']['importable'] == true): ?>
                    ...
                    <?php else: ?>
                        <?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['APP']['MSG_EMPTY_LIST_VIEW_NO_RESULTS_NO_IMPORT'])) ? $this->_run_mod_handler('replace', true, $_tmp, "<item1>", $this->_tpl_vars['pageData']['bean']['parentTitle']) : smarty_modifier_replace($_tmp, "<item1>", $this->_tpl_vars['pageData']['bean']['parentTitle'])))) ? $this->_run_mod_handler('replace', true, $_tmp, "<item2>", $this->_tpl_vars['createLink']) : smarty_modifier_replace($_tmp, "<item2>", $this->_tpl_vars['createLink'])); ?>
...
"<?php $this->_smarty_vars['capture']['default'] = ob_get_contents();  $this->assign('quotedQuery', ob_get_contents());ob_end_clean(); ?>
            ...
            <?php if ($this->_tpl_vars['displaySubMessage']): ?>
                <p class = "submsg">
                    <a href="?module=<?php echo $this->_tpl_vars['currentModule']; ?>
&action=EditView&return_module=<?php echo $this->_tpl_vars['currentModule']; ?>
...
%'>
					<div width='100%' align='<?php echo ((is_array($_tmp=@$this->_tpl_vars['params']['align'])) ? $this->_run_mod_handler('default', true, $_tmp, 'left') : smarty_modifier_default($_tmp, 'left')); ?>
'>
...
' class='listViewThLinkS1'>
	                    <?php else: ?>
	                        <?php if (((is_array($_tmp=((is_array($_tmp=@$this->_tpl_vars['params']['orderBy'])) ? $this->_run_mod_handler('default', true, $_tmp, @$this->_tpl_vars['colHeader']) : smarty_modifier_default($_tmp, @$this->_tpl_vars['colHeader'])))) ? $this->_run_mod_handler('lower', true, $_tmp) : smarty_modifier_lower($_tmp)) == $this->_tpl_vars['pageData']['ordering']['orderBy']): ?>
	                            <a href='#' onClick='sListView.order_checks("<?php echo ((is_array($_tmp=@$this->_tpl_vars['pageData']['ordering']['sortOrder'])) ? $this->_run_mod_handler('default', true, $_tmp, 'ASCerror') : smarty_modifier_default($_tmp, 'ASCerror')); ?>
...
");return false;' class='listViewThLinkS1'>
	                        <?php else: ?>
	                            <a href='#' onClick='sListView.order_checks("ASC", "<?php echo ((is_array($_tmp=((is_array($_tmp=@$this->_tpl_vars['params']['orderBy'])) ? $this->_run_mod_handler('default', true, $_tmp, @$this->_tpl_vars['colHeader']) : smarty_modifier_default($_tmp, @$this->_tpl_vars['colHeader'])))) ? $this->_run_mod_handler('lower', true, $_tmp) : smarty_modifier_lower($_tmp)); ?>
" , "<?php echo $this->_tpl_vars['pageData']['bean']['moduleDir'];  echo '2_';  echo ((is_array($_tmp=$this->_tpl_vars['pageData']['bean']['objectName'])) ? $this->_run_mod_handler('upper', true, $_tmp) : smarty_modifier_upper($_tmp));  echo '_ORDER_BY'; ?>
");return false;' class='listViewThLinkS1'>
	                        <?php endif; ?>
	                    <?php endif; ?>
...
'>
				...
				<?php endif; ?>
				<?php if (! empty ( $this->_tpl_vars['quickViewLinks'] )): ?>
	            <?php ob_start();  echo $this->_tpl_vars['pageData']['bean']['moduleDir'];  $this->_smarty_vars['capture']['default'] = ob_get_contents();  $this->assign('linkModule', ob_get_contents());ob_end_clean(); ?>
...
' data-module='<?php echo $this->_tpl_vars['pageData']['bean']['moduleDir']; ?>
'
