...
$mod_strings = array(
	...
	'ERR_CHECKSYS_CURL'					=> 'Не е намерено: Автоматизираните задачи на Sugar ще работят с ограничена функционалност.',
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => 'Поддръжката на базата данни не беше намерена.  Проверете дали имате необходимите драйвери за един от следните видове поддържани бази данни: MySQL или MS SQLServer.  Може да е необходимо да премахнете коментара към разширението във файла php.ini или да компилирате повторно с правилния двоичен файл в зависимост от вашата версия на PHP.  Моля, направете справка с вашето PHP ръководство за повече информация относно това как да разрешите Поддръжката на базата данни. <br><br>Oracle и DB2 не са поддържани бази данни за SugarCRM PRO. За списък на поддържаните бази данни и друга информация за платформата, моля посетете <a href="http://support.sugarcrm.com/05_Resources/03_Supported_Platforms/"> http://support.sugarcrm.com/05_Resources/03_Supported_Platforms/</a>.',
...
//	'LBL_NO_THANKS'						=> 'Continue to installer',
	...
	'LBL_WELCOME_2'						=> 'За документацията за инсталираните, моля посетете <a href="http://www.sugarcrm.com/crm/installation" target="_blank">Sugar Wiki</a>.  <BR><BR> Също може да получите помощ от Sugar общността в <a href="http://www.sugarcrm.com/forums/" target="_blank">Sugar Forums</a>.',
