...
$mod_strings = array(
	...
	'ERR_OC_SERVER_URL'					=> 'URL serwera Sugar jest wymagany.',
	'ERR_OC_USERNAME'					=> 'Nazwa użytkownika serwera jest wymagana.',
	'LBL_INSTALL_OC'					=> 'Zainstaluj Klienta Offline',
    'LBL_OC_ADMIN'                      => 'Aby rozwiązać ten problem, skontaktuj się z administratorem.',
    'LBL_OC_SUCCESS'                    => 'Instalacja Klienta Offline zakończyła się. Kliknij poniższy przycisk, aby przejść do instalacji.',
	...
	'LBL_OC_INSTALL_USERNAME_DETAILS'	=> 'To jest nazwa użytkownika, której będziesz używać do połączenia się z serwerem Sugar.',
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => 'Nie znaleziono obsługi bazy danych.  Sprawdź, czy zainstalowano wszystkie niezbędne sterowniki jednego z następujących obsługiwanych typów baz danych: MySQL lub MS SQLServer.  Może być konieczne usunięcie komentarzy w odpowiednich rozszerzeniach w pliku php.ini lub przekompilowanie przy użyciu odpowiedniego pliku binarnego zależnie od używanej wersji PHP. W instrukcji obsługi PHP zawarto informacje sposobie aktywacji obsługi bazy danych.<br><br>Bazy danych Oracle i DB2 nie są obsługiwane przez system SugarCRM Pro. Listę obsługiwanych baz danych oraz informacje o platformach można znaleźć na stronie <a href="http://support.sugarcrm.com/05_Resources/03_Supported_Platforms/">http://support.sugarcrm.com/05_Resources/03_Supported_Platforms/</a>.',
	...
	'ERR_DB_LOGIN_FAILURE'				=> 'Wprowadzony host, login i/lub hasło bazy danych są niepoprawne i połączenie z bazą nie może zostać nawiązane. Wprowadź prawidłowego hosta, nazwę użytkownika i hasło',
	'ERR_DB_LOGIN_FAILURE_MYSQL'		=> 'Wprowadzony host, login i/lub hasło bazy danych są niepoprawne i połączenie z bazą nie może zostać nawiązane. Wprowadź prawidłowego hosta, nazwę użytkownika i hasło',
	'ERR_DB_LOGIN_FAILURE_MSSQL'		=> 'Wprowadzony host, login i/lub hasło bazy danych są niepoprawne i połączenie z bazą nie może zostać nawiązane. Wprowadź prawidłowego hosta, nazwę użytkownika i hasło',
	'ERR_DB_MYSQL_VERSION'				=> 'Twoja wersja MySQL (%s) nie jest obsługiwana przez aplikację Sugar. Należy zainstalować wersję, która jest kompatybilna z aplikacją.  Sprawdź, które wersje MySQL są obsługiwane, w macierzy komptatybilności w dokumencie Uwagi do wydania.',
	...
	'ERR_LICENSE_MISSING'				=> 'Brak danych w wymaganych polach',
	...
	'ERROR_VERSION_INCOMPATIBLE'		=> 'Wczytywany plik nie jest kompatybilny z aktualną wersją aplikacji Sugar: ',
	...
	'LBL_LICENSE_OC'					=> 'Licencje klientów offline',
...
//	'LBL_NO_THANKS'						=> 'Continue to installer',
	...
	'LBL_WELCOME_2'						=> 'Dokumentacja dotycząca instalacji znajduje się w portalu <a href="http://www.sugarcrm.com/crm/installation" target="_blank">Sugar Wiki</a>.  <BR><BR>Pomoc można również uzyskać od społeczności Sugar na <a href="http://www.sugarcrm.com/forums/" target="_blank">Forach Sugar</a>.',
...
W celu uzyskania bardziej szczegółowych informacji sięgnij do Instrukcji instalacji.                                ",
	...
	'LBL_OOTB_WORKFLOW'		=> 'Wykonaj zadania przepływu pracy',
    ...
    'LBL_MODULE_TITLE'      => 'Zanistaluj pakiety językowe',
...
<br> Popraw <a target=_new href='http://us2.php.net/manual/en/ref.session.php'>konfigurację PHP</a> w pliku php.ini znajdującym się poniżej.",
	...
	'LBL_MINIMUM_PHP_VERSION' => 'Minimalna wymagana wersja PHP to 5.3.0.',
	'LBL_YOUR_PHP_VERSION' => '(Twoja aktualna wersja PHP to',
	'LBL_RECOMMENDED_PHP_VERSION' =>' Rekomendowana wersja PHP to 5.3.x)',
