 ...
 */
require_once 'vendor/Zend/Validate/Abstract.php';

/**
 * @see Zend_Validate_Ip
 */
require_once 'vendor/Zend/Validate/Ip.php';

/**
 * Please note there are two standalone test scripts for testing IDN characters due to problems
 * with file encoding.
 *
 * The first is tests/vendor/Zend/Validate/HostnameTestStandalone.php which is designed to be run on
 * the command line.
 *
 * The second is tests/vendor/Zend/Validate/HostnameTestForm.php which is designed to be run via HTML
...
class Zend_Validate_Hostname extends Zend_Validate_Abstract
{
    ...
    protected $_validIdns = array(
        ...
        'CN'  => 'Hostname/Cn.php',
        'COM' => 'vendor/Zend/Validate/Hostname/Com.php',
        ...
        'HK'  => 'vendor/Zend/Validate/Hostname/Cn.php',
        ...
        'JP'  => 'vendor/Zend/Validate/Hostname/Jp.php',
        ...
        'NET' => 'vendor/Zend/Validate/Hostname/Com.php',
        'NO'  => array(1 => '/^[\x{002d}0-9a-zàáä-éêñ-ôöøüčđńŋšŧž]{1,63}$/iu'),
        'NU'  => 'vendor/Zend/Validate/Hostname/Com.php',
        ...
        'TW'  => 'vendor/Zend/Validate/Hostname/Cn.php',
        ...
        '中国' => 'vendor/Zend/Validate/Hostname/Cn.php',
        '公司' => 'vendor/Zend/Validate/Hostname/Cn.php',
        '网络' => 'vendor/Zend/Validate/Hostname/Cn.php'
    );
