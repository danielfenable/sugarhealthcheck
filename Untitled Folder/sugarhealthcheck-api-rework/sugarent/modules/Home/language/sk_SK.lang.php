...
//ABOUT page
  ...
  'LBL_MOST_MEETING_HELD' => '{{count}} konané stretnutia',
    ...
    // Portal tour content
    'LBL_PORTAL_TOUR_RECORDS_INTRO' => 'Vitajte v portály Sugar. Pomocou nižšie uvedených šípok prejdite na rýchlu prehliadku.',
    'LBL_PORTAL_TOUR_RECORDS_PAGE' => 'Informačný panel poskytuje rýchly prehľad o nedávno aktualizovaných záznamoch.',
    'LBL_PORTAL_TOUR_RECORDS_CASES' => 'Kliknite sem na preskúmanie alebo odoslanie otázok podpory v module Prípady.',
    'LBL_PORTAL_TOUR_RECORDS_KB' => 'Kliknite sem a prečítajte si články publikované v Znalostnej báze.',
    'LBL_PORTAL_TOUR_RECORDS_BUGS' => 'Kliknite sem na preskúmanie alebo odoslanie hlásenia o chybách v module Chyby.',
    'LBL_PORTAL_TOUR_RECORDS_GLOBAL_SEARCH' => 'Vyhľadať záznamy podľa názvu alebo čísla cez všetky dostupné moduly.',
    'LBL_PORTAL_TOUR_RECORDS_QUICK_CREATE' => 'Kliknite sem pre rýchle vytváranie záznamov.',
    'LBL_PORTAL_TOUR_RECORDS_SEARCH' => 'Môžete vyhľadávať záznamy tiež v zoznamoch.',
    'LBL_PORTAL_TOUR_RECORDS_USER' => 'Z používateľského menu môžete pristupovať k svojmu profilu alebo odhláseniu.',
