...
$mod_strings = array(
    ...
    'LBL_MODULE_TITLE' => 'Partidas Individuales Cotizadas: Inicio',
    'LBL_SEARCH_FORM_TITLE' => 'Búsqueda de Partida Individual Cotizada',
    'LBL_LIST_FORM_TITLE' => 'Lista de Partida Individual Cotizada',
    'LBL_NEW_FORM_TITLE' => 'Crear Partida Individual Cotizada',
    'LBL_PRODUCT' => 'Partida Individual Cotizada:',
    'LBL_RELATED_PRODUCTS' => 'Artículos Relacionados Cotizados',
    'LBL_LEAD_SOURCE' => 'Fuente del Cliente Potencial',
    'LBL_LIST_NAME' => 'Partida Individual Cotizada',
    ...
    'LBL_LIST_QUOTE_NAME' => 'Nombre de la Cotización',
    'LBL_LIST_DATE_PURCHASED' => 'Comprado',
    'LBL_LIST_SUPPORT_EXPIRES' => 'Vencimiento',
    'LBL_NAME' => 'Nombre',
    'LBL_URL' => 'URL del Producto:',
    'LBL_QUOTE_NAME' => 'Nombre de la Cotización:',
    'LBL_ASSOCIATED_QUOTE' => 'Título de Cotización:',
    ...
    'LBL_MFT_PART_NUM' => 'Número de Pieza del Fabricante:',
    ...
    'LNK_NEW_PRODUCT' => 'Crear Partida Individual Cotizada',
    ...
    'LBL_DEFAULT_SUBPANEL_TITLE' => 'Partidas Individuales Cotizadas',
    'LBL_RELATED_PRODUCTS_TITLE' => 'Partidas Individuales Cotizadas',
    ...
    'LBL_REVENUELINEITEM_NAME' => 'Nombre de Partida Individual de Ingresos:',
    ...
    'LBL_REVENUELINEITEM_ID' => 'ID de Partida Individual de Ingresos:',
    'LBL_REVENUELINEITEM' => 'Artículo de Línea de Ganancia', 
    'LBL_EXPERT_ID' => 'Especialista de Producto',
    'LBL_FORECAST' => 'Incluyen en el pronóstico',
    'LBL_CALCULATED_LINE_ITEM_AMOUNT' => 'Calcular Cotización de Cantidad de Partida Individual',
    ...
    'LNK_IMPORT_PRODUCTS' => 'Importar Artículos Cotizados',
    ...
    'LBL_CONVERT_TO_QUOTE_ERROR_MESSAGE' => 'Se produjo un error al convertir esta Partida Individual Cotizada en una Cotización',

    'LBL_DISCOUNT_AS_PERCENT' => '% de Descuento',

    // Help Text
    // List View Help Text
    'LBL_HELP_RECORDS' => 'El módulo {{plural_module_name}} se compone de todos los productos que ya han sido vendidos o están en proceso de ser vendida a los clientes. La lista de los productos vendidos por la organización está ubicada en el catálogo de administración> Producto y los administradores tienen la capacidad de añadir productos según sea necesario. Al crear {{plural_module_name}}, usted tiene la opción de cualquiera de los productos seleccionados en el catálogo o crear nuevos productos a través del módulo {{plural_module_name}}. Hay varias formas de crear {{plural_module_name}} en Sugar tales como a través del módulo {{plural_module_name}}, módulo {{quotes_module}}, duplicando, importando {{plural_module_name}}, etc. Una vez que el registro {{module_name}} es creado, usted puede ver y editar la información relativa a la {{module_name}} vía la vista de registro {{plural_module_name}}.',

    // Record View Help Text
    'LBL_HELP_RECORD' => 'El módulo {{plural_module_name}} se compone de todos los productos que ya han sido vendidos o están en proceso de ser vendida a los clientes.
...
- Las acciones adicionales se encuentran disponibles en el menú Acciones desplegables a la derecha del botón Editar.',
    ...
    'LBL_HELP_CREATE' => 'El módulo {{plural_module_name}} se compone de todos los productos que ya han sido vendidos o que están en proceso de venderse a los clientes.

Para crear un {{module_name}}:
1. Proporcione valores para los campos según se desee. 
  - Los campos marcados "Obligatorio" deben ser completados antes de guardar. 
...
 .',
    ...
    'LBL_MANUFACTURERS' => 'Fabricantes',
    'LBL_PRODUCT_POSITION' => 'Posición de Juegos de Productos',
);
