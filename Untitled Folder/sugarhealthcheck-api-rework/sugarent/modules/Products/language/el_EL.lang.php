...
$mod_strings = array(
    ...
    'LBL_LIST_FORM_TITLE' => 'Λίστα Γραμμής Εισηγμένων Στοιχείων',
    ...
    'LBL_ASSIGNED_USER_ID' => 'Ταυτότητα Ανατεθειμένου Χρήστη:',
...
- Πρόσθετες ενέργειες είναι διαθέσιμες στο αναπτυσσόμενο μενού "Ενέργειες", δεξιά από το κουμπί "Επεξεργασία".',
    ...
    'LBL_HELP_CREATE' => 'Η ενότητα {{plural_module_name}} αποτελείται από όλα τα προϊόντα που έχουν ήδη πωληθεί ή βρίσκονται στη διαδικασία πώλησης σε πελάτες.
