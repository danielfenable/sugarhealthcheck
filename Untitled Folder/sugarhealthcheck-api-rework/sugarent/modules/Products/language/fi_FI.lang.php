...
$mod_strings = array(
    ...
    'LBL_DISCOUNT_RATE' => 'Alennusmäärä',
    ...
    // Help Text
    // List View Help Text
    'LBL_HELP_RECORDS' => '{{plural_module_name}}-moduuli tallentaa tietoja asiakkaille myydyistä tuotteista, tai tuotteista joita ollaan myymässä asiakkaille. Organisaatiosi tuotelista löytyy sijainnista Hallinto > Tuotekatalogi, ja järjestelmänvalvojat voivat lisätä tuotteita milloin vain. Kun luodaan {{plural_module_name}}, voit valita tuotteen {{plural_module_name}} tai luoda uuden tuotteen. {{plural_module_name}} voi luoda Sugarissa monella tapaa: {{plural_module_name}}-moduulista, {{quotes_module}}-moduulista, tuomalla tietueita {{plural_module_name}}, ym. Kun {{module_name}} on luotu, {{module_name}} tietoja voi katsella ja muokata sen {{plural_module_name}}.',

    // Record View Help Text
    'LBL_HELP_RECORD' => '{{plural_module_name}}-moduuli tallentaa tietoja asiakkaille myydyistä tuotteista, tai tuotteista joita ollaan myymässä asiakkaille.
...
- Muut toiminnot löytyvät ‘Muokkaa’-painikkeen oikealla puolella olevasta ‘Toiminnot’-valikosta.',
    ...
    'LBL_HELP_CREATE' => '{{plural_module_name}}-moduuli tallentaa tietoja asiakkaille myydyistä tuotteista, tai tuotteista joita ollaan myymässä asiakkaille.
