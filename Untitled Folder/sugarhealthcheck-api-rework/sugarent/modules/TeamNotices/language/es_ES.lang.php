...
*Interfaz de Usuario Mejorads y un nuevo Asistente que combinan un diseño simple e intuitivo con un proceso paso a paso para guiar al usuario a través de la creación de informes.
...
*La Independencia de Dispositivo permite que los usuarios vean los datos de SugarCRM desde cualquier PDA o smartphone, incluyendo Blackberry y iPhone.
...
Mejoras:
*Las Nuevas Relaciones permiten que los módulos nuevos y los existentes se relacionen de nuevas maneras.
*La Auditoría proporciona un historial completo de creación y modificación de módulos para poder hacer un seguimiento de las personalizaciones.
...
* Las Nuevas Plantillas proporcionan un modo de monitorizar fácilmente la información de archivos y oportunidades.',
  'LBL_TEAM_NOTICE_TRACKER' => 'La Monitorización proporciona una vista detallada del uso y rendimiento de SugarCRM.
Características:
*Los Informes de Monitorización proporcionan una instantánea del uso del sistema para mejorar la adopción y visibilidad por parte de los usuarios sobre la utilización del CRM. Los Usuarios pueden ver informes sobre actividades semanales en el CRM, registros y módulos vistos, tiempo de sesión acumulado y estado en línea de otros miembros de equipo.
