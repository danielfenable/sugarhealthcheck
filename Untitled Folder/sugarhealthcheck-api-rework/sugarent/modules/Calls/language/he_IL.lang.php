...
- Additional actions are available in the dropdown Actions menu to the right of the Edit button.',
    ...
    'LBL_HELP_CREATE' => 'המודול {{plural_module_name}} מורכב מרשומות {{calls_singular_module}} שהוקלטו על ידי משתמשים בארגון שלך.  {{plural_module_name}} יכול להיות במצב "תוזמן", "בהמתנה" או "בוטל". ניתן להוסיף משתמשי Sugar בנוסף לאנשי קשר ולידים כמוזמנים.

כדי ליצור {{calls_singular_module}}:
1. ספק ערכים לשדות כפי שתרצה.
 - יש להשלים את השדות המסומנים כ"נדרשים" לפני השמירה.
 - לחץ על "הצג עוד" כדי להציג שדות נוספים אם נדרש.
2. הוסף מוזמנים ל-{{calls_singular_module}}
