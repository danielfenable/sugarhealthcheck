...
$mod_strings = array (
  ...
  'LBL_LIST_ASSIGNED_TO_NAME' => 'Atanan Kullanıcı',
    ...
    //Tour content
    'LBL_PORTAL_TOUR_RECORDS_INTRO' => 'Hatalar modülü hata görüntüleme ve raporlama içindir. Hızlı bir tur atmak için aşağıdaki okları kullanın.',
    'LBL_PORTAL_TOUR_RECORDS_PAGE' => 'Bu sayfa mevcut yayınlanmış Hataların listesini gösterir.',
    'LBL_PORTAL_TOUR_RECORDS_FILTER' => 'Bir arama terimi sağlayarak Hata listesini filtreleyebilirsiniz.',
    'LBL_PORTAL_TOUR_RECORDS_FILTER_EXAMPLE' => 'Örneğin, daha önce rapor edilmiş bir ürün hatasını bulmak için bunu kullanabilirsiniz.',
    'LBL_PORTAL_TOUR_RECORDS_CREATE' => 'Raporlamak istediğiniz yeni bir hata ile karşılaştıysanız, yeni bir Hata kaydı oluşturmak için buraya tıklayabilirsiniz.',
