...
$mod_strings = array (
  ...
  'LBL_ACCOUNT_NAME' => 'Compte',
	...
	'LBL_PHONE' => 'Telèfon de l&#39;oficina:',
    ...
    'LBL_EXTERNALID' => 'ID aplicació externa',
    ...
    'LBL_EXTERNAL_MEETING_NO_URL' => 'L&#39;enllaç per llançar {{meetingType}} no s&#39;ha generat correctament quan es va crear la reunió. Contacteu amb l&#39;administrador.',
  ...
  //For export labels
    ...
    'LBL_EXPORT_EXTERNAL_ID' => 'ID extern',
    ...
    'LBL_EXPORT_PARENT_ID' => 'ID principal',
...
Des d&#39;aquesta vista de llista {{plural_module_name}}, podeu veure i editar en línia la informació de la reunió. Hi ha accions addicionals disponibles al menú del final de cada fila de reunió. Podeu seleccionar "Tanca" al menú de qualsevol fila de reunió programada per marcar-la com celebrada.
...
Es poden afegir usuaris de Sugar, contactes i clients potencials com a convidats a la reunió. {{plural_module_name}} es pot crear mitjançant el mòdul {{plural_module_name}}, mòdul del calendari, importa, així com amb el subpanell d&#39;Activitats (per a mòduls heretats) o amb el dashlet d&#39;activitats planificades (per a mòduls Sidecar) a registres de mòduls relacionats (per exemple, contactes, comptes, etc.), la qual cosa crearà automàticament una relació entre ambdós registres.',
    ...
    'LBL_HELP_RECORD' => 'El mòdul {{plural_module_name}} consisteix en registres de {{meetings_singular_module}} registrats per usuaris de la vostra organització. Podria ser que {{plural_module_name}} tingués un estat de "Programat", "Celebrat" o "Cancel·lat". Els usuaris de Sugar, així com {{contacts_module}} i {{leads_module}} es poden afegir com convidats.
...
- Feu i vegeu comentaris d&#39;usuari i l&#39;historial de canvis del registre a la seqüència d&#39;activitats mitjançant la commutació de la subfinestra inferior esquerra a la "Seqüència d&#39;activitats".
...
- Hi ha accions addicionals disponibles al menú desplegable d&#39;accions a la dreta del botó Edita.',
    ...
    'LBL_HELP_CREATE' => 'El  mòdul {{plural_module_name}} consisteix en registres {{meetings_module}} registrats per usuaris a la vostra organització. Podria ser que {{plural_module_name}} tingués l&#39;estat "Programat", "Celebrat" o "Cancel·lat". Els usuaris de Sugar, així com {{contacts_module}} i {{leads_module}} es poden afegir com a convidats.
...
2. Afegiu convidats al {{meetings_singular_module}}.
    - Feu clic a "Selecciona un convidat" per afegir un usuari, un contacte o un client potencial existent al {{meetings_singular_module}}.
    - Feu clic a la icona del símbol de suma a la dreta de "Selecciona un convidat" per crear un convidat de {{meetings_singular_module}} com a un registre de Sugar nou. 
