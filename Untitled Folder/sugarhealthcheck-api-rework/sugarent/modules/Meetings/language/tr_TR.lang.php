...
$mod_strings = array (
  ...
  'LBL_ACCOUNT_NAME' => 'Müşteri',
    ...
    'LBL_EXTERNAL_MEETING_NO_URL' => 'Toplantı oluşturulduğunda {{meetingType}} toplantı türünü başlatma bağlantısı düzgün şekilde oluşturulamadı. Lütfen Yöneticinizle iletişime geçin.',
...
Sugar kullanıcıları, kontaklar ve potansiyeller, toplantı davetlisi olarak eklenebilir. {{plural_module_name}}, {{plural_module_name}} modülü ile, Takvim modülü ile, içeri yüklemeyle, Aktiviteler alt paneli ile (Eski modüller için) veya ilgili modül kaydı üzerindeyken Planlanan Aktiviteler penceresi ile (Yan menü modülleri için) - her iki kayıt arasında otomatik olarak ilişki oluşturacaktır.',
    ...
    'LBL_HELP_RECORD' => '{{plural_module_name}} modülü, organizasyonunuzdaki kullanıcıların oluşturduğu {{meetings_singular_module}} kayıtlarından oluşur. {{plural_module_name}}, "Planlanan", "Yapıldı" veya "İptal" durumunda olabilir. Sugar kullanıcıları ile {{contacts_module}} ve {{leads_module}} davetli olarak eklenebilir.
