...
'LBL_SMA_WELCOME'=>'<h2>Modul bearbeiten</h2>Was möchten Sie mit dem Modul machen?<br><b>Bitte wählen Sie eine Aktion, die Sie durchführen möchten.',
...
'LBL_MB_WELCOME'=> '<h2>Verlauf</h2><br> Der Verlauf erlaubt es Ihnen, ältere veröffentlichte Versionen der Dateien zu sehen, an denen Sie gerade arbeiten. Sie können diese vergleichen und ältere Versionen wiederherstellen. Wenn Sie eine Datei wiederherstellen, wird diese zur aktuellen Datei. Sie müssen diese veröffentlichen, bevor sie für alle anderen sichtbar wird.<br>Was möchten Sie heute machen?<br><b>Bitte wählen Sie aus den Optionen unten aus.</b>',

//EDIT DROP DOWNS
'LBL_ED_CREATE_DROPDOWN'=> 'Dropdown-Liste erstellen',
'LBL_ED_WELCOME'=>'<h2>Dropdown-Editor</h2><br><b>Sie können entweder eine existierende Dropdown-Liste bearbeiten oder eine neue erstellen.',
'LBL_DROPDOWN_NAME' => 'Dropdown-Name:',
'LBL_DROPDOWN_LANGUAGE' => 'Dropdown-Sprache:',
'LBL_TABGROUP_LANGUAGE' => 'Sprache:',

//EDIT CUSTOM FIELDS
'LBL_EC_WELCOME'=>'<h2>Editor für benutzerdefinierte Felder</h2><br><b>Sie können entweder ein bestehendes Feld anzeigen und anpassen, ein neues Feld erstellen oder den Cache der eigenen Felder löschen.',
...
//TABS
'LBL_TAB_SUBTABS'=>'Sub-Registerkarten',
'LBL_MODULES'=>'Module',
...
'LBL_CONFIGURE_GROUP_TABS' => 'Modulmenü-Filter konfigurieren',
 //end bug #15095 fix
'LBL_GROUP_TAB_WELCOME'=>'Die Filter unten werden in der Liste "Mehr" im Modulmenü angezeigt werden, um Gruppen von Modulen innerhalb des Menüs anzuzeigen. Ziehen Sie Module in diese Filter bzw. daraus hinaus. Hinweis: Leere Filter werden nicht im Menü angezeigt.',
'LBL_RENAME_TAB_WELCOME'=>'Klicken Sie auf den Displaywert einer beliebigen Registerkarte, um diese umzubenennen.',
'LBL_DELETE_MODULE'=>'Modul&nbsp;aus<br />Filter&nbsp;entfernen',
'LBL_DISPLAY_OTHER_TAB_HELP' => 'Auswählen, um die Registerkarte "Sonstiges" in der Navigationsleiste anzuzeigen. Standardmäßig werden hier alle Module angezeigt, die nicht bereits anderen Gruppen zugeordnet wurden.',
'LBL_TAB_GROUP_LANGUAGE_HELP' => 'Wählen Sie eine verfügbare Sprache, bearbeiten Sie die Gruppenbezeichnungen und klicken Sie auf "Speichern & Anwenden", um diese in der gewünschten Sprache anzuwenden.',
'LBL_ADD_GROUP'=>'Filter hinzufügen',
'LBL_NEW_GROUP'=>'Neue Gruppe',
'LBL_RENAME_TABS'=>'Module umbenennen',
'LBL_DISPLAY_OTHER_TAB' => 'Registerkarte "Sonstiges" anzeigen',
...
'LBL_SMP_WELCOME'=>' Wählen Sie aus der Liste ein Modul aus, das Sie bearbeiten möchten',
...
'LBL_SP_SYNC'=>'Portal-Synchronisierung',
'LBL_SYNCP_WELCOME'=>'Bitte die URL für Ihre Portal-Instanz eintragen, dann Start betätigen.<br> Sie werden daraufhin nach Username und Kennwort gefragt.<br> Bitte Daten eintragen, dann Start betätigen.',
'LBL_LISTVIEWP_DESCRIPTION'=>'Es gibt unten zwei Spalten: "Standard" zeigt die Felder, die standardmäßig angezeigt werden und "Verfügbar" zeigt weitere Felder, die derzeit nicht angezeigt werden. Sie können die Felder mit der Maus zwischen den Spalten verschieben. So können Sie auch die Reihenfolge ändern.',
'LBL_SP_STYLESHEET'=>'Stylesheet hochladen',
'LBL_SP_UPLOADSTYLE'=>'Bitte eine Stylesheet von Ihrem Computer auswählen.<br> Wenn Sie das nächste Mal mit dem Portal synchronisieren, wird diese übertragen.',
'LBL_SP_UPLOADED'=> 'Hochgeladen',
'ERROR_SP_UPLOADED'=>'Bitte sicherstellen, dass Sie eine css-Stylesheet hochladen.',
'LBL_SP_PREVIEW'=>'Hier finden Sie eine Vorschau, wie Ihre Stylesheet aussehen wird',
...
'LBL_LANGUAGE_TOOLTIP' => 'Wählen Sie die zu bearbeitende Sprache.',
'LBL_SINGULAR' => 'Singular-Bezeichnung',
'LBL_PLURAL' => 'Plural-Bezeichnung',
'LBL_RENAME_MOD_SAVE_HELP' => 'Klicken Sie auf <b>Speichern</b>, um die Änderungen zu übernehmen.'
