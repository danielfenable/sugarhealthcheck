...
$mod_strings = array (
  ...
  'NTC_LIST_ORDER' => 'Establecer el orden en el que esta categoría aparecerá en las listas desplegables de Categorías de Productos',
  ...
  'CHILD_ERROR_MSG' => "Esta Consulta sólo es accesible mediante el Formato de Datos principal",
  'ERROR_RESULT_MSG' => 'Esta consulta no es válida.',
  'CHILD_RESULT_MSG' => 'Esta consulta no se puede ejecutar de forma independiente.',
  'LBL_QUERYRESULT' => 'Resultado de la Consulta',
  'LBL_EDIT_LAYOUT' => 'Editar Diseño' /*for 508 compliance fix*/,
  'LBL_OLD_COLUMN_NAME' => 'Nombre de Columna Anterior:',
  'LBL_NEW_COLUMN_NAME' => 'Nombre de Columna Nueva:',
  'LBL_COLUMN_REMAP' => 'Las columnas siguientes se deben eliminar o asignar a nuevas columnas:',
);
