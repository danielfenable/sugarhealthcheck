...
$mod_strings = array (
  'LBL_MODULE_NAME' => 'Формат данных',
  'LBL_MODULE_NAME_SINGULAR' => 'Формат данных',
  ...
  'LBL_MODIFY_HEAD_HEADER' => 'Добавить/Редактировать атрибут заголовка:',
  'LBL_MODIFY_BODY' => 'Изменить атрибуты основного текста',
  'LBL_MODIFY_BODY_HEADER' => 'Добавить/Редактировать атрибут тела:',
  ...
  'LBL_INVALID_QUERY' => 'Недействительный запрос',
);
