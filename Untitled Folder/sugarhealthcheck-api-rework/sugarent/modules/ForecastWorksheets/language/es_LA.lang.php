...
$mod_strings = array (
    ...
    'LBL_MODULE_NAME_SINGULAR' => 'Hoja de Trabajo del Pronóstico',
    ...
    'LBL_MANAGER_NOTIFY' => 'El siguiente {0} {1} no se incluyó en la última ejecución después de haber sido incluida en la anterior',
    'LBL_MANAGER_NOTIFY_NAME' => 'Cambio de compromiso {0}'
);
