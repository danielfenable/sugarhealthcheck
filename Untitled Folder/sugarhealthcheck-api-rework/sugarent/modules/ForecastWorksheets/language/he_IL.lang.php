...
$mod_strings = array (
    ...
    'ERR_FORECAST_AMOUNT' => 'חשבון התחייבות נדרש ועליו להיות מספר.',
    ...
    'LBL_MANAGER_NOTIFY' => 'ה{0}{1} הבא לא נכלל בהתחייבות האחרונה לאחר שנכלל בהתחייבות הקודמת',
    'LBL_MANAGER_NOTIFY_NAME' => '{0} שינוי התחייבות'
);
