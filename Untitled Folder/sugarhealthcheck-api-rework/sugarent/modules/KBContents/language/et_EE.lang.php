...
$mod_strings = array (
    ...
    'LBL_DOWNLOAD_ONE' => 'Lae alla',
    'LBL_ATTACHMENTS' => 'Manused:',
    'LBL_ADD_ATTACHMENT' => 'Lehitse',
    ...
    'LBL_SPECIFY_PUBLISH_DATE' => 'Planeerige selle artikli avaldamine, märkides ära avaldamiskuupäeva. Kas soovite jätkata ilma avaldamiskuupäeva uuendamata?',
    ...
    'LBL_RECORD_SAVED_SUCCESS' => '{{moduleSingularLower}} <a href="#{{buildRoute model=this}}">{{name}}</a> on edukalt loodud.', // use when a model is available
