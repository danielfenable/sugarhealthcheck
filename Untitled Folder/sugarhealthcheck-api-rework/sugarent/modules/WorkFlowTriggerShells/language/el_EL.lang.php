...
$mod_strings = array (
  ...
  'LBL_SEARCH_FORM_TITLE' => 'Ροή Εργασίας ενεργοποιητή, Αναζήτηση',
  'LBL_LIST_FORM_TITLE' => 'Λίστα ενεργοποιητή',
  ...
  'NTC_REMOVE_TRIGGER' => 'Είστε βέβαιοι ότι θέλετε να αφαιρέσετε αυτό τον ενεργοποιητή;',
  'NTC_REMOVE_TRIGGER_PRIMARY' => 'Αφαιρώντας τον πρωτεύων ενεργοποιητή θα αφαιρεθούν όλοι οι ενεργοποιητές.',
...
//Specific Lables
  ...
  'LBL_PAST_TRIGGER' => 'Καθορισμός παλαιού',
 	...
 	'LBL_NEW_TRIGGER_BUTTON_TITLE' => 'Δημιουργία ενεργοποιητή',
 	'LBL_NEW_TRIGGER_BUTTON_LABEL' => 'Δημιουργία ενεργοποιητή',
