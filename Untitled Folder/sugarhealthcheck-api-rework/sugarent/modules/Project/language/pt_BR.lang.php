...
$mod_strings = array (
	...
	'LBL_TOTAL_ESTIMATED_EFFORT' => 'Esforço Total Estimado (h):',
	'LBL_TOTAL_ACTUAL_EFFORT' => 'Esforço Real Total (h):',

	'LBL_LIST_NAME' => 'Nome',
    'LBL_LIST_DAYS' => 'dias',
	'LBL_LIST_ASSIGNED_USER_ID' => 'Atribuído a',
	'LBL_LIST_TOTAL_ESTIMATED_EFFORT' => 'Esforço Total Estimado (h)',
	'LBL_LIST_TOTAL_ACTUAL_EFFORT' => 'Esforço Real Total (h)',
	...
	'CONTACT_REMOVE_PROJECT_CONFIRM' => 'Tem certeza de que deseja excluir este contato do projeto?',

	'LNK_NEW_PROJECT'	=> 'Novo Projeto',
	'LNK_PROJECT_LIST'	=> 'Visualizar Lista de Projeto',
	'LNK_NEW_PROJECT_TASK'	=> 'Nova Tarefa de Projeto',
	'LNK_PROJECT_TASK_LIST'	=> 'Visualizar Tarefas de Projeto',
    'LNK_PROJECT_DASHBOARD' => 'Visualizar Painel Meus Projetos',
    'LNK_PROJECT_TASKS_DASHBOARD'   => 'Painel Minhas Tarefas de Projeto',   
	'LNK_NEW_PROJECT_TEMPLATES' => 'Criar Modelo de Projeto',
	'LNK_PROJECT_TEMPLATES_LIST' => 'Visualizar Modelos de Projeto',
	...
	'LBL_RESOURCE_TYPE' => 'Tipo do recurso',
    ...
    'LBL_PROJECT_HOLIDAYS' => 'Férias',
    'LBL_LIST_RESOURCE' => 'Recurso:',
    'LBL_TASK_ID_WIDGET' => 'id',
    'LBL_TASK_NAME_WIDGET' => 'descrição',
    'LBL_DURATION_WIDGET' => 'duração',
    'LBL_START_WIDGET' => 'data_de_início',
    'LBL_FINISH_WIDGET' => 'data_de_conclusão',
    'LBL_PREDECESSORS_WIDGET' => 'predecessores_',
    'LBL_PERCENT_COMPLETE_WIDGET' => 'porcentagem_concluída',
    'LBL_RESOURCE_NAMES_WIDGET' => 'recurso',
    'LBL_EDIT_PROJECT_TASKS_TITLE'=> 'Editar Tarefas de Projeto',
    'LBL_VIEW_GANTT_TITLE' => 'Visualizar Gantt',
    
    'LBL_INSERT_BUTTON' => 'Inserir linhas',
    'LBL_INDENT_BUTTON' => 'Indentar',
    'LBL_OUTDENT_BUTTON' => 'Diminuir Identação',
    ...
    'LBL_FILTER_VIEW' => 'Visualização',
    'LBL_LIST_FILTER_VIEW' => 'Visualização:',
    ...
    'LBL_FILTER_MY_OVERDUE_TASKS' => 'Minhas Tarefas Atrasadas',    
...
/*
  ...
  */   
    ...
    'ERR_TASK_NAME_FOR_ROW' => 'Nome de Tarefa para linha ',
    'ERR_IS_EMPTY' => 'não pode estar vazio.',   
    'ERR_PERCENT_COMPLETE' => '% Concluído deve ser um valor entre 0 e 100.',   
    'ERR_DURATION' => 'Duração deve ser um número inteiro.',
    'ERR_DATE' => 'A Data especificada cai em um dia não comercial, selecionando primeiro dia útil válido.',
    ...
    'ERR_PREDECESSORS_OUT_OF_RANGE' => 'O valor especificado para o campo Predecessores é maior que o número de linhas.',   
    'ERR_PREDECESSOR_CYCLE_FAIL' => 'O predecessor especificado causa um ciclo de dependência.',
    'ERR_PREDECESSOR_IS_PARENT_OR_CHILD_FAIL' => 'O predecessor especificado é uma tarefa principal ou uma subtarefa.', 
    'ERR_TASK_VIEW_DETAILS' => 'Não é possível visualizar os detalhes de uma tarefa que ainda não foi salva.',
    'NTC_DELETE_TASK_AND_SUBTASKS' => 'Tem certeza de que deseja excluir esta tarefa e todas as subtarefas?',
    'NTC_NO_ACTIVE_PROJECTS' => 'Não há projetos ativos ou tarefas de projetos.',
    'NTC_ASSIGN_RIGHT_TEAM' => 'Certifique-se de que todos os recursos do Projeto sejam membros desta equipe.',
    ...
    'LBL_POPUP_PERCENT_COMPLETE' => '% Concluído: ',
    ...
    'LBL_PERSONAL_HOLIDAY' => '-- Férias Pessoais --',
