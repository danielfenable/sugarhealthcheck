/*
     ...
     */
YUI.add('align-plugin',function(Y,NAME){var OFFSET_WIDTH='offsetWidth',OFFSET_HEIGHT='offsetHeight',undefined=undefined;function Align(config){if(config.host){this._host=config.host;}}
...
return ret;}};Align.NAME='Align';Align.NS='align';Align.prototype.constructor=Align;Y.namespace('Plugin');Y.Plugin.Align=Align;},'3.15.0',{"requires":["node-screen","node-pluginhost"]});