...
de la tabla de direcciones. Un ejemplo podría ser el botón "Copiar" presente en la vista de detalle del módulo Cuentas.
Ver modulos/Cuentas/vistas/view.detail.php para ver el valor que se establece
*}}
