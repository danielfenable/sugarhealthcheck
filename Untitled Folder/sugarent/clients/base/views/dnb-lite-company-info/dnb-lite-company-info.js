...
this.baseFilterData();},refreshClicked:function(){this.loadCompanyInfo(false);},loadCompanyInfo:function(isCollapsed){if(!isCollapsed){this.loadDNBData('duns_num','dnb_temp_duns_num',this.getDNBLiteCompanyDetails,null,'dnb.dnb-no-duns','dnb.dnb-no-duns-field');}},getDNBLiteCompanyDetails:function(duns_num){if(this.disposed){return;}
