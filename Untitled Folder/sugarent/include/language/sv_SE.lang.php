...
2. Klicka på "Spara" för att spara den nya posten och återgå till listvyn för {{plural_module_name}}.',
    ...
    'LBL_PMSE_PROCESSES_DASHLET_DESCRIPTION' => 'Processdashleten visar mallarna som kan användas i processförfattaren.',

    //PMSE Process Definitions Dashlet
    'LBL_PMSE_PROCESS_DEFINITIONS_DASHLET' => 'Processdefinitioner',
    'LBL_PMSE_PROCESS_DEFINITIONS_DASHLET_DESCRIPTION' => 'Processdefinitionsdashleten visar mallarna som kan användas i processförfattaren.',
    ...
    'LBL_PMSE_BUSINESS_RULES_DASHLET_DESCRIPTION' => 'Processaffärsregeldashleten visar mallarna som kan användas i processförfattaren.',
    ...
    'LBL_PMSE_EMAIL_TEMPLATES_DASHLET_DESCRIPTION' => 'Process-emailmall-dashleten visar mallarna som kan användas i processförfattaren.',
    ...
    'LBL_PMSE_IMPORT_EXPORT_WARNING' => 'När du utvecklar processer, affärsregler eller epostmallar i en annan instans av Sugar rekommenderar vi starkt att använda en exakt klon av ditt produktionssystem. Processer, affärsregler och epostmallar som byggts i en enskild version av Sugar kan fungera dåligt när de väl importeras. Processer, affärsregler och epostmallar kan förlita sig på specifika Studio- eller applikationsförändringar som egna fältnamn, menyalternativ, databas-IDn, etc. Om dessa värden inte är identiska med instansen där processen, affärsregeln eller epostmallen byggdes kan du behöva bygga om processen, affärsregeln eller epostmallen i din målinstans.',
    ...
    'LBL_PMSE_SETTINGS' => 'Processförfattarinställningar',
