...
$mod_strings = array(
    ...
    // Help Text
    // List View Help Text
    'LBL_HELP_RECORDS' => '{{plural_module_name}} modülü, müşterilere satılmış veya satış süreci devam eden bütün ürünlerinden oluşmaktadır. Firmanız tarafından satılan ürünler Sistem Yöneticisi > Ürün Kataloğu içinde yer almakta olup, sistem yöneticileri gerektiğinde ürün ekleyebilmektedir. {{plural_module_name}} oluşturulurken, katalog içinden ürün seçebilir veya {{plural_module_name}} modülü ile ürün oluşturulabilir. {{plural_module_name}} kaydı oluşturmak için Sugar içinde farklı yöntemler bulunmaktadır, örneğin {{plural_module_name}} modülü ile, {{quotes_module}} modülünde, aynı kayıttan oluşturarak, dışarıdan {{plural_module_name}} içeri yükleyerek, vb. {{module_name}} kaydı oluşturulduğunda, {{module_name}} modülündeki eksik bilgileri {{plural_module_name}} kayıt izleme ekranından görebilir ve düzeltebilirsiniz.',
...
- Daha fazla aksiyon, Değiştir tuşunun sağındaki Aksiyonlar seçimli menüde yer almaktadır.',
    ...
    'LBL_HELP_CREATE' => '{{plural_module_name}} modülü, müşterilere satılmış veya satış süreci devam eden bütün ürünlerinden oluşmaktadır.
