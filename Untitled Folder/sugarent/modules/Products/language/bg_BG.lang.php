...
$mod_strings = array(
    ...
    'LBL_MODULE_TITLE' => 'Оферирани продукти: Начало',
    'LBL_SEARCH_FORM_TITLE' => 'Търсене в модул "Оферирани продукти"',
    'LBL_LIST_FORM_TITLE' => 'Списък с оферирани продукти',
    'LBL_NEW_FORM_TITLE' => 'Въвеждане на офериран продукт',
    'LBL_PRODUCT' => 'Офериран продукт:',
    'LBL_RELATED_PRODUCTS' => 'Свързани оферирани продукти',
    ...
    'LNK_PRODUCT_LIST' => 'Списък с оферирани продукти',
    'LNK_NEW_PRODUCT' => 'Въвеждане на офериран продукт',
    ...
    'LBL_DEFAULT_SUBPANEL_TITLE' => 'Оферирани продукти',
    'LBL_RELATED_PRODUCTS_TITLE' => 'Оферирани продукти',
    'LBL_WEBSITE' => 'Сайт',
    ...
    'LBL_CALCULATED_LINE_ITEM_AMOUNT' => 'Сума на оферираните продукти',
    ...
    'LNK_IMPORT_PRODUCTS' => 'Импортиране на оферирани продукти',
