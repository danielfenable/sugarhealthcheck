...
$mod_strings = array(
    ...
    'LBL_MODULE_TITLE' => 'Piedāvājuma rindas produkti: Sākums',
    ...
    // Help Text
    // List View Help Text
    'LBL_HELP_RECORDS' => 'Modulis {{plural_module_name}} satur visus produktus, kas ir tikuši pārdoti klientiem vai kuru pārdošana vēl ir procesā. Produktu saraksts, ko jūsu uzņēmums ir pārdevis klientiem, atrodas sadaļā Administrators > Produktu katalogs, un administratori var pievienot jaunus produktus pēc vajadzības. Moduļa {{plural_module_name}} izveides laikā jūs varat vai nu izvēlēties produktus no kataloga, vai izveidot jaunus produktus, izmantojot moduli {{plural_module_name}}. Ir vairāki veidi, kā var izveidot moduli {{plural_module_name}} Sugar, piemēram, izmantojot moduli {{plural_module_name}}, moduli {{quotes_module}}, dublējot, importējot moduli {{plural_module_name}} utt. Kad moduļa {{module_name}} ieraksts ir izveidots, informāciju par moduli {{module_name}} var aplūkot un rediģēt moduļa {{plural_module_name}} ierakstu skatījuma režīmā.',
...
- Papildus darbības pieejamas izkrītošajā darbību izvēlnē pa labi no Rediģēšanas pogas.',
    ...
    'LBL_HELP_CREATE' => 'Modulis {{plural_module_name}} satur visus produktus, kas ir tikuši pārdoti klientiem vai kuru pārdošanas vēl ir procesā.
