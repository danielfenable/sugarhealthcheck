...
$mod_strings = array(
    ...
    'LBL_MODULE_TITLE' => 'Elements de la línia pressupostada: inici',
    'LBL_SEARCH_FORM_TITLE' => 'Cerca d&#39;elements de la línia pressupostada',
    'LBL_LIST_FORM_TITLE' => 'Llista d&#39;elements de línia de pressupost',
    'LBL_NEW_FORM_TITLE' => 'Crear element de la línia pressupostada',
    ...
    'LBL_REVENUELINEITEM' => 'Element de la línia d&#39;impostos', 
    ...
    // Help Text
    // List View Help Text
    'LBL_HELP_RECORDS' => 'El mòdul {{plural_module_name}} consisteix en tots el productes que ja s&#39;han venut o que s&#39;estan venent als clients. La llista de productes venuts per l&#39;organització està a Administració > Catàleg de productes i els administradors poden afegir productes quan sigui necessari. En crear {{plural_module_name}}, teniu l&#39;opció de seleccionar productes del catàleg o crear nou productes al mòdul {{plural_module_name}}. Hi ha vàries maneres de crear un {{plural_module_name}} a Sugar, com ara amb el mòdul {{plural_module_name}}, mòdul {{quotes_module}}, dulicació, importació de {{plural_module_name}}, etc. Quan es crea el registre del {{module_name}}, podeu veure i editar la informació que pertany al {{module_name}} mitjançant la vista de registres de {{plural_module_name}}.',

    // Record View Help Text
    'LBL_HELP_RECORD' => 'El mòdul {{plural_module_name}} consisteix en tots el productes que ja s&#39;han venut o que s&#39;estan venent als clients.
...
- Hi ha accions addicionals disponibles al menú desplegable d&#39;accions a la dreta del botó Edita.',
    ...
    'LBL_HELP_CREATE' => 'El mòdul {{plural_module_name}} consisteix en tots el productes que ja s&#39;han venut o que s&#39;estan venent als clients.
