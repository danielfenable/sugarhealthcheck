...
$mod_strings = array (
  ...
  'LBL_TEAM_NOTICE_TRACKER' => 'トラッカーはSugarCRMの利用度やパフォーマンスを提示します。<br />機能:<br />* トラッカーレポートはCRM利用時にユーザ導入と可視性を増やすためにスナップショットを提供します。ユーザは週単位のCRMのアクティビティ/参照されたレコードやモジュール/他のチームメンバーの累積ログイン時間やオンライン状況をレポートとして参照することができます。<br />* システムモニターはシステムがどのように利用されているか、またアプリケーションの潜在的なストレスの情報を管理者に提供します。',
