...
'help'=>array(
    'package'=>array(
            ...
            'exportbtn'=>'Kliknij <b>Eksport</b> aby utworzyć plik .zip, zawierający modyfikacje utworzone w pakiecie.<br><br> Wygenerowany plik nie jest plikiem instalacyjnym pakietu.<br><br>Poprzez <b>Zarządzanie modułami</b> można zaimportować plik .zip i i wyświetlić pakiet wraz z modyfikacjami w Kreatorze modułów.',
    ...
    'module'=>array(
        ...
        'importable'=>'Zaznaczenie pola <b>Importowalny</b> umożliwi wykonywanie importu dla tego modułu.<br><br>Łącze do Kreatora importu pojawi się w panelu Skróty modułu. Kreator importu pozwala importować dane z zewnętrzynch źrodeł do własnego modułu.',
        ...
        'viewrelsbtn'=>'Kliknij <b>Zobacz relacje</b>, aby zobaczyć relacje tego modułu z innymi lub utworzyć nowe.',
        'viewlayoutsbtn'=>'Kliknij <b>Zobacz widoki</b>, aby zobaczyć widoki modułu i ustawić własny układ pól w tych widokach.',
        'viewmobilelayoutsbtn' => 'Kliknij <b>Zobacz mobilne widoki</b>, aby zobaczyć mobilne widoki dla modułu i spersonalizować układ pól w widokach.',
    ...
    ,
        ...
        'historyBtn'=> 'Kliknij <b>Zobacz historię</b>, aby wyświetlić i przywrócić poprzednio zapisany układ z historii.',
    ...
    ,
        ...
        'historyBtn'=> 'Kliknij <b>Zobacz historię</b>, aby zobaczyć historię zmian lub przywrócić poprzednio zachowany widok. <br><br>Kliknięcie <b>Przywróć</b> w obszarze <b>Zobacz historię</b> przywraca położenie pól z poprzednio zapisanego układu. Aby zmienić etykiety pól, kliknij przycisk edycji znajdujący się obok każdego pola.',
    ...
    ,
        'savebtn'	=> 'Kliknij <b>Zapisz i zamieść</b>, aby zachować zmiany i aktywować je w module.',
        'historyBtn'=> 'Kliknij <b>Zobacz historię</b>, aby zobaczyć historię zmian lub przywrócić poprzednio zachowany układ. <br><br>Kliknięcie<b>Przywróć</b> w obszarze <b>Zobacz historię</b> przywraca położenie pól z poprzednio zapisanych układów. Aby zmienić etykiety pól, kliknij przycisk edycji znajdujący się obok każdego pola.',
        'historyRestoreDefaultLayout'=> 'Kliknij opcję <b>Przywróć domyślny układ</b>, aby przywrócić widok do oryginalnego układu.<br><br>Opcja <b>Przywróć domyślny układ</b> powoduje tylko przywrócenie rozmieszczenia pól w ramach oryginalnego układu. Aby zmienić etykiety pól, kliknij ikonę Edycja obok danego pola.',
        'Hidden' 	=> 'Pola <b>Ukryte</b> nie są obecnie dostępne dla użytkowników w widokach listy.',
        'Default'	=> 'Pola <b>Domyślne</b>, widoczne w widokach listy, nie są edytowalne przez użytkowników.'
    ),
    ...
    . '<br/><br/>This configuration applies to popup search layout in legacy modules only.',
        ...
        'historyBtn'=> 'Kliknij <b>Zobacz historię</b>, aby zobaczyć historię zmian lub przywrócić poprzednio zachowany układ. <br><br>Kliknięcie<b>Przywróć</b> w <b>Zobacz historię</b> przywraca położenie pól z poprzednio zapisanych układów. Aby zmienić etykiety pól, kliknij przycisk edycji znajdujący się obok każdego pola.',
        'historyRestoreDefaultLayout'=> 'Kliknij opcję <b>Przywróć domyślny układ</b>, aby przywrócić widok do oryginalnego układu.<br><br>Opcja <b>Przywróć domyślny układ</b> powoduje tylko przywrócenie rozmieszczenia pól w ramach oryginalnego układu. Aby zmienić etykiety pól, kliknij ikonę Edycja obok danego pola.',
    ...
    'fieldsEditor'=>array(
        ...
        'mbDefault'=>'<b>Pola</b> dostępne w tym module są wymienione tutaj wg wartości Nazwa pola.<br><br>Aby skonfigurować właściwości dla pola, kliknij jego nazwę.<br><br>Aby utworzyć nowe pole, kliknij <b>Dodaj pole</b>. Etykietę wraz z właściwościami utworzonego pola można edytować później przez kliknięcie nazwy pola.<br><br>Po zamieszczeniu modułu nowe pola utworzone w Kreatorze modułu są traktowane jako standardowe pola w zamieszczonym module w Studio.',
    ...
    'studioWizard'=>array(
        ...
        'PopupListViewBtn' => 'Układ <b>Widok listy wyskakującego okienka</b> służy do wyświetlania listy rekordów podczas wybierania jednego lib kilku rekordów odnoszących się do bieżącego rekordu.',
...
//HOME
'LBL_HOME_EDIT_DROPDOWNS'=>'Edytor list rozwijalnych',
...
'LBL_PARENT_DROPDOWN' => 'Narzędna lista rozwjana',
...
'LBL_BTN_VIEW_MOBILE_LAYOUTS'=>'Zobacz układy mobilne',
...
// underscores
'LBL_JS_DELETE_REQUIRED_DDL_ITEM_NEW' => 'Czy na pewno chcesz usunąć status sprzedaży Nowy? Usunięcie tego statusu spowoduje niepoprawne działanie przepływu pracy Pozycja pojedyncza przychodu w module Szanse.',
'LBL_JS_DELETE_REQUIRED_DDL_ITEM_IN_PROGRESS' => 'Czy na pewno chcesz usunąć status sprzedaży W trakcie? Usunięcie tego statusu spowoduje niepoprawne działanie przepływu pracy Pozycja pojedyncza przychodu w module Szanse.',
...
'LBL_REMOVE_FIELDS' => 'Usuń niestandardowe pola',
