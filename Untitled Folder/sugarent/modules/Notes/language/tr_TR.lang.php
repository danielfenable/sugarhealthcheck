...
$mod_strings = array(
    ...
    'LBL_HELP_RECORD' => '{{plural_module_name}} modülü, ilişkili kayda ait metin veya ek dosya {{plural_module_name}} kayıtlarından oluşur.
...
- Daha fazla aksiyon, Değiştir tuşunun sağındaki Aksiyonlar seçimli menüde yer almaktadır.',
    ...
    'LBL_HELP_CREATE' => '{{module_name}} oluşturmak için:
