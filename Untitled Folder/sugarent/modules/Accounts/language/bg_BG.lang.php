...
$mod_strings = array (
    ...
    'LBL_QUOTES_BILLTO' => 'Оферти (Да се фактурира на)',
...
- Можете да извършвате допълнителни действия със записа като използвате падащото меню в дясно на бутона „Редактирай“.',
    ...
    'LBL_HELP_CREATE' => 'Модулът {{plural_module_name}} съдържа данни за компании, с които поддържате бизнес взаимоотношения. Той може да се използва като централно място, от където могат да бъдат управлявани и анализирани контактите с всеки клиент.
