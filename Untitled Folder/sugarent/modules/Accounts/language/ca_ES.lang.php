...
$mod_strings = array (
    ...
    'LBL_QUOTES_BILLTO' => 'Pressupostos (Facturat a)',
	...
	'LBL_EMAIL_ADDRESSES' => 'Adreces electròniques',
    ...
    // Help Text
    // List View Help Text
    'LBL_HELP_RECORDS' => 'El mòdul {{plural_module_name}} consisteix en companyies que tenen alguna relació amb la vostra organització i generalment es consideren com el centre per gestionar i analitzar les interaccions de la vostra empresa amb els clients. Hi ha vàries maneres de crear {{plural_module_name}} a Sugar com ara, mitjançant el mòdul {{plural_module_name}}, duplicació, importació de {{plural_module_name}}, etc. Quan ja s&#39;ha creat el {{module_name}}, podeu veure i editar la informació que pertany al {{module_name}} a la vista de registre de {{plural_module_name}}. A continuació cada registre de {{module_name}} es pot relacionar amb altres registres de Sugar, com ara {{contacts_module}}, {{meetings_module}}, {{cases_module}}, {{opportunities_module}} i molts altres al temps que la relació amb el client madura.',

    // Record View Help Text
    'LBL_HELP_RECORD' => 'El mòdul {{plural_module_name}} consisteix en companyies que tenen alguna relació amb la vostra organització i generalment es consideren com el centre per gestionar i analitzar les interaccions de la vostra empresa amb els clients.
...
- Hi ha accions addicionals disponibles al menú desplegable d&#39;accions a la dreta del botó Edita.',
    ...
    'LBL_HELP_CREATE' => 'El mòdul {{plural_module_name}} consisteix en companyies que tenen alguna relació amb la vostra organització i generalment es consideren com el centre per gestionar i analitzar les interaccions de la seva empresa amb els clients. 
