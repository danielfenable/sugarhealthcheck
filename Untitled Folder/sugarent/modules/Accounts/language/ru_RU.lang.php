...
$mod_strings = array (
    ...
    'LBL_QUOTES_BILLTO' => 'Коммерческие предложения: Юридический адрес',
    ...
    // Help Text
    // List View Help Text
    'LBL_HELP_RECORDS' => 'Модуль {{plural_module_name}} содержит перечень компаний, с которыми взаимодействует Ваша организация, и является узлом, в котором Вы можете осуществлять анализ своей деятельности с клиентами и управлять такой деятельностью. Вы можете создать модуль {{plural_module_name}} в Sugar многими способами: через модуль {{plural_module_name}}, дублирование, импорт {{plural_module_name}}, и др. Как только запись {{module_name}} создана, Вы можете просмотреть и редактировать информацию, касающуюся модуля {{module_name}} в режиме просмотра записи {{plural_module_name}}. Каждая запись {{module_name}} может быть связана с другой записью Sugar, такой как {{contacts_module}}, {{meetings_module}}, {{cases_module}}, {{opportunities_module}}, и многими другими записями в процессе развития отношений с клиентами.',

    // Record View Help Text
    'LBL_HELP_RECORD' => 'Модуль {{plural_module_name}} содержит перечень компаний, с которыми взаимодействует Ваша организация, и является узлом, где Вы можете управлять и анализировать Ваши активности с клиентами.
...
- Дополнительные действия доступны в выпадающем меню Действий справа от кнопки Редактировать.',
    ...
    'LBL_HELP_CREATE' => 'Модуль {{plural_module_name}} содержит перечень компаний, с которыми взаимодействует Ваша организация, и является узлом, где Вы можете управлять Вашим взаимодействием с клиентами и анализировать его.
