...
$mod_strings = array (
    'ERR_NO_OPPS' => 'אנא צור כמה הזדמנויות כדי לראות גרף הזדמנות.',
    'LBL_ALL_OPPORTUNITIES' => 'סכום כולל של כל ההזדמנויות הוא',
    'LBL_CHART_TYPE' => 'סוג תרשים:',
    'LBL_CREATED_ON' => 'הורץ לאחרונה',
	'LBL_CLOSE_DATE_START' => 'תאריך סגירה צפוי - מ:',
	'LBL_CLOSE_DATE_END'   => 'תאריך סגירה צפוי - עד:',
    'LBL_DATE_END' => 'תאריך סיום:',
    'LBL_DATE_RANGE_TO' => 'ל',
    'LBL_DATE_RANGE' => 'טווח הנתונים הוא',
    'LBL_DATE_START' => 'תאריך התחלה:',
    'LBL_EDIT' => 'ערוך',
    'LBL_LEAD_SOURCE_BY_OUTCOME_DESC' => 'מציג סכומי הזדמנות מצטברים של מקור מוביל שנבחר לפי תוצאה עבור המשתמשים שנבחרו. התוצאה מתבססת על שלב המכירות, בין אם הוא סגורה וזכייה, סגורה והפסד, או כל ערך אחר.',
    'LBL_LEAD_SOURCE_BY_OUTCOME' => 'כל ההזדמנויות לפי מקור מוביל לפי תוצאה',
    'LBL_LEAD_SOURCE_FORM_DESC' => 'מציג סכומי הזדמנות מצטברים לפי מקור מוביל שנבחר עבור המשתמשים שנבחרו.',
    'LBL_LEAD_SOURCE_FORM_TITLE' => 'כל ההזדמנויות של מקור מוביל',
    ...
    'LBL_MONTH_BY_OUTCOME_DESC' => 'מציג סכומי הזדנות מצטברים לפי חודש לפי תוצאה עבור משתמשים שנבחרו כאשר תאריך הסגירה הצפוי נמצא בתוך טווח התאריכים שצוין. התוצאה מתבססת על שלב המכירה, בין אם הוא סגורה וזכייה, סגורה והפסד, או כל ערך אחר.',
    ...
    'LBL_PIPELINE_FORM_TITLE_DESC' => 'מציג סכומים מצטברים לפי שלבי מכירות נבחרים עבור ההזדמנויות שלך כאשר תאריך הסגירה הצפוי נמצא בתוך טווח התאריכים שצוין.',
    'LBL_CAMPAIGN_ROI_TITLE_DESC' => 'מציג תגובה לקמפיין לפי תשואה להשקעה.',
    'LBL_REFRESH' => 'רענן',
    'LBL_ROLLOVER_DETAILS' => 'הפוך טור אחד לפרטים.',
    'LBL_ROLLOVER_WEDGE_DETAILS' => 'הפוך יתד לפרטים.',
    'LBL_SALES_STAGE_FORM_DESC' => 'מציג סכומי הזדמנות מצטברים לפי שלבי מכירות נבחרים עבור המשתמשים שנבחרו כאשר תאריך הסגירה הצפוי נמצא בתוך טווח התאריכים שצוין.',
    'LBL_SALES_STAGE_FORM_TITLE' => 'Pipeline By Sales Stage',
    'LBL_SALES_STAGES' => 'שלב במכירות:',
    'LBL_TOTAL_PIPELINE' => 'Pipeline total is',
    'LBL_USERS' => 'משתמשים:',
    'LBL_YEAR_BY_OUTCOME' => 'קו ציונר לפי חודש לפי תוצאה',
    'LBL_YEAR' => 'שנה:',
