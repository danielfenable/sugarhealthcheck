...
$mod_strings = array (
    ...
    'LBL_ATTACH_SUGAR_DOC'      => 'シュガードキュメントを添付',
	'LBL_ATTACHMENTS'			=> '添付',
	...
	'LBL_EMAILTEMPLATE_MESSAGE_SHOW_MSG' => 'このテンプレートを選択するとEメールの本文に入力されている内容はすべて失われます。継続してよいですか？',
    'LBL_EMAILTEMPLATE_MESSAGE_CLEAR_MSG' => '「--なし--」を選択するとEメールの本文に入力されている内容はすべて失われます。継続してよいですか？',
	'LBL_EMAILTEMPLATE_MESSAGE_WARNING_TITLE' => '警告:',
	'LBL_EMAILTEMPLATE_MESSAGE_MULTIPLE_RECIPIENTS' => '取引先担当者の名前などを含むEメールテンプレートを用いて複数の受信者にEメールを送信すると予期せぬ結果を招くことがあります。一括Eメールを送信する際はEメールキャンペーンを利用することをお勧めします。',
