/*
     ...
     */
var AjaxObject={ret:'',currentRequestObject:null,timeout:300000,forceAbort:false,_reset:function(){this.timeout=300000;this.forceAbort=false;},handleFailure:function(o){alert(SUGAR.language.get('Administration','LBL_ASYNC_CALL_FAILED'));},startRequest:function(callback,args,forceAbort){if(this.currentRequestObject!=null){if(this.forceAbort==true||callback.forceAbort==true){YAHOO.util.Connect.abort(this.currentRequestObject,null,false);}}
