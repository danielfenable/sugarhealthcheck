...
$mod_strings = array(
	...
	'DESC_MODULES_QUEUED'						=> 'Les modules suivants sont prêts pour l&#39;installation :',
	...
	'ERR_UW_CONFIG'								=> 'Veuillez mettre des droits d&#39;écriture sur votre fichier et recharger cette page.',
	'ERR_UW_DIR_NOT_WRITABLE'					=> 'Répertoire non accessible en écriture',
	...
	'ERR_UW_FILE_NOT_WRITABLE'					=> 'Le fichier ne peut pas être déplacé ou copié vers',
	'ERR_UW_FLAVOR_2'							=> 'Mise à jour de la version : ',
	'ERR_UW_FLAVOR'								=> 'Édition de SugarCRM : ',
    ...
    'ERR_UW_MBSTRING_FUNC_OVERLOAD'				=> 'La valeur de mbstring.func_overload est supérieure à 1. <br/>Merci de changer cette valeur dans votre fichier php.ini et de redémarrer le serveur web.',
	'ERR_UW_MYSQL_VERSION'						=> 'SugarCRM exige MySQL version 4.1.2 ou +. Version trouvée :',
	'ERR_UW_OCI8_VERSION'				        => 'Votre version actuelle d&#39;Oracle n&#39;est pas prise en charge par Sugar. Vous devez installer une version compatible avec Sugar. Veuillez consulter la matrice de compatibilité des "Release Notes" pour les versions d&#39;Oracle prises en charge. Version actuelle : ',
    ...
    'ERROR_FLAVOR_INCOMPATIBLE'                 => 'Le fichier uploadé n&#39; est pas compatible avec cette version (Community Édition, Professional, ou Enterprise) de SugarCRM :',
	...
	'LBL_UW_CHECKLIST'							=> 'Étapes de mise à jour',
	...
	'LBL_UW_COMPLIANCE_MSSQL_MAGIC_QUOTES'		=> 'MS SQL Server & PHP guillemets magiques GPC',
	...
	'LBL_UW_OVERWRITE_DESC'						=> "Tous les fichiers modifiés vont être écrasés - comprenant les personnalisations de code et modifications de template. Êtes-vous sûr(e) de vouloir continuer ?",
	...
	'LBL_UW_SHOW_COMPLIANCE'					=> 'Afficher les paramètres détectés',
	'LBL_UW_SHOW_DB_PERMS'						=> 'Afficher les permissions absentes de la base de données',
	'LBL_UW_SHOW_DETAILS'						=> 'Afficher les détails',
	'LBL_UW_SHOW_DIFFS'							=> 'Afficher les fichiers nécessitant une fusion manuelle',
	'LBL_UW_SHOW_NW_FILES'						=> 'Afficher les fichiers avec des permissions non valides',
	'LBL_UW_SHOW_SCHEMA'						=> 'Afficher le schéma du script de modification',
	'LBL_UW_SHOW_SQL_ERRORS'					=> 'Afficher les requêtes incorrectes',
	'LBL_UW_SHOW'								=> 'Afficher',
	...
	'LBL_UW_SHOW_OLD_SCHEMA_TO_DROP'			=> 'Afficher l&#39;ancien schéma qui doit être supprimé',
