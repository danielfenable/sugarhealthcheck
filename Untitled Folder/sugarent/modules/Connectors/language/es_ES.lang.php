...
$mod_strings = array(
    ...
    'LBL_DUNS' => 'DUNS',
    'LBL_EMPTY_BEANS' => 'No se ha encontrado ninguna coincidencia con sus criterios de búsqueda.',
    ...
    'LBL_MARKET_CAP' => 'Techo de mercado',
    'LBL_MERGE' => 'Combinar',
    'LBL_MODIFY_DISPLAY_TITLE' => 'Habilitar Conectores',
    'LBL_MODIFY_DISPLAY_DESC' => 'Seleccionar los módulos habilitados para cada conector.',
    'LBL_MODIFY_DISPLAY_PAGE_TITLE' => 'Configuración de Conectores: Habilitar Conectores',
    'LBL_MODULE_FIELDS' => 'Campos del Módulo',
    'LBL_MODIFY_MAPPING_TITLE' => 'Asignar Campos del Conector',
    'LBL_MODIFY_MAPPING_DESC' => 'Asignar campos del conector a campos del módulo para determinar los datos del conector que se pueden ver y combinar con los registros del módulo.',
    'LBL_MODIFY_MAPPING_PAGE_TITLE' => 'Configuración de Conectores: Asignar Campos del Conector',
    'LBL_MODIFY_PROPERTIES_TITLE' => 'Establecer Propiedades del Conector',
    'LBL_MODIFY_PROPERTIES_DESC' => 'Configurar las propiedades de cada conector, incluyendo las URL y las claves de API.',
    ...
    'LBL_MODIFY_SEARCH_DESC' => 'Seleccionar los campos del conector que se utilizarán para la búsqueda de datos de cada módulo.',
    ...
    'LBL_PARENT_DUNS' => 'DUNS principales',
    'LBL_PREVIOUS' => '< Atrás',
    'LBL_QUOTE' => 'Presupuesto',
    'LBL_RECNAME' => 'Nombre de Empresa',
    ...
    'LBL_ULTIMATE_PARENT_DUNS' => 'DUNS Pincipal Final',
    'ERROR_RECORD_NOT_SELECTED' => 'Error: seleccione un registro de la lista antes de continuar.',
    'ERROR_EMPTY_WRAPPER' => 'Error: Ha sido imposible recuperar la instancia adaptadora para el origen [{$source_id}]',
    ...
    'ERROR_NO_SEARCHDEFS_MAPPED' => 'No hay ningún conector habilitado con campos de búsqueda definidos.',
    ...
    'ERROR_NO_CONNECTOR_DISPLAY_CONFIG_FILE' => 'Error: No se han asignado conectores a este módulo.',
    'ERROR_NO_SEARCHDEFS_MAPPING' => 'Error: No se han definido campos de búsqueda para el módulo y el conector.  Póngase en contacto con el administrador del sistema.',
    'ERROR_NO_FIELDS_MAPPED' => 'Error: Debe asignar por lo menos un campo del Conector a un campo de módulo para cada entrada de módulo.',
    'ERROR_NO_DISPLAYABLE_MAPPED_FIELDS' => 'Error: No se ha asignado ningún campo de módulo para ser mostrado como parte de los resultados.  Póngase en contacto con el administrador del sistema.',
