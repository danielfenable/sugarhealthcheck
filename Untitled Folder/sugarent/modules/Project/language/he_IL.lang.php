...
/*
  ...
  */   
    ...
    'ERR_PERCENT_COMPLETE' => '% שהסתיימו חייב להיות ערך בין 0 ל-100.',   
    'ERR_DURATION' => 'המשך חייב להיות מספר שלם.',
    'ERR_DATE' => 'Specified date falls on a non-working day.',
    'ERR_FINISH_DATE' => 'תאריך סיום לא יכול לבוא לפני תאריך ההתחלה.',
    'ERR_PREDECESSORS_INPUT' => 'ערכים שהוזנו בשדה קודמים חייבים להיות בצורה של "1" או "1.2"',
    'ERR_PREDECESSORS_OUT_OF_RANGE' => 'השדה שצוין עבור השדה קודם גדול ממספר השורות.',   
    'ERR_PREDECESSOR_CYCLE_FAIL' => 'הקודם שצוין גורם למעגל תלות.',
    'ERR_PREDECESSOR_IS_PARENT_OR_CHILD_FAIL' => 'הקודם שצוין הוא משימת אב או משימת משנה.', 
    'ERR_TASK_VIEW_DETAILS' => 'אתה לא יכול לצפות בפרטים של משימה שעוד לא נשמרה.',
    'NTC_DELETE_TASK_AND_SUBTASKS' => 'האם אתה בטוח שברצונך למחוק משימה זו ואת כל משימות המשנה שלה?',
    'NTC_NO_ACTIVE_PROJECTS' => 'אין לך פרויקטים פעילים או משימות פרויקט.',
    'NTC_ASSIGN_RIGHT_TEAM' => 'ודא שכל משאבי הפרויקט חברים בצוות זה.',
