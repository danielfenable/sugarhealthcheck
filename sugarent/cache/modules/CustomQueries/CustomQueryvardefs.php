<?php 
 $GLOBALS["dictionary"]["CustomQuery"]=array (
  ...
  array (
    ...
    array (
      'name' => 'team_link',
      'type' => 'link',
      'relationship' => 'customqueries_team',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'customqueries_team_count_relationship',
      'link_type' => 'one',
      'module' => 'Teams',
      'bean_name' => 'TeamSet',
      'source' => 'non-db',
    ...
    array (
      'name' => 'teams',
      'type' => 'link',
      'relationship' => 'customqueries_teams',
  ...
  'indices' => 
  array (
    'team_set_custom_queries' => 
    array (
      'name' => 'idx_custom_queries_tmst_id',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'team_set_id',
