...
<li>Mene sivulle Administration -> Manage Organization.</li>
<li>Valitse "Integrated Third-Party Apps" -linki sivupalkista ja ota käyttöön SugarCRM kaikille käyttäjille.</li>
<li>Valitse sivupalkista "Internal Apps" ja "Register App".</li>
<li>Anna sovellukselle nimi (vaikkapa "SugarCRM tuotanto") ja varmista, että "OAuth 2.x" -valintaruutu <strong>EI</strong> ole valittuna ponnahdusikkunan alalaidassa.</li>
