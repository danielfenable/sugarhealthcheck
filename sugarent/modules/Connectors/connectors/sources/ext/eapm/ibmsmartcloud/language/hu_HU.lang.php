...
class="dataLabel">A Sugar termék IBM SmartCloud felületen való regisztrálásával API és titkos ügyfélkulcsokhoz juthat.<br>
&nbsp;<br>
A regisztrálás lépései:<br>
&nbsp;<br>
<ol>
<li>Jelentkezzen be IBM SmartCloud fiókjába (Önnek adminisztrátornak kell lennie)!</li>
<li>Lépjen be az alábbi menüpontba: Administration > Manage Organization!</li>
