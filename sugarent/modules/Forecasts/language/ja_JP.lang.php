...
$mod_strings = array (
    ...
    'LBL_FORECASTS_CONFIG_HELP_RANGES' => '{{forecastByModule}} をどのカテゴリに入れるかを設定します。 <br><br>範囲設定は初回しか変更できないことにご注意ください。アップグレードされたインスタンスでは、範囲設定が既存の売上予測データにロックされています。<br><br>確率の範囲に基づいて 2 または 3 つ以上のカテゴリを選択することができます。<br><br>ユーザーは {{forecastByModule}} を含む／含まないの状態とカテゴリをワークシートから手動で変更できます。',
