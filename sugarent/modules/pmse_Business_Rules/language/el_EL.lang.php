...
$mod_strings = array (
  ...
  'LBL_RST_UPDATE_DATE' => 'Ημερομηνία Ενημέρωσης Επιχειρησιακών Κανόνων',
    ...
    'LNK_NEW_PMSE_BUSINESS_RULES' => 'Δημιουργία Διεργασιών Επιχειρησιακών Κανόνων',
    'LNK_IMPORT_PMSE_BUSINESS_RULES' => 'Εισαγωγή Διεργασιών Επιχειρησιακών Κανόνων',
    ...
    'LBL_PMSE_MESSAGE_LABEL_CHANGE_COLUMN_TYPE' => 'Οι τιμές που σχετίζονται με τη συγκεκριμένη μεταβλητή θα αφαιρεθούν. Θέλετε να συνεχίσετε;',
    'LBL_PMSE_MESSAGE_LABEL_REMOVE_VARIABLE' => 'Θέλετε όντως να αφαιρέσετε τη συγκεκριμένη μεταβλητή;',
    ...
    'LBL_PMSE_MESSAGE_REQUIRED_FIELDS_BUSINESSRULES' => 'Αυτός ο επιχειρησιακός κανόνας δεν είναι έγκυρος, δεδομένου ότι χρησιμοποιεί μη έγκυρα πεδία ή πεδία που δεν βρίσκονται στο SugarCRM υπόδειγμά σας. Παρακαλώ διορθώστε τα παρακάτω σφάλματα και αποθηκευστε τον επιχειρησιακό κανόνα.',
    'LBL_PMSE_PROCESS_BUSINESS_RULES_EDIT' => 'Ο συγκεκριμένος Επιχειρησιακός κανόνας χρησιμοποιείται αυτή τη στιγμή σε Ορισμό διαδικασίας. Συνεχίζετε να θέλετε να τροποποιήσετε το συγκεκριμένο Επιχειρησιακό κανόνα;',
    'LBL_PMSE_PROCESS_BUSINESS_RULES_DELETE' => "Δεν μπορείτε να διαγράψετε το συγκεκριμένο Επιχειρησιακό κανόνα επειδή χρησιμοποιείται αυτή τη στιγμή σε Ορισμό διαδικασίας.",
);
