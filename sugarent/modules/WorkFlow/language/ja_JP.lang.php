...
$mod_strings = array (
  ...
  'WARN_WORKFLOW_DEPRECATED_ERROR' => '<b>警告：</b>ワークフローモジュールはすぐに削除されます。新しい<a href="index.php?module=pmse_Project">プロセスの作成者</a>にワークフローを転送してください。<span style="width: 1em; display: inline-block;">&nbsp;</span><a target="_blank" href="http://support.sugarcrm.com/02_Documentation/01_Sugar_Editions/01_Sugar_Ultimate/Sugar_Ultimate_7.6/Administration_Guide/135_Process_Author/">プロセスの作成についてはこちらをご覧ください</a>。',
);
