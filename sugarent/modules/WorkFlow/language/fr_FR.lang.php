...
$mod_strings = array (
  ...
  'LBL_MODULE_TITLE' => 'Workflow : Accueil',
 ...
 'LBL_RELATED_MODULE'=> 'Module Associé :',
  ...
  'NTC_REMOVE_ALERT' => 'Êtes-vous sûr(e) de vouloir supprimer ce Workflow?',
  ...
  'LBL_ACTION_ERROR'=>'Cette action ne peut pas être exécutée. Éditer cette action afin que chacun des champs et des valeurs de champs soient valides.',
  'LBL_ACTION_ERRORS'=>'Remarque : au moins une des actions suivantes contient des erreurs.',
  'LBL_ALERT_ERROR'=>'Cette alerte ne peut pas être exécutée. Éditer cette alerte afin de vérifier les différents paramètres.',
  ...
  'LBL_WORKFLOW_SUNSET_NOTICE' => '<strong>Remarque :</strong> Cette fonctionnalité sera supprimée dans une future version de Sugar actuellement prévue pour fin 2017. Les clients de l&#39;édition Sugar Enterprise devraient commencer à utiliser les fonctionnalités de workflow avancées fournies par l&#39;auteur du processus. Cliquez sur<a href="http://www.sugarcrm.com/wf-eol/" target="_blank">ici</a> pour plus d&#39;informations.',
);
