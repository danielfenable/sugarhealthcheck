...
$mod_strings = array (
  ...
  'WARN_WORKFLOW_DEPRECATED_ERROR' => '<b>Aviso:</b> El módulo de Flujo de Trabajo pronto será obsoleto y eliminado. Por favor transfiera los flujos de trabajo al nuevo <a href="index.php?module=pmse_Project">Proceso de Autor</a>.<span style="width: 1em; display: inline-block;"></span><a target="_blank" href="http://support.sugarcrm.com/02_Documentation/01_Sugar_Editions/01_Sugar_Ultimate/Sugar_Ultimate_7.6/Administration_Guide/135_Process_Author/">&nbsp;Aprender más acerca de Proceso de Autor</a>.',
);
