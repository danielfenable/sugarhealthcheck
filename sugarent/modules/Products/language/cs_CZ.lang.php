...
$mod_strings = array(
    ...
    // Help Text
    // List View Help Text
    'LBL_HELP_RECORDS' => 'Modul {{plural_module_name}} obsahuje všechny produkty, které již byly prodány nebo jsou právě prodávány klientům. Seznam produktů prodaných vaší společností je umístěn v Admin -> Katalog produktů a administrátoři mají možnost přidávat produkty dle potřeby. Když vytváříte {{plural_module_name}}, máte možnost buďto vybrat produkty z katalogu neby vytvořit nové prostřednictvím modulu {{plural_module_name}}. Existují různé způsoby, kterými můžete vytvořit {{plural_module_name}} v Sugaru, jako například prostřednictvím modulu {{plural_module_name}}, modulu {{quotes_module}}, duplikací, importem {{plural_module_name}} atd. Jakmile je {{module_name}} vytvořen, můžete zobrazit a upravit informace příslušející k {{module_name}} prostřednictvím detailního pohledu modulu {{plural_module_name}}.',

    // Record View Help Text
    'LBL_HELP_RECORD' => 'Modul {{plural_module_name}} obsahuje všechny produkty, které již byly prodány nebo jsou právě prodávány klientům
...
- Další akce jsou dostupné ve výběrovém menu Akce vpavo od talčítka Upravit.',
    ...
    'LBL_HELP_CREATE' => 'Modul {{plural_module_name}} obsahuje všechny produkty, které již byly prodány nebo jsou právě prodávány klientům.
