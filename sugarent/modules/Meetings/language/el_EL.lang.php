...
- Πρόσθετες ενέργειες είναι διαθέσιμες στο αναπτυσσόμενο μενού "Ενέργειες", δεξιά από το κουμπί "Επεξεργασία".',
    ...
    'LBL_HELP_CREATE' => 'Η ενότητα {{plural_module_name}} αποτελείται από {{meetings_module}} οι οποίες καταχωρούνται από τους χειριστές του οργανισμού σας. Η {{plural_module_name}}, μπορεί να φέρει σήμανση "Προγραμματισμένη", "Πραγματοποιήθηκε" ή "Ακυρώθηκε". Οι χειριστές του Sugar {{contacts_module}} και οι {{leads_module}} μπορούν να προστεθούν ως προσκεκλημένοι.

Για να δημιουργήσετε μία {{meetings_singular_module}}:
...
2. Προσθέστε προσκεκλημένους στο {{meetings_singular_module}}.
 - Κάντε κλικ στο "Επιλέξτε ένα Συμμετέχοντα" για να προσθέσετε υφιστάμενο χρήστη, επαφή ή δυνητικό πελάτη στο {{meetings_singular_module}}.
...
3. Κάντε κλικ στην επιλογή "Αποθήκευση" για να οριστικοποιήσετε τη νέα εγγραφή και να επιστρέψετε στην προηγούμενη σελίδα.',
);
