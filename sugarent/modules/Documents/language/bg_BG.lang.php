...
$mod_strings = array (
    ...
    'LBL_DOC_ID' => 'Идентификатор на източника на документа',
    ...
    'LBL_DOC_URL' => 'URL на източника на документа',
    ...
    'ERR_INVALID_EXTERNAL_API_LOGIN' => 'Неуспешна проверка за вход за външни API ({0})',
