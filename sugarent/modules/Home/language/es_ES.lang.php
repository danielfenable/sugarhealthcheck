...
El Cuadro de Mando de Ayuda está disponible para todos los módulos de Sugar 7 y puede ser abierto y cerrado haciendo clic en el icono de Ayuda en la carpeta de aplicaciones.',
  ...
  'LBL_PORTAL_TOUR_RECORDS_BUGS' => 'Haz clic aquí para ver o enviar informes de incidencias en el módulo de Incidencias.',
  'LBL_PORTAL_TOUR_RECORDS_CASES' => 'Haz clic aquí para ver o enviar cuestiones de soporte en el módulo de Casos.',
  'LBL_PORTAL_TOUR_RECORDS_GLOBAL_SEARCH' => 'Busca registros por nombre o número a través de cualquier módulo.',
  'LBL_PORTAL_TOUR_RECORDS_INTRO' => 'Bienvenido al Portal de Sugar. Utilice las flechas de la zona inferior para acceder a la visita guiada',
  'LBL_PORTAL_TOUR_RECORDS_KB' => 'Haz clic aquí para leer artículos publicados en el módulo de Conocimiento.',
  'LBL_PORTAL_TOUR_RECORDS_PAGE' => 'El Cuadro de Mando muestra una rápida vista de los registros recientemente actualizados.',
  'LBL_PORTAL_TOUR_RECORDS_QUICK_CREATE' => 'Haz clic aquí para crear registros.',
  'LBL_PORTAL_TOUR_RECORDS_RETURN' => 'Haz clic aquí para volver a esta vista en cualquier momento.',
  'LBL_PORTAL_TOUR_RECORDS_SEARCH' => 'Puedes buscar registros dentro de la lista también.',
  'LBL_PORTAL_TOUR_RECORDS_USER' => 'Desde el menú del usuario puedes acceder tu Perfil o cerrar la sesión.',
  ...
  'TPL_DASHLET_ADD' => 'Agregar un {{sugardashlet}}',
