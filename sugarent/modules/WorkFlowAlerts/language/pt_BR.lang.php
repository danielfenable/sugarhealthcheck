...
$mod_strings = array (
  ...
  'LBL_SEARCH_FORM_TITLE' => 'Pesquisa de Destinatários do Fluxo de Trabalho',
  'LBL_LIST_FORM_TITLE' => 'Lista de Destinatários',
  'LBL_NEW_FORM_TITLE' => 'Criar Destinatários do fluxo de trabalho',
  ...
  'LBL_CUSTOM_USER' => 'Usuário Personalizado:',
  ...
  'LBL_ALERT_SPECIFIC_TEAM' => 			'Todos os usuários em uma especificada ',
  'LBL_ALERT_SPECIFIC_TEAM_TITLE' => 	'Todos os usuários em uma equipe especificada',
  'LBL_ALERT_SPECIFIC_ROLE' => 			'Todos os usuários em uma especificada ',
  'LBL_ALERT_SPECIFIC_ROLE_TITLE' => 	'Todos os usuários em uma função especificada',
  ...
  'LBL_TEAM' => 'Equipe',
  'LBL_USER' => 'Usuário',
  'LBL_USER_MANAGER' => 'gerente do usuário',
  'LBL_ROLE' => 'função',
  ...
  'LBL_USER4' => ' a quem o registro é atribuído',
  'LBL_USER5' => ' a quem o registro foi atribuído',
  ...
  'LBL_PREVIOUS_BUTTON' => 'Anterior',
	...
	'NTC_REMOVE_ALERT_USER' => 'Tem certeza de que deseja excluir o destinatário deste alerta?',



	//rel_user_custom

	'LBL_REL_CUSTOM_STRING' => 'Selecionar e-mail personalizado e nomes de campos',
	'LBL_REL_CUSTOM' => 'Selecionar Campo de E-mail Personalizado: ',
	...
	'LBL_MODULE_NAME_SINGULAR_INVITE' => 'Lista de Convidados',
	  'LBL_LIST_STATEMENT_INVITE' => 'Convidados de Reuniões/chamadas:',

	'LBL_SELECT_VALUE' => 'Você deve selecionar um valor válido.',
	'LBL_SELECT_NAME' => 'Você deve selecionar um campo de nome personalizado',
	'LBL_SELECT_EMAIL' => 'Você deve selecionar um campo de e-mail personalizado',
	'LBL_SELECT_FILTER' => 'Você deve selecionar um campo para filtrar',
	'LBL_SELECT_NAME_EMAIL' => 'Você deve selecionar os campos de nome e e-mail',
