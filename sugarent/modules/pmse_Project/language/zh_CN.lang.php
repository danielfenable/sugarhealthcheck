...
$mod_strings = array (
  ...
  'LBL_PMSE_ADAM_DESIGNER_COMMENT' => '备注',
  ...
  'LBL_PMSE_ADAM_DESIGNER_TASK' => '任务',
  'LBL_PMSE_ADAM_DESIGNER_TEXT_ANNOTATION' => '文本附注',
  'LBL_PMSE_ADAM_DESIGNER_UNDO' => '撤销',
  'LBL_PMSE_ADAM_DESIGNER_USER_TASK' => '任务',
  ...
  'LBL_PMSE_CONTEXT_MENU_ASSIGN_USER' => '指派用户',
  ...
  'LBL_PMSE_CONTEXT_MENU_EXCLUSIVE_GATEWAY' => '独有网关',
  ...
  'LBL_PMSE_CONTEXT_MENU_REFRESH' => '刷新',
  ...
  'LBL_PMSE_CONTEXT_MENU_UNASSIGNED' => '未指派',
  'LBL_PMSE_CONTEXT_MENU_USERS' => '用户...',
  'LBL_PMSE_CONTEXT_MENU_ZOOM' => '放大',
  'LBL_PMSE_EMAILPICKER_CURRENT_USER' => '当前用户',
  'LBL_PMSE_EMAILPICKER_RECORD_OWNER' => '纪录拥有者',
  'LBL_PMSE_EMAILPICKER_RESULTS_TITLE' => '关于 "%TEXT%" 的 %NUMBER% 建议',
  'LBL_PMSE_EMAILPICKER_SUGGESTIONS' => '建议',
  'LBL_PMSE_EMAILPICKER_SUPERVISOR' => '主任',
  ...
  'LBL_PMSE_EXPCONTROL_CONSTANTS_BASIC' => '字串、数字、boolean',
  'LBL_PMSE_EXPCONTROL_CONSTANTS_BASIC_ADD_BOOLEAN' => '新增boolean',
  ...
  'LBL_PMSE_EXPCONTROL_OPERATOR_MINOR_THAN' => '少于',
  ...
  'LBL_PMSE_EXPCONTROL_USER_EVALUATION_IS_NOT_ROLE' => '不是角色',
  'LBL_PMSE_EXPCONTROL_USER_EVALUATION_IS_NOT_USER' => '不是用户',
  'LBL_PMSE_EXPCONTROL_USER_EVALUATION_IS_ROLE' => '是角色',
  ...
  'LBL_PMSE_EXPCONTROL_USER_EVALUATION_SUPERVISOR' => '主任',
  'LBL_PMSE_EXPCONTROL_USER_EVALUATION_TIMESPAN_AMOUNT' => '值',
  'LBL_PMSE_EXPCONTROL_USER_EVALUATION_TIMESPAN_DAYS' => '天',
  'LBL_PMSE_EXPCONTROL_USER_EVALUATION_TIMESPAN_HOURS' => '小时',
  'LBL_PMSE_EXPCONTROL_USER_EVALUATION_TIMESPAN_MINUTES' => '分钟',
  'LBL_PMSE_EXPCONTROL_USER_EVALUATION_TIMESPAN_MONTHS' => '月',
  'LBL_PMSE_EXPCONTROL_USER_EVALUATION_TIMESPAN_TITLE' => '时间段',
  'LBL_PMSE_EXPCONTROL_USER_EVALUATION_TIMESPAN_UNIT' => '单元',
  'LBL_PMSE_EXPCONTROL_USER_EVALUATION_TIMESPAN_WEEKS' => '周',
  ...
  'LBL_PMSE_FORM_LABEL_ASSIGN_TO_TEAM' => '指派给团队',
  'LBL_PMSE_FORM_LABEL_ASSIGN_TO_USER' => '指派给用户',
  'LBL_PMSE_FORM_LABEL_CRITERIA' => '条件',
  'LBL_PMSE_FORM_LABEL_DURATION' => '持续时间',
  'LBL_PMSE_FORM_LABEL_EMAIL_BCC' => '密送',
  ...
  'LBL_PMSE_FORM_OPTION_STATIC_ASSIGNMENT' => '静态任务',
  'LBL_PMSE_FORM_OPTION_SUPERVISOR' => '主任',
  ...
  'LBL_PMSE_FORM_TITLE_ASSIGN_USER' => '指派用户',
  ...
  'LBL_PMSE_FORM_TOOLTIP_EVENT_MODULE' => '选择要应用事件触发器的SugarCRM模块',
  ...
  'LBL_PMSE_MESSAGE_ACTIVITY_NAME_ALREADY_EXISTS' => '形状组合已采用此名称 "%s"。',
  'LBL_PMSE_MESSAGE_ACTIVITY_NAME_EMPTY' => '活动名称是空的。',
  'LBL_PMSE_MESSAGE_CANCEL_CONFIRM' => '某些设置已变更。您是否要丢弃变更？',
  'LBL_PMSE_MESSAGE_ERROR_ACTIVITY_INCOMING' => '活动必须有一个内向的顺序流',
  'LBL_PMSE_MESSAGE_ERROR_ACTIVITY_OUTGOING' => '活动必须有一个往外的顺序流',
  'LBL_PMSE_MESSAGE_ERROR_ANNOTATION' => '文本附注必须有关联行',
  'LBL_PMSE_MESSAGE_ERROR_BOUNDARY_EVENT_OUTGOING' => '界限事件必须有一个或更多往外的顺序流',
  'LBL_PMSE_MESSAGE_ERROR_END_EVENT_INCOMING' => '结束事件必须有一个向内顺序流',
  'LBL_PMSE_MESSAGE_ERROR_GATEWAY_CONVERGING_INCOMING' => '网关可以有二个或多个内向的顺序流',
  'LBL_PMSE_MESSAGE_ERROR_GATEWAY_CONVERGING_OUTGOING' => '网关不可有一个往外的顺序流',
  'LBL_PMSE_MESSAGE_ERROR_GATEWAY_DIVERGING_INCOMING' => '网关可以有一个或多个内向的顺序流',
  'LBL_PMSE_MESSAGE_ERROR_GATEWAY_DIVERGING_OUTGOING' => '网关可以有二个或多个往外的顺序流',
  'LBL_PMSE_MESSAGE_ERROR_GATEWAY_MIXED_INCOMING' => '网关可以有二个或多个内向的顺序流',
  'LBL_PMSE_MESSAGE_ERROR_GATEWAY_MIXED_OUTGOING' => '网关可以有二个或多个往外的顺序流',
  'LBL_PMSE_MESSAGE_ERROR_INTERMEDIATE_EVENT_INCOMING' => '中间事件必须有一个或更多向内的顺序流',
  'LBL_PMSE_MESSAGE_ERROR_INTERMEDIATE_EVENT_OUTGOING' => '中间事件必须有一个或更多往外的顺序流',
  'LBL_PMSE_MESSAGE_ERROR_START_EVENT_OUTGOING' => '开始事件必须有一个往外顺序流',
  'LBL_PMSE_MESSAGE_INVALID_CONNECTION' => '无效连接',
  'LBL_PMSE_MESSAGE_REMOVE_ALL_START_CRITERIA' => '模块将变更，条件也会移除因为已与新模块没有字段关系。',
  'LBL_PMSE_MY_PROCESS_DEFINITIONS' => '我的流程定义',
  'LBL_PMSE_PROCESS_DEFINITIONS_DISABLED' => '已禁用',
  ...
  'LBL_PMSE_PROCESS_DEFINITION_IMPORT_TEXT' => '通过从您的文件系统导入一个 *.bpm 文件自动创建新流程定义记录。',
