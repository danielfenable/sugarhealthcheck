...
$mod_strings = array (
    ...
    // Help Text
    // List View Help Text
    'LBL_HELP_RECORDS' => 'Модуль {{plural_module_name}} складається із дзвінків, які можуть перебувати в статусі «Запланований», «Відбувся» або «Скасований». Дати майбутніх дзвінків, заплановані на наступні 24 години, позначені синім. Дати прострочених дзвінків позначені червоним.

 За допомогою подання списку {{plural_module_name}} можна переглядати та редагувати інформацію про дзвінки. Додаткові дії доступні у меню в кінці рядка кожного дзвінка. Виберіть "Закрити" у меню у рядку будь-якого запланованого дзвінка, щоб позначити його в якості здійсненого.

Користувачі Sugar, Контакти та Попередні контакти можуть бути додані в якості запрошених. {{plural_module_name}} можна створити за допомогою модуля {{plural_module_name}}, модуля Календар, імпорту, а також через субпанель активностей (для модулів колишніх версій) або через інформаційну панель Заплановані активності (для модулів Sidecar) на сторінках пов&#39;язаних записів модуля (наприклад, Контакти, Контрагенти і т.д.), який автоматично створює зв&#39;язок між обома записами.',
...
- Додаткові дії доступні у випадаючому меню Дій праворуч від кнопки Правка.',
    ...
    'LBL_HELP_CREATE' => 'Модуль {{plural_module_name}} складається із записів {{calls_singular_module}}, які зареєстрували користувачі Вашої організації. {{plural_module_name}} можуть мати стан "Запланований", "Відбувся" або "Скасований". Модуль дозволяє запросити користувачів Sugar, а також контакти й попередні контакти.

Щоб створити {{calls_singular_module}}, виконайте такі дії:
...
2. Додайте до {{calls_singular_module}} запрошених учасників.
    - Натисніть "Вибрати запрошеного", щоб додати наявного користувача, контакт чи попередній контакт до {{calls_singular_module}}.
    - Натисніть на значок зі знаком "+" праворуч від напису "Вибрати запрошеного", щоб створити запрошеного учасника {{calls_singular_module}} як новий запис Sugar.
