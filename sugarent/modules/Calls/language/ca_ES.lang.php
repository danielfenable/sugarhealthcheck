...
$mod_strings = array (
    ...
    'NTC_REMOVE_INVITEE' => 'Esteu segur que voleu treure aquest convidat de la trucada?',
    ...
    'LBL_SYNCED_RECURRING_MSG' => 'Aquesta trucada es va originar en un altre sistema i es sincronitzen amb el Sugar. Per realitzar canvis, aneu a la trucada original en l&#39;altre sistema. Els canvis realitzats en l&#39;altre sistema es pot sincronitzar amb aquest registre.',
    ...
    // Help Text
    // List View Help Text
    'LBL_HELP_RECORDS' => 'El mòdul {{plural_module_name}} consisteix en uns registres de trucades que poden tenir l&#39;estat "Programades", "Celebrades" o "Cancel·lades". Les trucades entrants programades per a les pròximes 24 hores mostren la data d&#39;inici marcada en blau. Les trucades vençudes mostren la data d&#39;inici marcada en vermell.

Des d&#39;aquesta vista de llista {{plural_module_name}}, podeu veure i editar en línia la informació de la trucada. Hi ha accions addicionals disponibles al menú del final de cada fila de trucada. Podeu seleccionar "Tanca" al menú de qualsevol fila de trucada programada per marcar-la com a celebrada.
...
1. Proporcioneu els valors desitjats per als camps.
    - Els camps marcats "Obligatori" s&#39;han de completar abans de desar-los.
