...
- Дополнительные действия доступны в выпадающем меню Действий справа от кнопки Правка.',
    ...
    'LBL_HELP_CREATE' => 'Модуль {{plural_module_name}} состоит из записей {{calls_singular_module}}, зарегистрированных пользователями Вашей организации. {{plural_module_name}} могут находиться в статусе "Запланирован", "Состоялся", или "Отменен". Пользователи Sugar, а также контакты и предварительные контакты могут быть добавлены в качестве приглашенных. 

Чтобы создать {{calls_singular_module}}:
...
2. Добавить приглашенных к {{calls_singular_module}}.
    ...
    - Нажмите на значок "плюс" справа от "Выбрать приглашенного" для того, чтобы создать приглашенного {{calls_singular_module}} в качестве новой записи Sugar.
