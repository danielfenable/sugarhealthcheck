...
$mod_strings = array (
    ...
    // Help Text
    // List View Help Text
    'LBL_HELP_RECORDS' => 'تتكون الوحدة {{plural_module_name}} من سجلات الاتصال التي يمكن أن تحمل حالة "تمت الجدولة" أو "تم الإجراء" أو "تم الإلغاء". تظهر الاتصالات القادمة المجدولة خلال الأربع والعشرين ساعة القادمة تاريخ البدء المميز باللون الأزرق. يظهر تاريخ البدء في الاتصالات المستحقة باللون الأحمر.
