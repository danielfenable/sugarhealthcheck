...
$mod_strings = array (
    ...
    'LBL_LIST_RELATED_TO_ID' => 'Свързано с',
...
- Допълнителни действия  са възможни през падащото меню в дясно от бутона Редактирай.',
    ...
    'LBL_HELP_CREATE' => 'Модулът {{plural_module_name}} се състои от {{calls_singular_module}}, проведени от служители на вашата организация. {{plural_module_name}} та могат да бъдат със статус "Планирано", "Проведено" или "Несъстояло се". Потребители на Sugar, както и контактите и потенциалните клиенти могат да бъдат канени като участници. 

За да създадете {{calls_singular_module}}: 
...
2. Добавете участници в {{calls_singular_module}} то. 
- Натиснете "Изберете участник", за да добавите съществуващ потребител, контакт или потенциален клиент към {{calls_singular_module}} то. 
- Натиснете бутона „плюс“ в дясно от „Изберете участник“, за да създадете участник в {{calls_singular_module}} то като нов запис в  Sugar. 
