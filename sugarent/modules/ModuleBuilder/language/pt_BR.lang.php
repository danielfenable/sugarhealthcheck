...
$mod_strings = array (
  ...
  'LBL_CONFIRM_FIELD_DELETE' => 'Eliminando um campo personalizado irá eliminar todos os dados relacionados com o campo personalizado, e irá remover o campo de qualquer layout a que esteja adicionado. Você deseja continuar?',
  ...
  'LBL_DROPDOWN_LIST_EMPTY' => 'A lista deve conter pelo menos um item editável',
  ...
  'LBL_FAILED_TO_SAVE' => 'Falha ao Gravar',
  'LBL_FIELDS' => 'Campos',
  'LBL_FILE' => 'Arquivo',
  'LBL_FILLER' => '(vazio)',
  ...
  'LBL_JS_DELETE_REQUIRED_DDL_ITEM_IN_PROGRESS' => 'Você tem certeza que deseja eliminar o progresso do staus de Venda? Eliminando este status você vai causar um mau funcionamento para o Modulo de Oportunidades e para os worflows da linha de Receita.',
  'LBL_JS_DELETE_REQUIRED_DDL_ITEM_NEW' => 'Você tem certeza que deseja eliminar o Novo status de Venda? Eliminando este status você vai causar um mau funcionamento para o Modulo de Oportunidades e para os worflows da linha de Receita.',
  ...
  'LBL_KEY' => 'Chave:',
  'LBL_LABEL' => 'Nome do Rótulo no Plural:',
  'LBL_LABELS' => 'Rótulos',
  ...
  'LBL_POWERED_BY_SUGAR' => 'Produzido por SugarCRM',
  ...
  'LBL_SINGULAR_LABEL' => 'Nome do Rótulo no Singular',
  ...
  array (
    ...
    'layoutEditor' => 
    array (
      'default' => 'A área de <b>Layout</b> contém os campos que estão atualmente exibidos dentro da <b>Edição</b>.<br/><br/>As <b>Ferramentas</b> contêm a <b>Reciclagem</b> e os campos e elementos de layout que podem ser adicionados ao layout.<br/><br/>Para efetuar alterações ao layout arrastar e largar elementos e campos entre as <b>Ferramentas</b> e o  <b>Layout</b> e dentro do próprio layout.<br/><br/>Para remover um campo do layout, arrastar o campo para a <b>Reciclagem</b>. O campo será estará então disponível nas Ferramentas para adicionar ao layout.&#39;<br />    . &#39;<br/><br/><img src="themes/default/images/SugarLogic/icon_dependent.png"/>Indica um campo Dependente que pode ou não ser visível com base em um valor de uma fórmula.<br/><img src="themes/default/images/SugarLogic/icon_calculated.png"/>Indica um campo Calculado cujo valor será determinado automaticamente com base em uma fórmula.',
      ...
      'defaultquickcreate' => 'A área de <b>Layout</b> contém os campos que estão atualmente exibidos dentro do formulário <b>Criação Rápida</b>.<br/><br/>O formulário de Criação Rápida aparece nos sub-painéis para o módulo quando o botão Criar é clicado.<br/><br/>As <b>Ferramentas</b> contêm a <b>Reciclagem</b> e todos os campos e elementos de layout que podem ser adicionados ao layout.<br/><br/>Para efetuar alterações ao layout arrastar e largar elementos e campos entre as <b>Ferramentas</b> e o  <b>Layout</b> e dentro do próprio layout.<br/><br/>Para remover um campo do layout, arrastar o campo para a <b>Reciclagem</b>. O campo será estará então disponível nas Ferramentas para adicionar ao layout.&#39;<br />    . &#39;<br/><br/><img src="themes/default/images/SugarLogic/icon_dependent.png"/>Indica um campo Dependente que pode ou não ser visível com base em um valor de uma fórmula.<br/><img src="themes/default/images/SugarLogic/icon_calculated.png"/>Indica um campo Calculado cujo valor será determinado automaticamente com base em uma fórmula.',
    ...
    array (
      ...
      'Hidden' => 'Campos <b>Escondidos</b> não disponíveis de momento aos utilizadores para visualização em Listagens.',
      'historyBtn' => 'Clicar <b>Ver Histórico</b> para ver e restaurar um layout gravado previamente do histórico.',
      'historyDefault' => 'Clicar <b>Restaurar Padrões</b> para restaurar o layout original.',
    ...
    array (
      ...
      'historyBtn' => 'Clicar <b>Ver Histórico </b> para ver e restaurar um layout gravado previamente do histórico.',
      'historyDefault' => 'Clicar <b>Restaurar Padrão</b> para restaurar o layout original.',
      'modify' => 'Todos os campos que podem ser mostrados no formulário de <b>Pesquisa</b> aparecem aqui.<br/><br/>A coluna <b>Padrão</b> contém os campos que serão mostrados no formulário de Pesquisa.<br/><br/>A coluna <b>Escondidos</b> contém os campos disponíveis a si como administrador para adicionar ao formulário de Pesquisa.&#39;<br />    . &#39;<br/><br/><img src="themes/default/images/SugarLogic/icon_dependent.png"/>Indica um campo Dependente que pode ou não ser visível com base em um valor de uma fórmula.<br/><img src="themes/default/images/SugarLogic/icon_calculated.png"/>Indica um campo Calculado cujo valor será determinado automaticamente com base em uma fórmula.',
      'savebtn' => 'Clicando <b>Guardar e Implementar</b> irá guardar todas as alterações e coloca-las ativas.',
    ),
    'studioWizard' => 
    array (
