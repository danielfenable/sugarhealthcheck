...
$mod_strings = array (
  ...
  array (
    ...
    array (
      ...
      'defaultrecordview' => 'predvolené zobrazenie záznamu<br />Layout oblasť obsahuje polia, ktoré sú aktuálne zobrazené v zobrazení záznamov.<br /><br />Toolbox obsahuje kôš, polia a rozloženie prvkov, ktoré môžu byť pridané do rozvrhnutia.<br /><br />Vykonajte zmeny v rozložení pretiahnutím polí a prvkov medzi nástroje a rozvrhnutie a v rámci rozvrhnutím samotným.<br /><br />Ak chcete odstrániť pole z rozvrhnutia, presuňte pole do koša. Pole potom bude k dispozícii v paneli pre pridanie do rozloženia.<br /><br />Označuje závislé polia, ktoré môže alebo nemusia byť viditeľné na základe hodnoty vzorca.<br />Označuje vypočítané pole, ktorého hodnota bude automaticky určená na základe vzorca.',
