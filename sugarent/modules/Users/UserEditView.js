...
if(typeof(form.user_name)!='undefined'&&trim(form.user_name.value)==""){add_error_style('EditView',form.user_name.name,SUGAR.language.get('app_strings','ERR_MISSING_REQUIRED_FIELDS')+SUGAR.language.get('Users','LBL_USER_NAME'));isError=true;}
...
if(window.parent.SUGAR&&window.parent.SUGAR.App){var field=document.getElementById('picture');if(field){var filename=field.value;if(!filename||filename&&!filename.length){window.parent.SUGAR.App.events.trigger("bwc:avatar:removed");}}}
return true;}
