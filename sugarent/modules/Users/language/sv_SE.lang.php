...
$mod_strings = array (
	...
	'ERR_EMAIL_INCORRECT'				=> 'Ange en giltig emailadress för att skapa och skicka lösenordet.',
	'ERR_EMAIL_NO_OPTS'					=> 'Kunde inte hitta optimala inställningar för inkommande email.',
	...
	'ERR_IE_FAILURE2'					=> 'Ett problem uppstod vid anslutning till mailkontot. Vänligen kontrollera dina inställningar och försök igen.',
	'ERR_IE_MISSING_REQUIRED'			=> "Inställningarna för inkommande mail saknar nödvändig information.\n Vänligen kontrollera dina inställningar och försök igen.\n\n Om du inte ställer in inkommande email, rensa alla fält i den sektionen.",
	...
	'LBL_EMAIL_LINK_TYPE'				=> 'Mailklient',

    'LBL_EMAIL_LINK_TYPE_HELP'			=> '<b>Sugars mailklient:</b> Skicka email genom mailklienten i Sugar.<br> Detta alternativ är endast tillgängligt om administratören tillåter det genom dina mailinställningar. <br><b>Extern mailklient:</b> Skicka email genom en klient utanför Sugar, t. ex Microsoft Outlook.',

    'LBL_EMAIL_NOT_SENT'                => 'Systemet kan inte processa din begäran. Var snäll och kontakta din system administratör',
    'LBL_EMAIL_PROVIDER'               => 'Mailleverantör',
	'LBL_EMAIL_SHOW_COUNTS'				=> 'Visa antal mail?',
	'LBL_EMAIL_SIGNATURE_ERROR1'		=> 'Signaturen kräver ett',
    'LBL_EMAIL_SMTP_SSL'				=> 'Aktivera SMTP över SSL',
    'LBL_EMAIL_TEMPLATE_MISSING'            => 'Ingen mall har valts för mailet som innehåller användarens lösenord. Välj en mall på sidan Lösenordshantering.',
	...
	'LBL_EXPORT_CHARSET_DESC'			=> 'Välj vilken teckenuppsättning som ska användas lokalt. Denna egenskap kommer att användas vid importer, utgående email, export av .csv, när du skapar PDF:er, eller genererar vCards.',
	...
	'LBL_GROUP_DESC'					=> 'Använd den här för att tilldela poster till en grupp (exempelvis inkommande mail). Typen kan inte logga in via Sugars webbgränssnitt.',
	...
	'LBL_MAIL_OPTIONS_TITLE'			=> 'Emailinställningar',
	'LBL_MAIL_SENDTYPE'					=> 'Agent för överföring av email',
	'LBL_MAILMERGE_TEXT'				=> 'Aktivera &#39;Sammanfoga email&#39; (&#39;Sammanfoga email&#39; måste även vara aktiverat av administratör i systemets inställningar)',
	...
	'LBL_OTHER_EMAIL'					=> 'Annan mailadress',
	...
	'LBL_TAB_TITLE_EMAIL'				=> 'Emailinställningar',
...
// PROJECT RESOURCES STRINGS
	...
	'LBL_CHECKMARK' => 'Bock' /*for 508 compliance fix*/,
