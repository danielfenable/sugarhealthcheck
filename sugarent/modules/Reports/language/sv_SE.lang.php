...
$mod_strings = array (
  ...
  'LBL_DISPLAY_SUMMARY_HELP_DESC' => '<b>Steg för att Välja Visa Summeringar:</b><br/><br/>1) Klicka på modulen i <b>Relaterade Moduler</b> som du vill använda för summeringen i din rapport.  Som standard är den primära modulen (övre nod i trädvyn) vald.<br/><br/>	Du kan välja en relaterad modul (barn nod i trädvyn) genom att klicka på modulen. Expandera noden för att visa ytterligare moduler relaterade till den relaterade modulen. Modulen som du väljer avgör vilka rapporterbara fält visas i rutan <b>Tillgängliga fält</b>.<br/><br/>	2) Klicka på ett fält i rutan <b>Tillgängliga fält</b> för att välja summeringar för din rapport.  Du kan även söka efter fältet genom att skriva i textrutan i rutan.<br/><br/>	När du har valt ett antal fält från modulen som valts i moduler rutan <b>Relaterade Moduler</b>, kan du välja en annan modul som du kan välja valfritt antal fält som ska användas för summeringen i din rapport.<br/><br/>För Matris Rapporter kan du välje fler än ett fält för att visa flera värden i en enkel cell i din rapport.',
