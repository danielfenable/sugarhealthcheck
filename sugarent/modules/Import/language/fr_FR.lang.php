...
$mod_strings = array (
    ...
    'LBL_STEP_4_TITLE' => 'Étape {0} : Import du fichier',
    'LBL_STEP_5_TITLE' => 'Étape {0} : Visualisation des résultats',
    'LBL_CUSTOM_ENCLOSURE' => 'Caractère de protection :',
    'LBL_ERROR_UNABLE_TO_PUBLISH' => 'Impossible de publier ce mapping. Un autre mapping publié existe déjà avec ce nom.',
    ...
    'LBL_UPDATE_BUTTON_HELP' => 'Utiliser cette option pour mettre à jour des enregistrements existants. La correspondance entre les données dans le fichier d&#39;import et les données existantes dans Sugar sera réalisée sur le champ ID de SugarCRM.',
    'LBL_NO_ID' => 'ID Requis',
    ...
    'LBL_ARE_YOU_SURE' => 'Êtes-vous sûr(e)? Cela effacera toutes les données de ce module.',
    ...
    'LBL_ERROR_ENUM_EMPTY' => 'Valeur non présente dans le menu déroulant. Le menu déroulant est vide',
    ...
    'LBL_CONFIRM_TITLE' => 'Étape {0} : Confirmer les paramètres d&#39;import de fichier',
    'LBL_CONFIRM_EXT_TITLE' => 'Étape {0} : Confirmer les propriétés des sources externes',
    ...
    'LBL_NEXT' => 'Suivant >',
    'LBL_BACK' => '< Retour',
    'LBL_STEP_2_TITLE' => 'Étape 2 : Upload du fichier à importer',
    ...
    'LBL_SF_NUM_4' => '<b>Étape 1 : Selectionner votre type de rapport</b>, selectionner <b>Tabular Report</b>cliquer sur <b>Suivant</b>',
    'LBL_SF_NUM_5' => 'Étape 2 : Sélectionnez les colonnes du rapport , choisissez les colonnes que vous souhaitez exporter et cliquez sur Suivant',
    'LBL_SF_NUM_6' => 'Étape 3 : Sélectionnez les informations à résumer, cliquer sur Suivant',
    'LBL_SF_NUM_7' => 'Étape 4 : Ordonnez les colonnes du rapports, puis cliquez sur Suivant',
    'LBL_SF_NUM_8' => 'Étape 5 : Sélectionnez les critères de votre rapport, pour le champ Date de démarrage, choisissez une date suffisamment éloignée pour inclure tous vos comptes. Vous pouvez aussi exporter une sous-sélection de ce rapport en utilisant de multiples critères. Une fois terminé, cliquez sur Lancer le rapport',
    'LBL_SF_NUM_9' => 'Un rapport sera généré, et l&#39;écran doit présenter État de la génération du rapport : Terminé. Ensuite cliquez sur Exporter vers Excel',
    ...
    'LBL_STEP_3_TITLE' => 'Étape 3 : Mapping des champs et import',
    'LBL_STEP_DUP_TITLE' => 'Étape {0} : Vérification des doublons potentiels',
    ...
    'LBL_ACCOUNTS_NOTE_1' => 'Les champs "Rue 1" à "Rue 3" seront concaténés lors de l&#39;insertion dans la base de données.',
    ...
    'LBL_SHOW_ADVANCED_OPTIONS' => 'Afficher les options avancées',
    ...
    'LBL_DELETE_MAP_CONFIRMATION' => 'Êtes-vous sûr de vouloir supprimer ce mapping ?',
