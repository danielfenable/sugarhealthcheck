...
$mod_strings = array (
  ...
  'LBL_CONFIRM_IMPORT' => 'Você selecionou para atualizar os registros durante o processo de importação. Atualizações feitas em registros existentes não pode ser desfeita. No entanto, os registros criados durante o processo de importação pode ser desfeita (suprimido), se desejar. Clique em Cancelar para selecionar para criar novos registros apenas, ou clique em OK para continuar.',
  ...
  'LBL_IMPORT_MODULE_ERROR_NO_MOVE' => 'Arquivo não foi carregado com sucesso. Verifique as permissões do Arquivo no diretório cache de instalação do Sugar.',
  ...
  'LBL_MICROSOFT_OUTLOOK_HELP' => 'Os mapeamentos personalizado para Microsoft Outlook dependem da importação de arquivos sendo delimitado por vírgulas (. Csv). Se o seu arquivo de importação é delimitado por tabulações, os mapeamentos não serão aplicados como esperado.',
  ...
  'LBL_NO_EMAIL_DEFS_IN_MODULE' => 'Tentando lidar com endereços de e-mail em um Bean que não suporta.',
