...
$mod_strings = array (
    ...
    // Help Text
    // List View Help Text
    'LBL_HELP_RECORDS' => 'Moduł {{plural_module_name}} jest używany do śledzenia i zarządzania zgłoszeniami skierowanymi do Twojej firmy przez klientów, powiązanymi z produktem lub usługą oferowaną przez Twoje przedsiębiorstwo. Moduły {{plural_module_name}} są zwykle powiązane z rekordem {{accounts_singular_module}}, z jednym {{accounts_singular_module}} może być powiązanych wiele {{plural_module_name}}. Jest kilka sposobów na utworzenie {{plural_module_name}} w Sugar, np. poprzez moduł {{plural_module_name}}, importowanie {{plural_module_name}} lub poprzez konwersję z wiadomości e-mail. Po utworzeniu rekordu {{module_name}} możesz przeglądać i edytować informacje dotyczące {{module_name}} poprzez widok rekordu {{module_name}}. Każdy rekord {{module_name}} może zostać powiązany z innymi rekordami Sugar, np. z {{calls_module}}, {{contacts_module}}, {{bugs_module}} oraz wieloma innymi.',
