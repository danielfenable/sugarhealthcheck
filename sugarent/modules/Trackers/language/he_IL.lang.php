...
$mod_strings = array (
		  ...
		  'LBL_MODULE_NAME_SINGULAR' => 'מעקב',
		  'LBL_TRACKER_SETTINGS' => 'הגדרת גשש',
		  'LBL_TRACKER_QUERIES_DESC' => 'שאילתות לגשש',
		  'LBL_TRACKER_QUERIES_HELP' => 'עקוב אחר הצהרות SQL כאשר "תעד שאילתות איטיות" מופעל וזמן ביצוע השאילתא גבוה מהערך "סף זמן שאילתא איטית"',
		  'LBL_TRACKER_PERF_DESC' => 'ביצועים של גשש',
		  'LBL_TRACKER_PERF_HELP' => 'עקוב אחר מעגלי מסד נתונים, קבצים שניגשו אליהם וניצולת זיכרון',
		  'LBL_TRACKER_SESSIONS_DESC' => 'מעקב אחר הפעלות',
		  'LBL_TRACKER_SESSIONS_HELP' => 'עקוב אחר משתמשים ואחר פרטי הפעלה של משתמשים&rsquo;',
		  'LBL_TRACKER_DESC' => 'פעולו של גשש',
		  'LBL_TRACKER_HELP' => 'עקוב אחר צפיות הדף (דפי מודולים ורישומים) ושמירות רישומים של המשתמש',
		  'LBL_TRACKER_PRUNE_INTERVAL' => 'מספר הימים לאחסון נתוני העוקב כאשר יומן האירועים מוחק את הטבלאות',
