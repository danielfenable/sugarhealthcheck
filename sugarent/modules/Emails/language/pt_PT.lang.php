...
$mod_strings = array (
	...
	'WARNING_SETTINGS_NOT_CONF'	=> 'As suas definições de e-mail não estão corretamente configuradas para enviar e-mail. Deve ser configurado um servidor de SMTP em <a href="#bwc/index.php?module=EmailMan&action=config">Definições de E-mail</a>.',
	...
	'LBL_EMAILTEMPLATE_MESSAGE_SHOW_MSG' => 'O modelo irá substituir todo o conteúdo deste e-mail. Tem a certeza de que pretende utilizar este modelo e substituir o conteúdo?',
    'LBL_EMAILTEMPLATE_MESSAGE_CLEAR_MSG' => 'Selecionando "--Nenhum--" irá limpar todos os dados já introduzidos no corpo do e-mail. Pretende continuar?',
	'LBL_EMAILTEMPLATE_MESSAGE_WARNING_TITLE' => 'Aviso',
	'LBL_EMAILTEMPLATE_MESSAGE_MULTIPLE_RECIPIENTS' => 'Utilize um modelo de e-mail que contenha variáveis de contacto, como nome de contacto, para enviar e-mails para vários destinatários poderá dar resultados inesperados. É recomendado que seja utilizada uma campanha de e-mail para envio massivo de correio.',
