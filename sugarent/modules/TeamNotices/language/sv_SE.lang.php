...
$mod_strings = array (
  ...
  'LBL_TEAM_NOTICE_MODULE_BUILDER' => 'Modulbyggaren ger dig möjlighet att utöka SugarCRM på nya och innovativa sätt.
 Förbättringar: 
* Nya relationer ger möjlighet att relatera nya och befintliga moduler på nya sätt. 
* Revision ger en fullständig historik över modulskapande och ändringar för att hålla reda på alla anpassningar. 
* Dashletstöd låter anpassade objekt och modulfunktionalitet visas i AJAX-kontroller på hemsidan. 
* Nya Mallar ger dig ett enkelt sätt att spåra filer och affärsmöjligheter.',
