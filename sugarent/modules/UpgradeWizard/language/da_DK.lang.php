...
$mod_strings = array(
    ...
    'ERR_UW_MBSTRING_FUNC_OVERLOAD'				=> 'mbstring.func_overload er angivet til en værdi, der er højere end 1. <br/>Ret dette i php.ini, og genstart webserveren.',
	...
	'LBL_UW_CANCEL_DESC'						=> 'Opgradering er blevet annulleret. Eventuelle midlertidige filer, der blev kopieret og eventuelle opgradering filer, der blev uploadet er blevet slettet.',
	...
	'LBL_UW_NEXT_TO_UPLOAD'						=> "<b>Klik på Næste for at overføre opgraderingspakkerne.</b>",
	'LBL_UW_FROZEN'								=> 'Upload en pakke, før du fortsætter.',
	...
	'LBL_UW_MODULE_READY_UNINSTALL'				=> "Modulet er klar til at blive afinstalleret. Klik på \"Forpligt\" for at fortsætte med af-installationen.<br>\n",
	...
	'LBL_LAYOUT_MERGE_DESC' => 'Der er nye felter til rådighed, som er blevet tilføjet som en del af denne opgradering, og som automatisk kan blive tilføjet til dit eksisterende modul layout. Hvis du vil vide mere om de nye felter, henvises der til udgivelsesbemærkningerne for den version, som du har opgraderet til.<br><br> Hvis du ikke ønsker at føje de nye felter, skal du fjerne afkrydsningen af modulet, og dit brugerdefinerede layout vil forblive uændret. Felterne vil være tilgængelig i Studio efter opgraderingen.<br><br>',
	'LBL_LAYOUT_MERGE_TITLE' => 'Klik på Næste for at bekræfte ændringerne og for at afslutte opgraderingen.',
	...
	'LBL_THEMES' => 'Temaer' /*for 508 compliance fix*/,
