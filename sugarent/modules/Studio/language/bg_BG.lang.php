...
'LBL_SW_EDIT_PORTAL'=>'Редактиране на портала',
'LBL_SW_EDIT_WORKFLOW'=>'Редактиране на Workflow',
'LBL_SW_REPAIR_CUSTOMFIELDS'=>'Редакция на потребителските полета',
'LBL_SW_MIGRATE_CUSTOMFIELDS'=>'Мигриране на потребителските полета',
...
'LBL_DELETE_MODULE'=>'Премахни&nbsp;модула<br />от&nbsp;филтъра',
...
'LBL_SYNCP_WELCOME'=>'Моля, въведете Url адреса на инсталацията на портала, която искате да актуализирате, след което натиснете бутона Go. <br>Това ще изведе подкана за вашите потребителско име и парола. <br>Моля, въведете потребителското си име и парола за Sugar и натиснете бутона Започни синхронизиране.',
...
'LBL_SP_STYLESHEET'=>'Заредете Списък със стилове',
'LBL_SP_UPLOADSTYLE'=>'Щракнете върху бутона Преглед и изберете списък със стилове от вашия компютър, за да го заредите. <br>Следващия път, когато синхронизирате портала, той ще премести и списъка със стиловете.',
'LBL_SP_UPLOADED'=> 'Заредени',
'ERROR_SP_UPLOADED'=>'Моля, убедете се, че зарежданият файл е css.',
'LBL_SP_PREVIEW'=>'Ето преглед на начина, по който ще изглежда вашия списък със стилове',

	'LBL_SAVE' => 'Съхрани' /*for 508 compliance fix*/,
	'LBL_UNDO' => 'Върни' /*for 508 compliance fix*/,
	'LBL_REDO' => 'Повтори' /*for 508 compliance fix*/,
	'LBL_INLINE' => 'Текуща форма' /*for 508 compliance fix*/,
	...
	'LBL_ADDROWS' => 'Добави редове' /*for 508 compliance fix*/,
...
'LBL_SINGULAR' => 'Етикет в единствено число',
'LBL_PLURAL' => 'Етикет в множествено число',
'LBL_RENAME_MOD_SAVE_HELP' => 'Натиснете <b>Запази</b>, за да приложите промените.'
