...
'LBL_SW_EDIT_DROPDOWNS'=>'Edit Dropdowns',
...
//EDIT DROP DOWNS
'LBL_ED_CREATE_DROPDOWN'=> 'Create a Dropdown',
'LBL_ED_WELCOME'=>'<h2>Dropdown Editor</h2><br><b>You can either edit an existing dropdown or create a new dropdown.',
...
'LBL_LISTVIEW_DESCRIPTION'=>'There are three columns displayed below. The default column contains the fields that are displayed in a list view by default, the additional column contains fields that a user may choose to use for creating a custom view, and the available columns are columns available for you as an admin to either add to the default or additional columns for use by users but are currently not used.',
...
'LBL_SYNCP_WELCOME'=>'Please enter the url to the portal instance you wish to update then press the Go button.<br> This will bring up a prompt for your username and password.<br> Please enter your Sugar username and password and press the Begin Sync button.',
...
'LBL_SP_PREVIEW'=>'Here is a preview of what your style sheet will look like',
	...
	'LBL_MAXIMIZE' => 'Maximise' /*for 508 compliance fix*/,
	'LBL_MINIMIZE' => 'Minimise' /*for 508 compliance fix*/,
