...
//WIZARDS
//STUDIO WIZARD
'LBL_SW_WELCOME'=>'<h2>¡Bienvenido a Studio!</h2><br> ¿Qué desea hacer hoy?<br><b> Seleccione una de las siguientes opciones.</b>',
...
'LBL_SMW_WELCOME'=>'<h2>¡Bienvenido a Studio!</h2><br><b>Seleccione uno de los siguientes módulos.',

//SELECT MODULE ACTION
'LBL_SMA_WELCOME'=>'<h2>Editar un Módulo</h2>¿Qué desea hacer con ese módulo?<br><b>Seleccione la acción que desea realizar.',
...
'LBL_MB_WELCOME'=> '<h2>Historial</h2><br> El Historial le permite ver ediciones publicadas anteriormente del archivo con el que actualmente está trabajando. Puede comparar con versiones previas y restaurarlas. Si restaura un archivo, éste se convertirá en su archivo de trabajo. Debe publicarlo antes de que sea visible para cualquier otra persona.<br> ¿Qué desea hacer hoy?<br><b> Seleccione una de las siguientes opciones.</b>',

//EDIT DROP DOWNS
'LBL_ED_CREATE_DROPDOWN'=> 'Crear una Lista Desplegable',
...
//SELECT MODULE
'LBL_SM_WELCOME'=> '<h2>Historial</h2><br><b>Seleccione el archivo que desea visualizar.</b>',
//END WIZARDS
...
'LBL_CONFIGURE_GROUP_TABS' => 'Configurar los filtros del menú de módulos',
 //end bug #15095 fix
'LBL_GROUP_TAB_WELCOME'=>'Los filtros de abajo se mostrará en la lista de Más en el menú del módulo para que los usuarios vean los grupos de módulos dentro del menú. Arrastrar y soltar los módulos de y a los filtros. Nota: Los filtros vacíos no se mostrarán en el menú.',
...
'LBL_TAB_GROUP_LANGUAGE_HELP' => 'Seleccione uno de los idiomas disponibles, edite las etiquetas del Grupo y haga clic en Guardar e implementar para aplicar las etiquetas en el idioma deseado.',
...
'LBL_SMP_WELCOME'=>' Seleccione el módulo que desea editar de la siguiente lista',
'LBL_SP_WELCOME'=>'Bienvenido a Studio para el Portal de Sugar. Puede elegir editar módulos aquí, o realizar una sincronización con una instancia de portal.<br> Selecciónelo de la siguiente lista.',
'LBL_SP_SYNC'=>'Sincronización de Portal',
'LBL_SYNCP_WELCOME'=>'Introduzca la Url de la instancia de portal que desea actualizar y haga clic en el botón Ir.<br> Tras esto, se le pedirá su nombre y contraseña.<br> Introduzca su nombre y contraseña de Sugar y haga clic en el botón Iniciar Sincronización.',
...
'LBL_SP_UPLOADSTYLE'=>'Haga clic en el botón de exploración y seleccione la hoja de estilo que desea cargar de su ordenador.<br> La próxima vez que realice una sincronización al portal, se incluirá la hoja de estilos.',
...
'LBL_RENAME_MOD_SAVE_HELP' => 'Haga clic en <b>Guardar</b> para aplicar los cambios.'
