...
'LBL_CONFIRM_UNSAVE' => '任何改变将为未保存状态。您确定您要继续吗?',
'LBL_PUBLISHING' => '发布中 ...',
'LBL_PUBLISHED' => '已发布',
...
'LBL_SW_EDIT_TABS'=>'配置选项卡',
'LBL_SW_RENAME_TABS'=>'重命名选项卡',
...
'LBL_SMA_WELCOME'=>'<h2>编辑一个模块</h2>您想对那个模块做什么?<br><b>请选择您想进行的活动。',
...
'LBL_MB_DELETE'=>'删除',
'LBL_MB_COMPARE'=>'比较',
'LBL_MB_WELCOME'=> '<h2>历史记录</h2><br> 历史记录允许您可浏览您最近正在从事的文件的前期部署编辑。您可以对比和恢复先前的版本。如果您恢复这个文件，此文件将会成为工作文件。在此文件对任何其他人可见之前您需要部署此文件。<br> 您今天想做什么?<br><b> 请从下面的选项中选择。</b>',

//EDIT DROP DOWNS
'LBL_ED_CREATE_DROPDOWN'=> '创建一个下拉框',
'LBL_ED_WELCOME'=>'<h2>下拉框编辑器</h2><br><b>您可以编辑一个下拉框或创建一个新的下拉框 。',
'LBL_DROPDOWN_NAME' => '下拉框名称：',
'LBL_DROPDOWN_LANGUAGE' => '下拉框语言：',
'LBL_TABGROUP_LANGUAGE' => '语言：',

//EDIT CUSTOM FIELDS
'LBL_EC_WELCOME'=>'<h2>自定义字段编辑器</h2><br><b>您可以查看和编辑现有自定义字段，创建一个新的自定义字段或清除自定义字段缓存。',
'LBL_EC_VIEW_CUSTOMFIELDS'=> '查看自定义字段',
'LBL_EC_CREATE_CUSTOMFIELD'=>'创建自定义字段',
'LBL_EC_CLEAR_CACHE'=>'清除缓存',

//SELECT MODULE
'LBL_SM_WELCOME'=> '<h2>历史记录</h2><br><b>请选择您想要查看的文件。</b>',
//END WIZARDS
...
'LBL_CONFIGURE_GROUP_TABS' => '配置模块菜单过滤器',
 //end bug #15095 fix
'LBL_GROUP_TAB_WELCOME'=>'将在模块菜单中的更多列表中显示以下过滤器，以供用户查看菜单中模块的分组。拖拽模块，以查看过滤器内的分组。 注意：菜单中不会显示空过滤器。',
'LBL_RENAME_TAB_WELCOME'=>'点击以下表中的任何选项卡的显示值以重命名选项卡。',
'LBL_DELETE_MODULE'=>'删除e&nbsp;模块<br />从&nbsp;过滤器中',
'LBL_DISPLAY_OTHER_TAB_HELP' => '在导航栏中选择以显示“其他”选项卡。默认条件下，“其他”选项卡显示任何模块而不是已包含在其他分组的任何模块。',
'LBL_TAB_GROUP_LANGUAGE_HELP' => '选择一种有效的语言，编辑组标签并且点击保存与部署以已选语言应用此标签。',
'LBL_ADD_GROUP'=>'添加过滤器',
'LBL_NEW_GROUP'=>'新分组',
'LBL_RENAME_TABS'=>'重命名模块',
'LBL_DISPLAY_OTHER_TAB' => '显示 “其他” 选项卡',

//LIST VIEW EDITOR
'LBL_DEFAULT'=>'默认',
'LBL_ADDITIONAL'=>'附加的',
'LBL_AVAILABLE'=>'可用',
'LBL_LISTVIEW_DESCRIPTION'=>'下面显示三列。默认列包括列表视图中默认显示的字段。附加的列包括用户选择使用创建一个自定义查看的字段，有效列包含的列可以让管理员增加当前用户没有使用的默认列或附加列。',
...
//SUGAR PORTAL
'LBL_SW_SUGARPORTAL'=>'Sugar 门户',
'LBL_SMP_WELCOME'=>'请从下面列表中选择一个您想要编辑的模块',
'LBL_SP_WELCOME'=>'欢迎访问 Sugar 门户网站工作室。您可以在此处选择一个想要编辑的模块，或者同步至一个门户网站实例。<br> 请从下面的列表中选择。',
'LBL_SP_SYNC'=>'门户网站同步',
'LBL_SYNCP_WELCOME'=>'请输入您要更新门户网站实例的 URL，然后点击“执行”按钮。<br> 会出现用户名和密码的提示。<br> 请输入您 Sugar 的用户名和密码，并按“开始同步”按钮。',
'LBL_LISTVIEWP_DESCRIPTION'=>'下面有两个列：默认列包含要显示的字段，有效列包含那些未显示的字段，但是是可以设置显示该字段。在两列之间拖拽字段。您也可以通过拖拽，重新排列列中的项目。',
'LBL_SP_STYLESHEET'=>'上传样式表',
'LBL_SP_UPLOADSTYLE'=>'点击“浏览”按钮，并从计算机中选择一个样式表。<br> 下一次您同步门户网站，样式表会被同步到门户网站中。',
'LBL_SP_UPLOADED'=> '已上传',
'ERROR_SP_UPLOADED'=>'请确定您在上传一个 css 样式表。',
'LBL_SP_PREVIEW'=>'在此处您可以预览您的样式表',

	'LBL_SAVE' => '保存' /*for 508 compliance fix*/,
	'LBL_UNDO' => '取消操作' /*for 508 compliance fix*/,
	'LBL_REDO' => '重新操作' /*for 508 compliance fix*/,
...
'LBL_SINGULAR' => '单数标签',
'LBL_PLURAL' => '复数标签',
'LBL_RENAME_MOD_SAVE_HELP' => '点击 <b>保存</b> 应用所做的更改。'
