...
'LBL_CONFIRM_UNSAVE' => 'Toutes les modifications seront perdues. Êtes-vous sûr(e) de vouloir continuer ?',
...
'LBL_SW_EDIT_MODULE'=>'Éditer un Module',
'LBL_SW_EDIT_DROPDOWNS'=>'Éditer une Liste déroulante',
'LBL_SW_EDIT_TABS'=>'Configurer les Onglets',
'LBL_SW_RENAME_TABS'=>'Renommer les Onglets',
'LBL_SW_EDIT_PORTAL'=>'Éditer le Portail',
...
'LBL_SMA_WELCOME'=>'<h2>Éditer un Module</h2>Que souhaitez-vous faire avec ce module?<br><b>Merci de selectionner une action à réaliser.',
'LBL_SMA_EDIT_CUSTOMFIELDS'=>'Éditer les champs personnalisés',
'LBL_SMA_EDIT_LAYOUT'=>'Éditer la mise en page',
'LBL_SMA_EDIT_LABELS' =>'Éditer les libellés',
...
'LBL_ED_WELCOME'=>'<h2>Édition d&#39;une Liste déroulante</h2><br><b>Vous pouvez soit éditer une liste existante  soit créer une nouvelle liste.',
...
//EDIT CUSTOM FIELDS
'LBL_EC_WELCOME'=>'<h2>Édition de Champs personnalisés</h2><br><b>Vous pouvez soit Afficher et éditer un champ personnalisé existant, créer un nouveau champ personnalisé ou nettoyer le cache des champs personnalisés.',
'LBL_EC_VIEW_CUSTOMFIELDS'=> 'Afficher les Champs personnalisés',
'LBL_EC_CREATE_CUSTOMFIELD'=>'Créer un Champ personnalisé',
'LBL_EC_CLEAR_CACHE'=>'Effacer le Cache',

//SELECT MODULE
'LBL_SM_WELCOME'=> '<h2>Historique</h2><br><b>Merci de sélectionner le fichier que vous souhaitez afficher.</b>',
//END WIZARDS
...
'LBL_BTN_TABINDEX'=>'Éditer l&#39;ordre des onglets',
...
'LBL_SP_PREVIEW'=>'Voici un aperçu de ce que votre feuille de style présentera',
	...
	'LBL_INLINE' => 'Édition à la volée' /*for 508 compliance fix*/,
