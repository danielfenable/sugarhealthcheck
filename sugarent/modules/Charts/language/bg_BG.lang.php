...
$mod_strings = array (
    ...
    'LBL_EDIT' => 'Редактирай',
    'LBL_LEAD_SOURCE_BY_OUTCOME_DESC' => 'Показва натрупаните суми по възможностите по етапи в зависимост от източника за избрания потребител. Резултатите се базират върху етапите на преговори: спечелени преговори, загубени преговори или други стойности.',
    ...
    'LBL_TOTAL_PIPELINE' => 'Обща сума на текущи възможности ',
