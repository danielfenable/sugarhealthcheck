...
$mod_strings = array (
    ...
    'LBL_EDIT' => 'Bearbeiten',
    'LBL_LEAD_SOURCE_BY_OUTCOME_DESC' => 'Zeigt die gesamten Beträge der Verkaufschancen nach Ergebnis für bestimmte Benutzer an. Das Ergebnis hängt davon ab, ob die Verkaufsphase "geschlossen gewonnen", "geschlossen verloren" oder anders ist.',
    'LBL_LEAD_SOURCE_BY_OUTCOME' => 'Alle Verkaufschancen nach Quelle und Ergebnis',
    'LBL_LEAD_SOURCE_FORM_DESC' => 'Zeigt die gesamten Beträge der Verkaufschancen nach gewählter Quelle für bestimmte Benutzer an.',
    ...
    'LBL_MODULE_TITLE' => 'Dashboard: Startseite',
    'LBL_MONTH_BY_OUTCOME_DESC' => 'Zeigt die gesamten Beträge der Verkaufschancen nach Monat und Ergebnis für bestimmte Benutzer an. Das erwartete Enddatum der Verkaufschancen liegt innerhalb des angegebenen Datumbereichs. Die Ergebnisse basieren auf den Verkaufsphasen.',
    ...
    'LBL_PIPELINE_FORM_TITLE_DESC' => 'Zeigt die gesamten Beträge der Verkaufschancen, deren erwartetes Enddatum innerhalb des angegebenen Datumbereichs liegt, nach den ausgewählten Verkaufsphasen an.',
    'LBL_CAMPAIGN_ROI_TITLE_DESC' => 'Zeigt die Kampagnen-Resonanz nach dem Return On Investment.',
    ...
    'LBL_SALES_STAGE_FORM_DESC' => 'Zeigt die gesamten Beträge der Verkaufschancen, deren erwartetes Enddatum innerhalb des angegebenen Datumbereichs liegt, an. Gruppiert nach ausgewählten Verkaufsphasen für bestimmte Benutzer.',
    'LBL_SALES_STAGE_FORM_TITLE' => 'Pipeline nach Verkaufsphasen',
    'LBL_SALES_STAGES' => 'Verkaufsphasen:',
    'LBL_TOTAL_PIPELINE' => 'Pipeline-Summe beträgt',
    'LBL_USERS' => 'Benutzer:',
    ...
    'LBL_CHART_MODULES_USED_DIRECT_REPORTS_30_DAYS' => 'Benutzer-Nutzungsdaten (letzte 30 Tage)',
