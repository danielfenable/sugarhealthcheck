...
$mod_strings = array(
    ...
    'LBL_SNIP_KEY_DESC' => 'Email Archiving OAuth key. Used for accessing this instance for purposes of importing emails.',
    ...
    'LBL_SNIP_STATUS_ERROR_SUMMARY' => 'This instance has a valid Email Archiving server licence, but the server returned the following error message:',
    ...
    "LBL_SNIP_PURCHASE_SUMMARY" => "In order to use Email Archiving, you must purchase a licence for your SugarCRM instance",
