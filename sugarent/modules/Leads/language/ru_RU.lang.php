...
$mod_strings = array (
    ...
    'LBL_BUSINESSCARD' => 'Конвертировать предварительный контакт',
    'LBL_CITY' => 'Город',
    ...
    'LBL_CONVERT_PANEL_OPTIONAL' => '(не обязательно)',
    ...
    'LBL_CONVERT_CREATE_MODULE' => 'Создать {{moduleName}}',
    'LBL_CONVERT_CREATED_MODULE' => 'Создание {{moduleName}}',
    ...
    'LBL_CONVERT_MOVE_ACTIVITIES_TO_CONTACT' => 'Переместить связанные мероприятия в запись контакта',
    ...
    'LBL_CONVERTED'=> 'Конвертирован',
    'LBL_CONVERTLEAD_BUTTON_KEY' => 'V',
    'LBL_CONVERTLEAD_TITLE' => 'Конвертировать предварительный контакт',
    'LBL_CONVERTLEAD' => 'Конвертировать предварительный контакт',
    ...
    'LBL_CONVERTLEAD_ERROR' => 'Не удалось конвертировать предварительный контакт',
    ...
    'LBL_IMPORT_VCARD_SUCCESS' => 'Предварительный контакт из vCard создан успешно',
    'LBL_VCARD' => 'vCard',
    ...
    'LBL_CONVERT_REQUIRED' => 'Обязательное',
...
- Дополнительные действия доступны в выпадающем меню Действий справа от кнопки Редактировать.',
    ...
    'LBL_HELP_CREATE' => 'Модуль {{plural_module_name}} содержит список потенциальных клиентов, которые могут быть заинтересованы в продукте или услуге, предоставляемых Вашей компанией. Как только {{module_name}} квалифицирован как продажа {{opportunities_singular_module}}, он может быть конвертирован в {{contacts_singular_module}}, {{accounts_singular_module}}, {{opportunities_singular_module}}, или другую запись.
