...
$mod_strings = array (
  ...
  'LBL_MODULE_NAME_SINGULAR' => 'Тип данни',
  ...
  'LBL_LIST_OUTPUT_DEFAULT' => 'Стандартен изход',
  ...
  'LBL_PRESPACE_X' => 'Страната преди свободното пространство:',
  ...
  'LBL_CHILD_NAME' => 'Съб-/Вторичен въпрос:',
  ...
  'LBL_LAYOUT_DISPLAY_TYPE' => 'Визуализация:',
  'LBL_LAYOUT_LIST_ORDER_X' => 'Последователност на списък X:',
  'LBL_LAYOUT_LIST_ORDER_Z' => 'Последователност на списък Z:',
  'LBL_MODIFY_HEAD' => 'Промяна на атрибутите на заглавието:',
  'LBL_MODIFY_HEAD_HEADER' => 'Добави/редактирай атрибути на заглавната част',
  'LBL_MODIFY_BODY' => 'Промяна на атрибутите на справката:',
  'LBL_MODIFY_BODY_HEADER' => 'Добави/Редактирай атрибути на основния текст',
  ...
  'LBL_FINISHED_BUTTON' => 'Приключено',
  ...
  'LBL_INVALID_QUERY' => 'Невалидна заявка към базата данни',
);
