...
$mod_strings = array (
  ...
  'LBL_MODULE_NAME_SINGULAR' => 'Formato de Datos',
  ...
  'LBL_LIST_OUTPUT_DEFAULT' => 'Resultado Predeterminado',
  'LBL_LIST_LIST_ORDER_Y' => 'Orden Y',
  'LBL_LIST_LIST_ORDER_X' => 'Orden X',
  'LBL_LIST_VISIBLE' => '¿Visible?',
  'LBL_LIST_EXPORTABLE' => '¿Exportable?',
  'LBL_LIST_HEADER' => '¿Mostrar Encabezado?',
  'LBL_NAME' => 'Nombre del Formato de Datos:',
  'LBL_DESCRIPTION' => 'Descripción:',
  'LBL_TYPE' => 'Tipo:',
  'LBL_PARENT_DATASET' => 'Formato de Datos Principales:',
  'LBL_QUERY_NAME' => 'Nombre de Consulta:',
  'LBL_OUTPUT_DEFAULT' => 'Tipo de Resultado Predeterminado:',
  'LBL_LIST_ORDER_Y' => 'Orden de ubicaciones en Eje Y:',
  'LBL_LIST_ORDER_X' => 'Orden de ubicaciones en Eje X:',
  'LBL_HEADER' => 'Mostrar Encabezado:',
  ...
  'LBL_HEADER_TEXT_COLOR' => 'Color de Texto del Encabezado:',
  'LBL_HEADER_BACK_COLOR' => 'Color de Fondo del Encabezado:',
  'LBL_BODY_BACK_COLOR' => 'Color de Fondo del Cuerpo:',
  'LBL_USE_PREV_HEADER' => 'Agrupar con Encabezado previo:',
  'LBL_CHILD_NAME' => 'Consulta secundaria:',
  ...
  'LBL_LAYOUT_LIST_ORDER_X' => 'Orden de Lista X:',
  'LBL_LAYOUT_LIST_ORDER_Z' => 'Orden de Lista Z:',
  'LBL_MODIFY_HEAD' => 'Modificar Atributos del Encabezado:',
  'LBL_MODIFY_HEAD_HEADER' => 'Añadir/Editar Atributos del Encabezado:',
  'LBL_MODIFY_BODY' => 'Modificar Atributos del Cuerpo:',
  'LBL_MODIFY_BODY_HEADER' => 'Añadir/Editar Atributos del Cuerpo:',
  ...
  'LBL_FINISHED_BUTTON' => 'Finalizado',
  'CONFIRM_LAYOUT_DISABLE' => 'Al deshabilitar el diseño predeterminado se perderán todas las propiedades actuales del diseño personalizado',
  'LBL_LEFT' => 'Izquierda',
  'LBL_RIGHT' => 'Derecha',
