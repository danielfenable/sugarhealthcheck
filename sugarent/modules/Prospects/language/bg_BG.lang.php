...
//END DON'T CONVERT
  ...
  'MSG_SHOW_DUPLICATES' => 'Създаването на този целеви клиент може да доведе до създаване на дублиращ целеви клиент. Целевите клиенти, съдържащи подобни имена и/или имейл адреси, са посочени по-долу.<br>Натиснете Създай целеви клиент, за да продължите със създаването на този целеви клиенти, или да изберете съществуващ списък на целеви клиенти по-долу.',
  'MSG_DUPLICATE' => 'Създаването на този контакт може да доведе до създаване на дублиращ контакт.<br>Можете или да съхраните записа с вече въведените данни, или да изберете Отмени.',
...
- Можете да извършвате допълнителни действия със записа като използвате падащото меню в дясно на бутона „Редактирай“.',
    ...
    'LBL_HELP_CREATE' => 'Модулът {{module_name}} съдържа лица, за които вашата организация счита че могат в бъдеще да станат клиенти на предлаганите от вас стоки или услуги. Вие разполагате с информация за тези лица, но те все още не са {{leads_singular_module}}.
