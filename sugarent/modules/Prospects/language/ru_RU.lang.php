...
//END DON'T CONVERT
  ...
  'LBL_CONVERT_BUTTON_TITLE' => 'Конвертировать потенциального клиента',
  'LBL_CONVERT_BUTTON_LABEL' => 'Конвертировать потенциального клиента',
  'LBL_CONVERTPROSPECT'=>'Конвертировать потенциального клиента',
...
- Дополнительные действия доступны в выпадающем меню Действий справа от кнопки Редактировать.',
    ...
    'LBL_HELP_CREATE' => 'Модуль {{module_name}} содержит неквалифицированные контакты, точнее интересы, о которых вам удалось собрать немного информации, но ее недостаточно для квалификации интереса {{leads_singular_module}}.
