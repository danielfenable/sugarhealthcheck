...
//END DON'T CONVERT
  ...
  'LBL_RECORD_SAVED_SUCCESS' => 'יצרת בהצלחה את {{moduleSingularLower}} {{full_name}}.',
    ...
    // Help Text
    // List View Help Text
    'LBL_HELP_RECORDS' => 'המודול {{module_name}} מכיל אנשים נפרדים שאינם הזדמנויות מאומתות שיש לך קצת מידע עליהם, אך הוא עוד לא {{leads_singular_module}} מוסמך. מידע (כגון שם, כתובת דוא"ל) אודות {{plural_module_name}} אלה בדרך כלל מתקבל מכרטיסים עסקיים שאתה מקבל בזמן נוכחותך בכנסים, תערוכות סחר וכו&#39;. {{plural_module_name}} ב-Sugar הם רישומים נפרדים שאינם קשורים ל-{{contacts_module}}, {{leads_module}}, {{accounts_module}}, או {{opportunities_module}}. קיימות מספר דרכים שבהן תוכל ליצור {{plural_module_name}} ב-Sugar כמו באמצעות המודול {{plural_module_name}}, ייבוא {{plural_module_name}}, וכו&#39;. ברגע שהרישום {{module_name}} נוצר, תוכל להציג ולערוך מידע שמשתייך ל-{{module_name}} דרך תצוגת רישום {{plural_module_name}}.',
...
- Additional actions are available in the dropdown Actions menu to the right of the Edit button.',
    ...
    'LBL_HELP_CREATE' => 'המודול {{module_name}} מורכב מיחידים המהווים לקוחות פוטנציאליים שלא סווגו שיש לך עליהם מידע, אך עוד לא סיווגת כ-{{leads_singular_module}}.
