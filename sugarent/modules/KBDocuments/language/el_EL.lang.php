...
$mod_strings = array (
  ...
  'LBL_PORTAL_TOUR_RECORDS_FILTER' => 'Μπορείτε να φιλτράρετε κάτω από τον κατάλογο των άρθρων παρέχοντας έναν όρο αναζήτησης.',
  'LBL_PORTAL_TOUR_RECORDS_FILTER_EXAMPLE' => 'Για παράδειγμα, μπορείτε να χρησιμοποιήσετε αυτό για να βρείτε ένα άρθρο σε ένα συγκεκριμένο θέμα ενδιαφέροντος.',
  'LBL_PORTAL_TOUR_RECORDS_INTRO' => 'Η ενότητα Βάση Γνώσεων είναι για να εργάζεται με τα δημοσιευμένα άρθρα. Χρησιμοποιήστε το βέλος παρακάτω για να περάσουν από μια γρήγορη περιήγηση.',
  'LBL_PORTAL_TOUR_RECORDS_PAGE' => 'Αυτή η σελίδα εμφανίζει τη λίστα δημοσιευμένων άρθρων.',
  'LBL_PORTAL_TOUR_RECORDS_RETURN' => 'Κάνοντας κλικ εδώ, θα σας επιστρέψει στη Βάση Γνώσεων ανά πάσα στιγμή.',
