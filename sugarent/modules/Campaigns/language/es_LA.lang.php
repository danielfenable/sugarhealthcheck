...
$mod_strings = array (
  ...
  'LBL_STATUS' => 'Estado',
  'LBL_TYPE' => 'Tipo',
  'LBL_CAMPAIGN_INACTIVE_SCHEDULE' => "Campaña '{0}' tiene estado 'Inactivo'. Debe establecer el estado de la campaña como 'Activo'.",
  ...
  'LBL_TRACKER_TEXT' => 'Texto de Vínculo de Seguimiento: ',
  ...
  'LBL_EMAIL_MARKETING_SUBPANEL_TITLE' => 'Marketing por Correo Electrónico',
  'LNK_NEW_EMAIL_TEMPLATE' => 'Nueva Plantilla de Correo Electrónico',
  ...
  'LBL_QUEUE_BUTTON_TITLE'=>'Enviar Correos Electrónicos',
  'LBL_QUEUE_BUTTON_KEY'=>'u',
  'LBL_QUEUE_BUTTON_LABEL'=>'Enviar Correos Electrónicos',
  ...
  'LBL_LOG_ENTRIES_INVALID_EMAIL_TITLE'=>'Mensajes Rebotados,Correo electrónico no válido',
  'LBL_LOG_ENTRIES_LINK_TITLE'=>'Vínculo',
  ...
  //error messages.
  'ERR_NO_EMAIL_MARKETING'=>'Debe haber al menos un mensaje de Marketing por correo electrónico asociado a la campaña.',
  'ERR_NO_TARGET_LISTS'=>'Debe haber al menos una Lista de Público Objetivo asociada a la campaña.',
  'ERR_NO_TEST_TARGET_LISTS'=>'Debe haber al menos una Lista de Público Objetivo de tipo Pruebas asociada a la campaña.',
  'ERR_SENDING_NOW'=>'Los mensajes están siendo entregados, por favor inténtelo de nuevo más tarde.',
  'ERR_MESS_NOT_FOUND_FOR_LIST'=>'No se ha encontrado un mensaje de Marketing por correo electrónico para esta lista de público objetivo',
  'ERR_MESS_DUPLICATE_FOR_LIST'=>'Se han definido múltiples mensajes de Marketing por correo electrónico para esta lista de público objetivo',
  ...
  'LBL_TRACK_DELETE_CONFIRM'=>'Esta opción eliminará las entradas del registro creadas al ejecutar la prueba. ¿Desea continuar?',
  ...
  'LBL_CURRENCY'=>'Moneda:',
  'LBL_ROLLOVER_VIEW' => 'Mueva el cursor sobre la barra para más detalles.',
  ...
  'LBL_CREATE_NEWSLETTER'=>'Crear Boletín de Noticias',
  ...
  'LBL_TEMPLATE' => 'Plantilla de Correo Electróinco:',
  ...
  'LBL_EDIT_OPT_OUT_'=>'¿Vínculo para rehusar?',
  ...
  'LBL_WIZARD_HEADER_MESSAGE' => 'Complete los campos requerido para ayudar a identificar la campaña.',
  'LBL_WIZARD_BUDGET_MESSAGE' => 'Introduzca el presupuesto para calcular el ROI.',
  'LBL_WIZARD_SUBSCRIPTION_MESSAGE' => 'Cada boletín de noticias debe tener tres listas de público objetivo (Suscripción, No suscripción, y Pruebas). Puede asignar una lista existente de público objetivo. De lo contrario, se creará una lista vacía al guardar el boletín de noticias.',
  'LBL_WIZARD_TARGET_MESSAGE1' => 'Seleccione o cree una lista de público objetivo para utilizar con su campaña.  Esta lista se usará para enviar correos electrónicos con sus mensajes de marketing.',
  'LBL_WIZARD_TARGET_MESSAGE2' => 'O cree una nueva utilizando el siguiente formulario:',
  ...
  'LBL_WIZARD_MARKETING_MESSAGE' => 'Complete el siguiente formulario para crear una instancia de correo electrónico para su boletín de noticias.  Esto le permitirá especificar cuándo y cómo su boletín de noticias debería ser distribuido.',
  ...
  'LBL_WIZ_MARKETING_TITLE' => 'Correo Electrónico de Marketing',
  ...
  'LBL_NAVIGATION_MENU_TRACKERS' => 'Seguimiento',
  ...
  'LBL_CONFIRM_CAMPAIGN_SAVE_CONTINUE' => 'Guardar el trabajo y proceder con el correo electrónico de Marketing',
  ...
  'LBL_CONFIRM_SEND_SAVE' => 'Está a punto de terminar y proceder a la página de Envío de Correos Electrónicos de Campaña.  ¿Desea guardar los cambios y continuar?',
  ...
  'LBL_SEND_AS_TEST' => 'Enviar correo electrónico de Marketing a modo de Prueba',
  ...
  'LBL_NO_SUBS_ENTRIES_WARNING' => 'No puede enviar un correo electrónico de marketing hasta que su lista de suscriptores tenga al menos una entrada.  Puede completar su lista al finalizar.',
  'LBL_NO_TARGET_ENTRIES_WARNING' => 'No puede enviar un correo electrónico de marketing hasta que su lista de público objetivo tenga al menos una entrada.  Puede completar su lista al finalizar.',
  'LBL_NO_TARGETS_WARNING' => 'No puede enviar un correo electrónico de marketing hasta que su campaña tenga al menos una lista de público objetivo.',
  'LBL_NONE' => 'ninguna creada',
  'LBL_CAMPAIGN_WIZARD' => 'Asistente de Campañas',
  'LBL_EMAIL' =>'Correo Electrónico',
  'LBL_OTHER_TYPE_CAMPAIGN' => 'Campaña no basada en correos electrónicos',
  ...
  'LBL_EMAILS_SCHEDULED' => 'Correos Electrónicos Programados',
  'LBL_TEST_EMAILS_SENT' => 'Correos Electrónicos de Prueba Enviados',
  'LBL_USERS_CANNOT_OPTOUT' => 'Los Usuarios del Sistema no pueden optar por no recibir Correos Electrónicos.',
  ...
  'LBL_EMAIL_SETUP_DESC'                      => 'Complete el siguiente formulario para modificar su configuración del sistema, para poder enviar los Correos Electrónicos de la campaña.',
  ...
  'LNK_CAMPAIGN_DIGNOSTIC_LINK' => 'La campaña puede no funcionar de la manera esperada y es posible que sus correos no sean enviados por las siguientes razones:',
  'LBL_CAMPAIGN_DIAGNOSTICS'  => 'Diagnósticos de Campaña',
  'LBL_DIAGNOSTIC'            => 'Diagnóstico',
  'LBL_MAILBOX_CHECK1_GOOD'   => ' Cuenta(s) de correo con gestión de rebote detectadas:',
  ...
  'LBL_MAILBOX_CHECK2_BAD'    => 'Por favor, configure la dirección de correo electrónico de su sistema. Las opciones de correo electrónico no han sido configuradas o no son válidas.',
  ...
  'LBL_MARKETING_CHECK1_GOOD' => 'Se han detectado los componentes de marketing del Correo Electrónico.',
  'LBL_MARKETING_CHECK1_BAD'  => 'No se han detectado los componentes de marketing del correo electrónico, usted tendrá que crear uno para enviar por correo una campaña.',
  ...
  'LBL_EMAIL_SETUP_WIZ' => 'Iniciar Configuración de Correo Electrónico',
  'LBL_SCHEDULER_LINK' => 'ir a la pantalla de administración del planificador.',
  'LBL_TO_WIZARD' => 'iniciar',
  'LBL_TO_WIZARD_TITLE' => 'Iniciar Asistente',
  ...
  'LBL_NON_ADMIN_ERROR_MSG'  => 'Por favor, notifíque a su Administrador del Sistema para que corrija este problema',
  'LBL_EMAIL_COMPONENTS' => 'Componentes de Correo Electrónico',
  'LBL_SCHEDULER_COMPONENTS' => 'Componentes del Planificador',
  'LBL_RECHECK_BTN'=>'Volver a Comprobar',
  //web to lead wizard titles
    ...
    'LBL_DEFINE_LEAD_SUBMIT' => 'Etiqueta del Botón de Enviar:',
    'LBL_DEFINE_LEAD_POST_URL' => 'URL de publicación:',
    'LBL_EDIT_LEAD_POST_URL' => '¿Editar URL de publicación?',
    ...
    'LBL_WEB_TO_LEAD'    =>  'Crear Formulario de Cliente Potencial',
    ...
    'LBL_PROSPECTLISTS_SUBPANEL_TITLE' => 'Lista de Posibles Clientes',
    'LBL_EMAILMARKETING_SUBPANEL_TITLE' => 'Marketing por Correo Electrónico',
    ...
    'LBL_LINK_SUBPANEL_TITLE' => 'Vínculo',
    ...
    'LBL_CAMPAIGN_INFORMATION' => 'Reseña General',
    ...
    'LBL_VIEW_INLINE' => 'Ver',
    'ERR_NO_OPTS_SAVED'		=> 'No se han guardado valores óptimos con su cuenta de correo de entrada.',
    'ERR_REVIEW_EMAIL_SETTINGS' => 'Por favor, revise la configuración del correo de entrada.',
