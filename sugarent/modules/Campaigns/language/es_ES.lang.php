...
$mod_strings = array (
  ...
  'LBL_STATUS' => 'Estado',
  'LBL_TYPE' => 'Tipo',
  'LBL_CAMPAIGN_INACTIVE_SCHEDULE' => "La Campaña \"{0}\" tiene establecido el estado como \"Inactiva\". Debes establecer el estado de la campaña como \"Activa\".",
  'LNK_NEW_CAMPAIGN' => 'Creación de Campaña (Clásica)',
  ...
  'LBL_CHARSET_NOTICE' => 'NOTA: Asegúrese de que la página que contiene el formulario web-to-lead tiene las siguientes líneas en la sección &lt;head&gt;:',

  'LBL_TODETAIL_BUTTON_TITLE'=>'Mostrar Detalles',
  'LBL_TODETAIL_BUTTON_KEY'=>'T',
  'LBL_TODETAIL_BUTTON_LABEL'=>'Mostrar Detalles',
  ...
  'ERR_SENDING_NOW'=>'Los mensajes se están enviando, inténtelo de nuevo más tarde.',
  ...
  'ERR_FIX_MESSAGES'=>'Corrija los siguientes errores antes de proceder',
  ...
  'ERR_NO_MAILBOX'=>"Los siguientes mensajes de marketing no tiene una cuenta de correo asociada.<BR>Corrija este problema antes de continuar.",
  ...
  'LBL_MAILBOX_CHECK_WIZ_BAD'                 => 'No se ha detectado ninguna cuenta de correo con gestión de rebote de correo. Cree una nueva a continuación.',
  ...
  'LBL_MAILBOX_CHECK2_BAD'    => 'Configure la dirección de email de su sistema. Las opciones de E-mail no se han configurado.',
  ...
  'LBL_MARKETING_CHECK1_BAD'  => 'No se detecta ningún componente de marketing de correo electrónico, deberá crear uno para enviar una campaña.',
  ...
  'LBL_NON_ADMIN_ERROR_MSG'  => 'Notifíqueselo a su administrador del sistema para que corrija este problema',
  ...
  //web to lead wizard titles
    ...
    'LBL_SELECT_LEAD_FIELDS' => 'Seleccione de entre los campos disponibles',
    ...
    'LBL_DOWNLOAD_TEXT_WEB_TO_LEAD_FORM' =>'Descargue su formulario Web a Cliente potencial',
    ...
    'LBL_CREATE_WEB_TO_LEAD_FORM' => 'Crear formulario WebToLead',
