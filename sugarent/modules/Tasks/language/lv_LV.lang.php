...
$mod_strings = array (
  ...
  'LBL_SEARCH_FORM_TITLE' => ' Uzdevumu meklēšana',
  ...
  'LBL_ASSIGNED_USER' => 'Piešķirts lietotājam',
    ...
    // Help Text
    // List View Help Text
    'LBL_HELP_RECORDS' => 'Modulī „{{plural_module_name}}” ietvertas dažādas darbības, uzdevumi vai citas aktivitātes, kuras ir jāpabeidz. Moduļa „{{module_name}}” ieraksti var tik saistīti ar vienu ierakstu vairākos moduļos, izmantojot dinamisko saites lauku, un arī atsevišķi ar moduli „{{contacts_singular_module}}”. Ir vairāki veidi, kā izveidot moduli „{{plural_module_name}}” vietnē „Sugar”, piemēram, izmantojot moduli „{{plural_module_name}}”, dublējot, importējot moduli „{{plural_module_name}}” utt. Kad moduļa „{{module_name}}” ieraksts ir izveidots, informāciju par moduli „{{module_name}}” var aplūkot un rediģēt moduļa „{{plural_module_name}}” ierakstu skatījuma režīmā. Atkarībā no moduļa „{{module_name}}” informācijas jūs varat arī skatīt un rediģēt moduļa „{{module_name}}” informāciju, izmantojot moduli „Kalendārs”. Katrs moduļa „{{module_name}}” ieraksts vēlāk var tikt saistīts ar jebkuru citu „Sugar” ierakstu, piemēram, moduļiem „{{accounts_module}}”, „{{contacts_module}}”, „{{opportunities_module}}” un daudziem citiem.',
...
- Papildus darbības pieejamas izkrītošajā darbību izvēlnē pa labi no Rediģēšanas pogas.',
    ...
    'LBL_HELP_CREATE' => 'Modulis {{plural_module_name}} satur dažādas darbības, uzdevumus vai cita veida aktivitātes, kuras ir jāpabeidz.
