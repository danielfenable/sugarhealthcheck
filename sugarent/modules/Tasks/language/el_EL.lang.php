...
- Πρόσθετες ενέργειες είναι διαθέσιμες στο αναπτυσσόμενο μενού "Ενέργειες", δεξιά από το κουμπί "Επεξεργασία".',
    ...
    'LBL_HELP_CREATE' => 'Η ενότητα {{plural_module_name}} αποτελείται από ευέλικτες δράσεις, εκκρεμή στοιχεία, ή άλλου είδους δραστηριότητες οι οποίες θα πρέπει να ολοκληρωθούν.

Για να δημιουργήσετε μία εγγραφή {{module_name}}:
1. Καταχωρήστε τιμές για τα πεδία, όπως επιθυμείτε.
