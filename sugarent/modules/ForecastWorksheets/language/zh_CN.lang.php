...
$mod_strings = array (
    ...
    //module strings.
    'LBL_MODULE_NAME' => '预测工作表',
    'LBL_MODULE_NAME_SINGULAR' => '预测工作表',
    'LNK_NEW_OPPORTUNITY' => '创建商业机会',
    'LBL_MODULE_TITLE' => '预测工作表',
    ...
    'LBL_CALCULATED_LINE_ITEM_AMOUNT' => '计算线项目金额',
    'LBL_TYPE' => '类型:',
    ...
    'LBL_MANAGER_NOTIFY' => '以下 {0} {1}在上一次提交记录中，但不包括在最新的一次提交中',
    'LBL_MANAGER_NOTIFY_NAME' => '{0} 承诺变更'
);
