...
$mod_strings = array (
	...
	'POPUP_INSERT_HEADER_TITLE' => '添加自定义字段',
    ...
    'LBL_IMAGE_HEIGHT' => '高度',
    'LBL_IMAGE_BORDER' => '边框',
	'COLUMN_TITLE_VALIDATE_US_FORMAT' => '美国格式',
	'LBL_DEPENDENT'=>'附属',
	'LBL_VISIBLE_IF'=>'是否可见',
	'LBL_ENFORCED'=>'强制的',
    ...
    'LBL_EDIT_VIS' => '调整能见度',
    'LBL_SIMULATION_MODE' => '仿真模式 - 除清除缓存外，不进行任何改动',
    'LBL_SCAN_MODULE' => '扫描',
    'LBL_DROPPING_COLUMN' => '模块中，从 {1} 中删除列 {0}',
    'LBL_FIX_COLUMN_TYPE' => '修复 {0} 的列类型，将 {1} 更改为',
