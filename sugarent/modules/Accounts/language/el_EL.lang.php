...
$mod_strings = array (
    ...
    'LBL_QUOTES_BILLTO' => 'Προσφορές (Λογαριασμός σε)',
    ...
    'LBL_MODULE_NAME_SINGULAR'	=> 'Λογαριασμό',
	...
	'LBL_COPY' => 'Αντιγραφή' /*for 508 compliance fix*/,
    //For export labels
    ...
    // Help Text
    // List View Help Text
    'LBL_HELP_RECORDS' => 'Η ενότητα {{plural_module_name}} αποτελείται από εταιρείες με τις οποίες η εταιρεία σας έχει κάποιας μορφής σχέση, και θεωρείται γενικά ως κομβικό σημείο για τη διαχείριση και ανάλυση της σχέσης της επιχείρησής σας με κάθε πελάτη. Υπάρχουν διάφοροι τρόποι με τους οποίους μπορείτε να δημιουργήσετε εγγραφές στο {{plural_module_name}} Sugar μέσω της ενότητας {{plural_module_name}}, όπως η δημιουργία αντίγραφων, η εισαγωγή δεδομένων {{plural_module_name}}, κ. λ. π. Αφού δημιουργηθεί η εγγραφή {{module_name}}, μπορείτε να προβάλετε και να επεξεργαστείτε τις πληροφορίες που αφορούν το συγκεκριμένο {{module_name}} μέσω της προβολής εγγραφής {{plural_module_name}}. Κάθε εγγραφή {{module_name}} μπορεί στη συνέχεια να συσχετιστεί με άλλες εγγραφές στο {{contacts_module}}, {{meetings_module}}, {{cases_module}}, {{opportunities_module}}, και πολλές άλλες εγγραφές Sugar, καθώς η σχέση της εταιρίας με τον πελάτη ωριμάζει.',
...
- Πρόσθετες ενέργειες είναι διαθέσιμες στο αναπτυσσόμενο μενού "Ενέργειες", δεξιά από το κουμπί "Επεξεργασία".',
    ...
    'LBL_HELP_CREATE' => 'Η ενότητα {{plural_module_name}} αποτελείται από εταιρείες με τους οποίες η εταιρεία σας έχει κάποιου είδους σχέση και θεωρείται γενικά ως κομβικό σημείο για τη διαχείριση και ανάλυση της αλληλεπίδραση της επιχείρησής σας με κάθε πελάτη.
