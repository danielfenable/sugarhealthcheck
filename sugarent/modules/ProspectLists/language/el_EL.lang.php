...
- Πρόσθετες ενέργειες είναι διαθέσιμες στο αναπτυσσόμενο μενού "Ενέργειες", δεξιά από το κουμπί "Επεξεργασία".',
    ...
    'LBL_HELP_CREATE' => 'Μία ενότητα {{module_name}} αποτελείται από μια συλλογή μεμονομένων ατόμων ή οργανισμών που θέλετε να συμπεριλάβετε ή να εξαιρέσετε από μαζική εκστρατεία {{campaigns_singular_module}}.
...
1. Καταχωρήστε τιμές για τα πεδία, αναλόγως των προτιμήσεών σας.
 ...
 - Κάντε κλικ στην επιλογή "Εμφάνιση Περισσότερων" για να ανοίξουν πρόσθετα πεδία, εάν είναι απαραίτητο.
2. Κάντε κλικ στην επιλογή "Αποθήκευση" για να οριστικοποιήσετε τη νέα εγγραφή και να επιστρέψετε στην προηγούμενη σελίδα.
3. Μετά την αποθήκευση, χρησιμοποιήστε τους υποπίνακες που διατίθενται στην προβολή εγγραφών των στόχων, για να προσθέσετε παραλήπτες {{campaigns_singular_module}}.',
);
