...
$mod_strings = array (
  ...
  'LBL_LIST_ASSIGNED_TO_NAME' => 'Przydzielony użytkownik',
    ...
    // Help Text
    // List View Help Text
    'LBL_HELP_RECORDS' => 'Moduł {{plural_module_name}} jest używany do śledzenia i zarządzania problemami, związanymi z produktami, znalezionymi wewnętrznie lub zgłoszonymi przez klientów, występującymi też pod nazwą {{plural_module_name}}. Moduły {{plural_module_name}} mogą zostać sprawdzone poprzez śledzenie znalezionych i naprawionych błędów w wydaniu. Moduł {{plural_module_name}} pozwala na szybką ocenę wszystkich elementów modułu {{module_name}} i proces jego naprawy. Po utworzeniu modułu {{module_name}} możesz przeglądać i edytować informacje dotyczące modułu {{module_name}} poprzez widok rekordu {{module_name}}. Każdy moduł {{module_name}} może zostać powiązany z innymi rekordami Sugar, np. {{calls_module}}, {{contacts_module}}, {{cases_module}} oraz wieloma innymi.',

    // Record View Help Text
    'LBL_HELP_RECORD' => 'Moduł {{plural_module_name}} jest używany do śledzenia i zarządzania problemami, związanymi z produktami, znalezionymi wewnętrznie lub zgłoszonymi przez klientów, występującymi też pod nazwą {{plural_module_name}}.
...
- Dodatkowe działania dostępne są w liście rozwijalnej menu Działania po prawej stronie przycisku Edytuj.',
    ...
    'LBL_HELP_CREATE' => 'Moduł {{plural_module_name}} jest używany do śledzenia i zarządzania problemami związanymi z produktami znalezionymi wewnętrznie lub zgłoszonymi przez klientów popularnie określanymi jako moduł {{plural_module_name}}.
