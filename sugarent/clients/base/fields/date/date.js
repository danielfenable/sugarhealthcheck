...
$field.datepicker(options);},_getAppendToTarget:function(){var component=this.closestComponent('main-pane')||this.closestComponent('drawer');if(component){return component.$el;}
...
this._setupDatePicker();},focus:function(){this.$(this.fieldTag).datepicker('focusShow');},_dispose:function(){var $field=this.$(this.fieldTag);if($field.data('datepicker')){$(window).off('resize',$field.data('datepicker').place);}
