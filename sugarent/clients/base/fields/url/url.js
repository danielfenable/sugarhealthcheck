/*
     ...
     */
({direction:'ltr',plugins:['EllipsisInline'],initialize:function(options){this._super("initialize",arguments);if(app.utils.isTruthy(this.def.gen)){this.def.readonly=true;}},format:function(value){if(value&&!value.match(/^([a-zA-Z]+):\/\//)){value="http://"+value;}
