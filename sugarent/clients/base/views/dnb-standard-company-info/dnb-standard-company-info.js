...
this.baseFilterData();},loadCompanyInfo:function(isCollapsed){if(!isCollapsed){this.loadDNBData('duns_num','dnb_temp_duns_num',this.getDNBStdCompanyDetails,null,'dnb.dnb-no-duns','dnb.dnb-no-duns-field');}},getDNBStdCompanyDetails:function(duns_num){if(this.disposed){return;}
