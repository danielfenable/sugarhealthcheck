...
if(this.context.parent){this.context.parent.on('subpanel:reload',function(args){if(!_.isUndefined(args)&&_.isArray(args.links)&&_.contains(args.links,this.context.get('link'))){this.context.reloadData({recursive:false});}},this);}},show:function(){this.context.set('hidden',false);this._super('show');},hide:function(){this.context.set('hidden',true);this._super('hide');}})