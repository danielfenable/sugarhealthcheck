...
$mod_strings = array (
  ...
  'ERROR_FLAVOR_INCOMPATIBLE' => 'A feltöltött fájl nem kompatibilis a Sugar használt verziójával (Community Edition, Professional, vagy Enterprise):',
  ...
  'ERR_DBCONF_VALIDATION' => 'Kérem, javítsa ki a következő hibákat a folytatás előtt:',
  ...
  'ERR_DB_LOGIN_FAILURE' => 'A megadott adatbázis kiszolgáló, felhasználónév és / vagy jelszó érvénytelen, adatbázis kapcsolat nem létesíthető. Adjon meg egy érvényes kiszolgálót, felhasználónevet és jelszót.',
  ...
  'LBL_DBCONF_CREATE_USER' => 'Felhasználó létrehozása',
  ...
  'REQUIRED_SYS_COMP_MSG' => 'Kezdés előtt kérem, győződjön meg róla, hogy a támogatott verziója fel van telepítve az alábbi rendszerösszetevőknek:<br />Adatbázis / Database Management System (például: MySQL, SQL Server, Oracle, DB2)<br />Web szerver (Apache, IIS)<br /><br /> Kérem, olvassa el a kompatibilitási mátrixot a kiadásokra vonatkozó jegyzetekben!',
  ...
  array (
    ...
    'txt_body' => 'Ön nemrég kezdeményezte a $contact_user_pwd_last_changed oldalon fiókja jelszavának visszaállítását. Kattintson az alábbi linkre a jelszó visszaállításához: $contact_user_link_guid',
  ),
  ...
  array (
    ...
    'txt_body' => 'Ez az Ön felhasználóneve és ideiglenes jelszava: Felhasználónév: contact_user_user_name Jelszó: contact_user_user_hash config_site_url Miután belépett a fenti jelszót használva, szükséges lehet a jelszót megváltoztatni saját választása szerint.',
  ),
);
