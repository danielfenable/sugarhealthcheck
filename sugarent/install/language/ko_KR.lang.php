...
$mod_strings = array (
  ...
  'ERROR_LICENSE_EXPIRED' => '오류 : 라이센스 만료되었습니다.',
  ...
  'ERROR_PACKAGE_TYPE' => '현재 파일이 확인되지 않은 패키지형식을 지정해야합니다.',
  'ERROR_SPRITE_SUPPORT' => '현재 GD library의 위치가 파악되지 않았습니다. 결과적으로 CSS Sprite 기능의 사용이 불가능 합니다.',
  'ERROR_VALIDATION_EXPIRED' => '오류:귀하의 인증키가 만료되었습니다.',
  ...
  'ERR_DBCONF_VALIDATION' => '진행하기전 다음 오류를 수정하십시오.',
  ...
  'ERR_UW_NO_UPDATE_RECORD' => '설치기록의 위치를 파악할수 없습니다.',
  'LBL_ACCEPT' => '수락합니다.',
  ...
  'LBL_DBCONF_SUGAR_DB_USER' => 'Sugar 데이타베이스 사용자명',
  ...
  'LBL_OOTB_CAMPAIGN' => '매일 저녁 대용량 이메일 캠페인 진행',
  ...
  array (
    ...
    'txt_body' => '최근 귀하의 계정 비밀번호 재설정을 위한 contact_user_pwd_last_changed을 요청하였습니다. 아래 링크를 클릭하여 비밀번호를 재설정하십시요. :$contact_user_link_guid',
  ),
  ...
  array (
    ...
    'subject' => '새 계정 정보',
    'txt_body' => '귀하의 계정 사용자명과 임시 비밀번호입니다 : 사용자명 : $contact_user_user_name 비밀번호 : $contact_user_user_hash $config_site_url. 위 비밀번호로 로그인 후에 본인만의 비밀번호로 재설정하십시오.',
  ),
);
