...
$mod_strings = array (
  ...
  'ERROR_PACKAGE_TYPE' => 'Файлът manifest.php специфицира непоснат тип на пакет',
  ...
  'ERR_UW_NO_UPDATE_RECORD' => 'Не може да бъде намерен инсталационният запис на',
  'LBL_ACCEPT' => 'Приеми',
  ...
  'LBL_CHECKSYS_NOT_AVAILABLE' => 'Липсващ',
  'LBL_CHECKSYS_OK' => 'ОК',
  ...
  'LBL_OOTB_REPORTS' => 'Изпълнение на задачите за генериране на справки',
  ...
  'LBL_OOTB_WORKFLOW' => 'Изпълнение на Автоматизираните процеси',
