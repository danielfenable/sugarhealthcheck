...
$mod_strings = array(
	...
	'ERR_OC_SERVER_URL'					=> 'Se requiere el URL del Servidor de Sugar.',
	'ERR_OC_USERNAME'					=> 'Se requiere el nombre de usuario del servidor.',
	'LBL_INSTALL_OC'					=> 'Instalar Cliente Desconectado',
    'LBL_OC_ADMIN'                      => 'Por favor, contáctese con su Administrador para resolver este problema.',
    'LBL_OC_SUCCESS'                    => 'La instalación del Cliente Desconectado se ha completado. Por favor, haga clic en el siguiente botón para dirigirse a su instalación.',
	'LBL_OC_INSTALL_ADMIN_NAME'			=> 'Nombre de usuario del Administrador',
	'LBL_OC_INSTAL_DIRECTIONS'			=> 'Por favor, introduzca los siguientes datos para instalar y sincronizar adecuadamente su cliente desconectado.',
	...
	'LBL_PERFORM_OC_INSTALL'			=> 'Iniciando Instalación de Cliente Desconectado',
    'LBL_OC_INSTALL_DIRECTIONS'         => 'Por favor, introduzca los siguientes datos para instalar y sincronizar adecuadamente su cliente desconectado.',
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => 'No se encontró el soporte de la base de datos. Asegúrese de tener los controladores necesarios para uno de los siguientes tipos de base de datos soportados: MySQL o MS SQLServer. Es posible que deba eliminar el comentario de la extensión en el archivo php.ini o recompilarlo con el archivo binario correcto, según su versión de PHP. Por favor, consulte el manual de PHP para mayor información sobre cómo habilitar el soporte de la base de datos.<br><br>Oracle y DB2 no son bases de datos soportadas para SugarCRM PRO. Para acceder a una lista de bases de datos soportadas y demás información sobre plataformas, visite <a href="http://support.sugarcrm.com/05_Resources/03_Supported_Platforms/">http://support.sugarcrm.com/05_Resources/03_Supported_Platforms/</a>.',
	...
	'ERROR_FLAVOR_INCOMPATIBLE'			=> 'El archivo cargado no es compatible con esta edición (Edición Comunidad, Profesional o Empresa) de Sugar: ',
...
//	'LBL_NO_THANKS'						=> 'Continue to installer',
	...
	'LBL_WELCOME_2'						=> 'Para encontrar documentación sobre la instalación, por favor visite <a href="http://www.sugarcrm.com/crm/installation" target="_blank">Sugar Wiki</a>.  <BR><BR> También podrá obtener ayuda por parte de la comunidad de SugarCRM en los <a href="http://www.sugarcrm.com/forums/" target="_blank">Foros de Sugar</a>.',
...
<li><b>Juego de Caracteres</b> más comúnmente usado en su configuración regional.<br><br></li></ul>                                  Para información más detallada, por favor, consulte la Guía de Instalación.                                ",
    ...
    'LBL_OOTB_SEND_EMAIL_REMINDERS'	=> 'Ejecutar Notificaciones de Envío de Correos Electrónicos',
    ...
    'LBL_FTS_ERROR'    => 'No se puede conectar al servidor de búsqueda de texto completo, por favor, verifique la configuración.',
	...
	'LBL_MINIMUM_PHP_VERSION' => 'La versión de PHP mínima requerida es la 5.3.0.',
	'LBL_YOUR_PHP_VERSION' => '(Su versión actual de PHP es',
	'LBL_RECOMMENDED_PHP_VERSION' =>' La versión de Php recomendada de Php es la 5.3.x)',
