...
$mod_strings = array (
  ...
  'ERR_CHECKSYS_PHP_INVALID_VER' => 'Sugar ei tue PHP-versiotasi. Sinun pitää asentaa Sugarin kanssa yhteensopiva versio. Katso julkaisutiedoissa olevaa yhteensopivuusmatriisia tuetuille PHP-versioille. Versiosi on&nbsp;',
  ...
  'ERR_DB_MYSQL_DB_NAME_INVALID' => 'Tietokannan nimessä ei voi olla taka- ja etukenoviivoja tai pisteitä (“\\”, “/”, “.”)',
  ...
  'ERR_UW_NO_UPDATE_RECORD' => 'Ei löydetty asennuskirjaa',
  'LBL_ACCEPT' => 'Hyväksyn',
  ...
  'LBL_LANG_BUTTON_UNINSTALL' => 'Poista asennus',
  'LBL_LANG_BUTTON_UPLOAD' => 'Lataa (upload)',
  ...
  'LBL_ML_TYPE' => 'Tyyppi',
  'LBL_ML_UNINSTALLABLE' => 'Voidaan poistaa',
  ...
  'LBL_OC_INSTALL_USERNAME' => 'Käyttäjänimi',
  ...
  'LBL_OOTB_BOUNCE' => 'Suorita yöllinen prosessi palautuneille kampanjaviesteille',
  'LBL_OOTB_CAMPAIGN' => 'Suorita yölliset massasähköpostituskampanjat',
  ...
  array (
    ...
    'txt_body' => 'Pyysit käyttäjätunnuksesi salasanan vaihtoa $contact_user_pwd_last_changed .<br /><br />Klikkaa alla olevaa linkkiä vaihtaaksesi salasanasi:<br /><br />$contact_user_link_guid',
  ),
  ...
  array (
    ...
    'txt_body' => 'Tässä on käyttäjänimesi ja tilapäinen salasanasi:<br />Käyttäjänimi : $contact_user_user_name<br />Salasana     : $contact_user_user_hash<br /><br />$config_site_url<br /><br />Kun kirjaudut sisään yllä olevalla sanasanalla, sinua saatetaan pyytää muutamaan salasana.',
  ),
);
