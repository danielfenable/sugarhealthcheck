...
$mod_strings = array(
	...
	'ERR_OC_SERVER_URL'					=> 'Se requiere la URL del Servidor Sugar.',
	'ERR_OC_USERNAME'					=> 'Se requiere el nombre de usuario del servidor.',
	'LBL_INSTALL_OC'					=> 'Instalar Cliente offline',
    'LBL_OC_ADMIN'                      => 'Contacte con su Administrador para resolver este problema.',
    'LBL_OC_SUCCESS'                    => 'La instalación del Cliente sin conexión ha terminado. Haga clic en el siguiente botón para que le lleven a su instalación.',
	'LBL_OC_INSTALL_ADMIN_NAME'			=> 'Nombre de usuario Administrador',
	'LBL_OC_INSTAL_DIRECTIONS'			=> 'Introduzca los siguientes detalles para instalar y sincronizar adecuadamente su cliente sin conexión.',
	'LBL_OC_INSTALL_SERVER_URL'			=> 'URL del Servidor Sugar',
	'LBL_OC_INSTALL_PASS'				=> 'Contraseña para el usuario del servidor',
	'LBL_OC_INSTALL_TITLE'				=> 'Instalación de Cliente sin conexión',
	...
	'LBL_PERFORM_OC_INSTALL'			=> 'Inicializando Instalación de Cliente sin conexión',
    'LBL_OC_INSTALL_DIRECTIONS'         => 'Introduzca los siguientes detalles para instalar y sincronizar adecuadamente su cliente sin conexión.',
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => 'No se ha encontrado el soporte de base de datos. Asegúrese de tener los controladores necesarios para alguno de los siguientes tipo de Base de Datos: MySQL o MS SQLServer.  Es posible que tenga que descomentar la extensión en el archivo php.ini, o recompilarlo con el archivo binario apropiado, dependiendo de la versión de PHP. Consulte el manual de PHP para más información sobre cómo habilitar el Servicio de Asistencia de Base de Datos.<br><br>Oracle y DB2 no son bases de datos compatibles con SugarCRM PRO. Para obtener una lista de bases de datos compatibles y otra información de plataformas visite <a href="http://support.sugarcrm.com/05_Resources/03_Supported_Platforms/">http://support.sugarcrm.com/05_Resources/03_Supported_Platforms/</a>.',
	...
	'ERROR_FLAVOR_INCOMPATIBLE'			=> 'El archivo subido no es compatible con esta edición de Sugar Suite (Community Edition, Professional o Enterprise): ',
	...
	'LBL_LICENSE_OC_DIRECTIONS'			=> 'Introduzca el nombre de clientes sin conexión adquiridos.',
	'LBL_LICENSE_OC_NUM'				=> 'Número de Licencias de Cliente sin conexión',
	'LBL_LICENSE_OC'					=> 'Licencias de Cliente sin conexión',
...
//	'LBL_NO_THANKS'						=> 'Continue to installer',
	...
	'LBL_WELCOME_2'						=> 'Para encontrar documentación sobre la instalación, visite  <a href="http://www.sugarcrm.com/crm/installation" target="_blank">Sugar Wiki</a>.  <BR><BR> También puede obtener ayuda de la Comunidad Sugar en <a target="_blank" href="http://support.sugarcrm.com">Foros Sugar</a>.',
...
Para información más detallada, consulte la Guía de Instalación.                                ",
    ...
    'LBL_OOTB_SEND_EMAIL_REMINDERS'	=> 'Ejecutar las notificaciones de aviso de correo electrónico',
    ...
    'LBL_FTS_ERROR'    => 'No se puede conectar al servidor de búsqueda de texto completo, compruebe la configuración.',
...
<br> Corrija su <a target=_new href=\"http://us2.php.net/manual/en/ref.session.php\">configuración PHP</a> en el archivo php.ini ubicado a continuación.",
	...
	'LBL_MINIMUM_PHP_VERSION' => 'La versión mínima requerida de PHP es la 5.3.0.',
	'LBL_YOUR_PHP_VERSION' => '(Su versión actual de PHP es',
	'LBL_RECOMMENDED_PHP_VERSION' =>' La versión recomendada de php es la 5.3.x)',
