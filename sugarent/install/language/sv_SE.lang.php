...
$mod_strings = array (
  ...
  'ERR_DB_LOGIN_FAILURE' => 'Angiven databasvärd, användarnamn, och/eller lösenord är ogiltigt och en en anslutning till databasen kunde inte göras. Var god och ange giltig information.',
  ...
  'ERR_DB_MYSQL_DB_NAME_INVALID' => 'Databas namn kan inte innehålla &#39;\\&#39;, &#39;/&#39;, eller &#39;.&#39;',
  ...
  array (
    ...
    'txt_body' => 'Du begärde nyss för $contact_user_pwd_last_changed att kunna återställa ditt kontolösenord. Klicka på länken nedanför för att återställa ditt lösenord: $contact_user_link_guid',
  ),
  ...
  array (
    ...
    'txt_body' => 'är är ditt användarnamn och ditt tillfälliga lösenord: <br />Användarnamn : $contact_user_user_name<br />Lösenord : $contact_user_user_hash<br /><br />$config_site_url<br /><br />After you log in using the above password, you may be required to reset the password to one of your own choice.',
  ),
);
