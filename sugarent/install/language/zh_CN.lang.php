...
$mod_strings = array (
  ...
  'ERR_DBCONF_VALIDATION' => '请修复下列错误后才继续：',
  ...
  'ERR_DB_IBM_DB2_CONNECT' => '所提供的数据库主机名、用户名和/或密码无效，无法建立和数据库的连接。请输入有效的主机名、用户名和密码',
  'ERR_DB_IBM_DB2_VERSION' => 'Sugar不支持您的DB2版本(%s)。您需要安装与Sugar程序兼容的版本。 请参阅可支持DB2版本中发行说明的兼容性矩阵表。',
  'ERR_DB_INVALID' => '选择的数据库类型无效。',
  'ERR_DB_LOGIN_FAILURE' => '所提供的数据库主机、用户名和/或者密码无效。与数据库的连接无法建立。请输入一个有效的主机、用户名和密码',
  'ERR_DB_LOGIN_FAILURE_IBM_DB2' => '所提供的数据库主机名、用户名和/或密码无效，无法建立和数据库的连接。请输入有效的主机名、用户名和密码',
  'ERR_DB_LOGIN_FAILURE_MSSQL' => '所提供的数据库主机、用户名和/或者密码无效。与数据库的连接无法建立。请输入一个有效的主机、用户名和密码',
  'ERR_DB_LOGIN_FAILURE_MYSQL' => '所提供的数据库主机、用户名和/或者密码无效。与数据库的连接无法建立。请输入一个有效的主机、用户名和密码',
  'ERR_DB_LOGIN_FAILURE_OCI8' => '所提供的数据库主机、用户名和/或密码无效，无法建立和数据库的连接。请输入一个有效的主机、用户名和密码',
  ...
  'ERR_DB_OCI8_CONNECT' => '所提供的数据库主机、用户名和/或密码无效，无法建立和数据库的连接。请输入一个有效的主机、用户名和密码',
  'ERR_DB_OCI8_DB_NAME_INVALID' => '数据库名称只能包含字母数字字符组和符号 $#39;#$#39;, $#39;_$#39; 或 $#39;$$#39;',
  'ERR_DB_OCI8_VERSION' => 'Sugar不支持您的Oracle版本 (%s)。您需要安装一个与Sugar兼容的版本。请参阅可支持Oracle版本中发行说明的兼容性矩阵表。',
  ...
  'ERR_UW_NO_UPDATE_RECORD' => '找不到以下的安装记录',
  'LBL_ACCEPT' => '我接受',
  ...
  'LBL_OPP' => '商业机会数据集',
  'LBL_OPP1_DESC' => '你可以修改自定义查询的界面与外观',
  ...
  'LBL_PRINT_SUMM' => '打印摘要',
  'LBL_Q' => '商业机会查询',
  'LBL_Q1_DESC' => '按类型列表商业机会',
  'LBL_Q2_DESC' => '根据客户列表商业机会',
  'LBL_R1' => '6个月的销售管道报表',
  'LBL_R1_DESC' => '按月份与类型列表接下6个月的商业机会',
  ...
  'LBL_SYSOPTS_DB_DIRECTIONS' => '如果你选择Oracle，你必须安装并配置妥当的Oracle客户端。',
