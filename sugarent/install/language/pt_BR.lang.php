...
$mod_strings = array (
  ...
  'ERR_DB_IBM_DB2_CONNECT' => 'O nome do usuário e/ou senha da base de dados é inválido(a), e a conexão com a base de dados não pôde ser estabelecida. Por favor insira um nome do usuário e senha válidos.',
  'ERR_DB_IBM_DB2_VERSION' => 'Sua Versão do DB2 (%s) não é suportada pelo SugarCRM. Você deve instalar uma versão compatível. Por favor consulte as versões compatíveis nas informações para checar qual versão de DB2 é suportada.',
  ...
  'ERR_DB_LOGIN_FAILURE_IBM_DB2' => 'O nome do usuário e/ou senha da base de dados é inválido(a), e a conexão com a base de dados não pôde ser estabelecida. Por favor insira um nome do usuário e senha válidos.',
  ...
  'ERR_DB_LOGIN_FAILURE_OCI8' => 'O nome do usuário e/ou senha da base de dados é inválido(a), e a conexão com a base de dados não pôde ser estabelecida. Por favor insira um nome do usuário e senha válidos.',
  ...
  'ERR_DB_OCI8_CONNECT' => 'O nome do usuário e/ou senha da base de dados é inválido(a), e a conexão com a base de dados não pôde ser estabelecida. Por favor insira um nome do usuário e senha válidos.',
  ...
  'LBL_DBCONFIG_ORACLE' => 'Favro informar nome do Banco de Dados. Este será o nome padrão atribuído para seu usuário (SID from tnsnames.ora).',
  ...
  'LBL_OC_INSTALL_DIRECTIONS' => 'Por favor insira os detalhes abaixo de modo a instalar e sincronizar corretamente o seu cliente offline.',
  ...
  array (
    ...
    'txt_body' => 'Recentemente pediu em $contact_user_pwd_last_changed que tenha a possibilidade de indicar uma nova senha da sua conta. Clicar no link abaixo para indicar uma nova senha: $contact_user_link_guid',
  ),
  ...
  array (
    ...
    'txt_body' => 'Aqui está o nome de usuário senha da sua conta: Nome de usuário: $contact_user_user_name senha: $contact_user_user_hash $config_site_url. Depois de se autenticar com a senha indicada, poderá ser necessário indicar uma nova senha.',
  ),
);
